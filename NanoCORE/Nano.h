// -*- C++ -*-
// Generated with args: -t Events -p /hadoop/cms/store/user/hmei/nanoaod_runII/HHggtautau/HHggtautau_Era2018_private_v2_20201005/test_nanoaod_1.root
#ifndef Nano_H
#define Nano_H
...
#define NCORRT1METJET_MAX 63 // for CorrT1METJet_* collection
#define NMUON_MAX 21 // for Muon_* collection
...
#define NISOTRACK_MAX 15 // for IsoTrack_* collection
#define NLHEPDFWEIGHT_MAX 312 // for LHEPdfWeight_* collection
#define NFSRPHOTON_MAX 6 // for FsrPhoton_* collection
#define NOTHERPV_MAX 12 // for OtherPV_* collection
#define NTRIGOBJ_MAX 117 // for TrigObj_* collection
#define NSUBJET_MAX 27 // for SubJet_* collection
#define NSUBGENJETAK8_MAX 33 // for SubGenJetAK8_* collection
#define NGENVISTAU_MAX 12 // for GenVisTau_* collection
#define NGENJETAK8_MAX 18 // for GenJetAK8_* collection
#define NELECTRON_MAX 18 // for Electron_* collection
#define NFATJET_MAX 15 // for FatJet_* collection
#define NJET_MAX 63 // for Jet_* collection
...
protected:
    ...
    unsigned int counter_cached_CaloMET_phi_;
    unsigned int counter_uncached_CaloMET_phi_;
    float CaloMET_pt_;
    TBranch *b_CaloMET_pt_;
    bool loaded_CaloMET_pt_;
    unsigned int counter_cached_CaloMET_pt_;
    unsigned int counter_uncached_CaloMET_pt_;
    float CaloMET_sumEt_;
    TBranch *b_CaloMET_sumEt_;
    bool loaded_CaloMET_sumEt_;
    unsigned int counter_cached_CaloMET_sumEt_;
    unsigned int counter_uncached_CaloMET_sumEt_;
    float ChsMET_phi_;
    TBranch *b_ChsMET_phi_;
    bool loaded_ChsMET_phi_;
    unsigned int counter_cached_ChsMET_phi_;
    unsigned int counter_uncached_ChsMET_phi_;
    float ChsMET_pt_;
    TBranch *b_ChsMET_pt_;
    bool loaded_ChsMET_pt_;
    unsigned int counter_cached_ChsMET_pt_;
    unsigned int counter_uncached_ChsMET_pt_;
    float ChsMET_sumEt_;
    TBranch *b_ChsMET_sumEt_;
    bool loaded_ChsMET_sumEt_;
    unsigned int counter_cached_ChsMET_sumEt_;
    unsigned int counter_uncached_ChsMET_sumEt_;
    ...
    unsigned int counter_cached_CorrT1METJet_area_;
    unsigned int counter_uncached_CorrT1METJet_area_;
    ...
    unsigned int counter_cached_CorrT1METJet_eta_;
    unsigned int counter_uncached_CorrT1METJet_eta_;
    ...
    unsigned int counter_cached_CorrT1METJet_muonSubtrFactor_;
    unsigned int counter_uncached_CorrT1METJet_muonSubtrFactor_;
    ...
    unsigned int counter_cached_CorrT1METJet_phi_;
    unsigned int counter_uncached_CorrT1METJet_phi_;
    ...
    unsigned int counter_cached_Electron_charge_;
    unsigned int counter_uncached_Electron_charge_;
    ...
    unsigned int counter_cached_Electron_cleanmask_;
    unsigned int counter_uncached_Electron_cleanmask_;
    ...
    unsigned int counter_cached_Electron_cutBased_;
    unsigned int counter_uncached_Electron_cutBased_;
    ...
    unsigned int counter_cached_Electron_cutBased_Fall17_V1_;
    unsigned int counter_uncached_Electron_cutBased_Fall17_V1_;
    ...
    unsigned int counter_cached_Electron_cutBased_HEEP_;
    unsigned int counter_uncached_Electron_cutBased_HEEP_;
    ...
    unsigned int counter_cached_Electron_deltaEtaSC_;
    unsigned int counter_uncached_Electron_deltaEtaSC_;
    ...
    unsigned int counter_cached_Electron_dr03EcalRecHitSumEt_;
    unsigned int counter_uncached_Electron_dr03EcalRecHitSumEt_;
    ...
    unsigned int counter_cached_Electron_dr03HcalDepth1TowerSumEt_;
    unsigned int counter_uncached_Electron_dr03HcalDepth1TowerSumEt_;
    ...
    unsigned int counter_cached_Electron_dr03TkSumPt_;
    unsigned int counter_uncached_Electron_dr03TkSumPt_;
    ...
    unsigned int counter_cached_Electron_dr03TkSumPtHEEP_;
    unsigned int counter_uncached_Electron_dr03TkSumPtHEEP_;
    float Electron_dxy_[NELECTRON_MAX];
    vector<float> v_Electron_dxy_;
    TBranch *b_Electron_dxy_;
    bool loaded_Electron_dxy_;
    unsigned int counter_cached_Electron_dxy_;
    unsigned int counter_uncached_Electron_dxy_;
    ...
    unsigned int counter_cached_Electron_dxyErr_;
    unsigned int counter_uncached_Electron_dxyErr_;
    float Electron_dz_[NELECTRON_MAX];
    vector<float> v_Electron_dz_;
    TBranch *b_Electron_dz_;
    bool loaded_Electron_dz_;
    unsigned int counter_cached_Electron_dz_;
    unsigned int counter_uncached_Electron_dz_;
    float Electron_dzErr_[NELECTRON_MAX];
    vector<float> v_Electron_dzErr_;
    TBranch *b_Electron_dzErr_;
    bool loaded_Electron_dzErr_;
    unsigned int counter_cached_Electron_dzErr_;
    unsigned int counter_uncached_Electron_dzErr_;
    float Electron_eCorr_[NELECTRON_MAX];
    vector<float> v_Electron_eCorr_;
    TBranch *b_Electron_eCorr_;
    bool loaded_Electron_eCorr_;
    unsigned int counter_cached_Electron_eCorr_;
    unsigned int counter_uncached_Electron_eCorr_;
    ...
    unsigned int counter_cached_Electron_eInvMinusPInv_;
    unsigned int counter_uncached_Electron_eInvMinusPInv_;
    ...
    unsigned int counter_cached_Electron_energyErr_;
    unsigned int counter_uncached_Electron_energyErr_;
    float Electron_eta_[NELECTRON_MAX];
    vector<float> v_Electron_eta_;
    TBranch *b_Electron_eta_;
    bool loaded_Electron_eta_;
    unsigned int counter_cached_Electron_eta_;
    unsigned int counter_uncached_Electron_eta_;
    ...
    unsigned int counter_cached_Electron_genPartIdx_;
    unsigned int counter_uncached_Electron_genPartIdx_;
    float Electron_hoe_[NELECTRON_MAX];
    vector<float> v_Electron_hoe_;
    TBranch *b_Electron_hoe_;
    bool loaded_Electron_hoe_;
    unsigned int counter_cached_Electron_hoe_;
    unsigned int counter_uncached_Electron_hoe_;
    float Electron_ip3d_[NELECTRON_MAX];
    vector<float> v_Electron_ip3d_;
    TBranch *b_Electron_ip3d_;
    bool loaded_Electron_ip3d_;
    unsigned int counter_cached_Electron_ip3d_;
    unsigned int counter_uncached_Electron_ip3d_;
    ...
    unsigned int counter_cached_Electron_isPFcand_;
    unsigned int counter_uncached_Electron_isPFcand_;
    ...
    unsigned int counter_cached_Electron_jetPtRelv2_;
    unsigned int counter_uncached_Electron_jetPtRelv2_;
    ...
    unsigned int counter_cached_Electron_jetRelIso_;
    unsigned int counter_uncached_Electron_jetRelIso_;
    ...
    unsigned int counter_cached_Electron_lostHits_;
    unsigned int counter_uncached_Electron_lostHits_;
    float Electron_mass_[NELECTRON_MAX];
    vector<float> v_Electron_mass_;
    TBranch *b_Electron_mass_;
    bool loaded_Electron_mass_;
    unsigned int counter_cached_Electron_mass_;
    unsigned int counter_uncached_Electron_mass_;
    ...
    unsigned int counter_cached_Electron_miniPFRelIso_all_;
    unsigned int counter_uncached_Electron_miniPFRelIso_all_;
    ...
    unsigned int counter_cached_Electron_miniPFRelIso_chg_;
    unsigned int counter_uncached_Electron_miniPFRelIso_chg_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V1Iso_;
    unsigned int counter_uncached_Electron_mvaFall17V1Iso_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V1Iso_WP80_;
    unsigned int counter_uncached_Electron_mvaFall17V1Iso_WP80_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V1Iso_WP90_;
    unsigned int counter_uncached_Electron_mvaFall17V1Iso_WP90_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V1Iso_WPL_;
    unsigned int counter_uncached_Electron_mvaFall17V1Iso_WPL_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V1noIso_;
    unsigned int counter_uncached_Electron_mvaFall17V1noIso_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V1noIso_WP80_;
    unsigned int counter_uncached_Electron_mvaFall17V1noIso_WP80_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V1noIso_WP90_;
    unsigned int counter_uncached_Electron_mvaFall17V1noIso_WP90_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V2Iso_;
    unsigned int counter_uncached_Electron_mvaFall17V2Iso_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V2Iso_WP80_;
    unsigned int counter_uncached_Electron_mvaFall17V2Iso_WP80_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V2Iso_WP90_;
    unsigned int counter_uncached_Electron_mvaFall17V2Iso_WP90_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V2Iso_WPL_;
    unsigned int counter_uncached_Electron_mvaFall17V2Iso_WPL_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V2noIso_;
    unsigned int counter_uncached_Electron_mvaFall17V2noIso_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V2noIso_WP80_;
    unsigned int counter_uncached_Electron_mvaFall17V2noIso_WP80_;
    ...
    unsigned int counter_cached_Electron_mvaFall17V2noIso_WPL_;
    unsigned int counter_uncached_Electron_mvaFall17V2noIso_WPL_;
    ...
    unsigned int counter_cached_Electron_p4_;
    unsigned int counter_uncached_Electron_p4_;
    int Electron_pdgId_[NELECTRON_MAX];
    vector<int> v_Electron_pdgId_;
    TBranch *b_Electron_pdgId_;
    bool loaded_Electron_pdgId_;
    unsigned int counter_cached_Electron_pdgId_;
    unsigned int counter_uncached_Electron_pdgId_;
    ...
    unsigned int counter_cached_Electron_pfRelIso03_all_;
    unsigned int counter_uncached_Electron_pfRelIso03_all_;
    ...
    unsigned int counter_cached_Electron_pfRelIso03_chg_;
    unsigned int counter_uncached_Electron_pfRelIso03_chg_;
    float Electron_phi_[NELECTRON_MAX];
    vector<float> v_Electron_phi_;
    TBranch *b_Electron_phi_;
    bool loaded_Electron_phi_;
    unsigned int counter_cached_Electron_phi_;
    unsigned int counter_uncached_Electron_phi_;
    ...
    unsigned int counter_cached_Electron_photonIdx_;
    unsigned int counter_uncached_Electron_photonIdx_;
    float Electron_pt_[NELECTRON_MAX];
    vector<float> v_Electron_pt_;
    TBranch *b_Electron_pt_;
    bool loaded_Electron_pt_;
    unsigned int counter_cached_Electron_pt_;
    unsigned int counter_uncached_Electron_pt_;
    float Electron_r9_[NELECTRON_MAX];
    vector<float> v_Electron_r9_;
    TBranch *b_Electron_r9_;
    bool loaded_Electron_r9_;
    unsigned int counter_cached_Electron_r9_;
    unsigned int counter_uncached_Electron_r9_;
    ...
    unsigned int counter_cached_Electron_scEtOverPt_;
    unsigned int counter_uncached_Electron_scEtOverPt_;
    ...
    unsigned int counter_cached_Electron_seedGain_;
    unsigned int counter_uncached_Electron_seedGain_;
    float Electron_sieie_[NELECTRON_MAX];
    vector<float> v_Electron_sieie_;
    TBranch *b_Electron_sieie_;
    bool loaded_Electron_sieie_;
    unsigned int counter_cached_Electron_sieie_;
    unsigned int counter_uncached_Electron_sieie_;
    float Electron_sip3d_[NELECTRON_MAX];
    vector<float> v_Electron_sip3d_;
    TBranch *b_Electron_sip3d_;
    bool loaded_Electron_sip3d_;
    unsigned int counter_cached_Electron_sip3d_;
    unsigned int counter_uncached_Electron_sip3d_;
    ...
    unsigned int counter_cached_Electron_tightCharge_;
    unsigned int counter_uncached_Electron_tightCharge_;
    ...
    unsigned int counter_cached_Electron_vidNestedWPBitmap_;
    unsigned int counter_uncached_Electron_vidNestedWPBitmap_;
    ...
    unsigned int counter_cached_Electron_vidNestedWPBitmapHEEP_;
    unsigned int counter_uncached_Electron_vidNestedWPBitmapHEEP_;
    float FatJet_area_[NFATJET_MAX];
    vector<float> v_FatJet_area_;
    TBranch *b_FatJet_area_;
    bool loaded_FatJet_area_;
    unsigned int counter_cached_FatJet_area_;
    unsigned int counter_uncached_FatJet_area_;
    float FatJet_btagCMVA_[NFATJET_MAX];
    vector<float> v_FatJet_btagCMVA_;
    TBranch *b_FatJet_btagCMVA_;
    bool loaded_FatJet_btagCMVA_;
    unsigned int counter_cached_FatJet_btagCMVA_;
    unsigned int counter_uncached_FatJet_btagCMVA_;
    ...
    unsigned int counter_cached_FatJet_btagCSVV2_;
    unsigned int counter_uncached_FatJet_btagCSVV2_;
    ...
    unsigned int counter_cached_FatJet_btagDDBvL_noMD_;
    unsigned int counter_uncached_FatJet_btagDDBvL_noMD_;
    ...
    unsigned int counter_cached_FatJet_btagDDCvB_noMD_;
    unsigned int counter_uncached_FatJet_btagDDCvB_noMD_;
    ...
    unsigned int counter_cached_FatJet_btagDDCvL_noMD_;
    unsigned int counter_uncached_FatJet_btagDDCvL_noMD_;
    ...
    unsigned int counter_cached_FatJet_btagDeepB_;
    unsigned int counter_uncached_FatJet_btagDeepB_;
    ...
    unsigned int counter_cached_FatJet_deepTagMD_H4qvsQCD_;
    unsigned int counter_uncached_FatJet_deepTagMD_H4qvsQCD_;
    ...
    unsigned int counter_cached_FatJet_deepTagMD_HbbvsQCD_;
    unsigned int counter_uncached_FatJet_deepTagMD_HbbvsQCD_;
    ...
    unsigned int counter_cached_FatJet_deepTagMD_TvsQCD_;
    unsigned int counter_uncached_FatJet_deepTagMD_TvsQCD_;
    ...
    unsigned int counter_cached_FatJet_deepTagMD_WvsQCD_;
    unsigned int counter_uncached_FatJet_deepTagMD_WvsQCD_;
    ...
    unsigned int counter_cached_FatJet_deepTagMD_ZHbbvsQCD_;
    unsigned int counter_uncached_FatJet_deepTagMD_ZHbbvsQCD_;
    ...
    unsigned int counter_cached_FatJet_deepTagMD_ZHccvsQCD_;
    unsigned int counter_uncached_FatJet_deepTagMD_ZHccvsQCD_;
    ...
    unsigned int counter_cached_FatJet_deepTagMD_ZbbvsQCD_;
    unsigned int counter_uncached_FatJet_deepTagMD_ZbbvsQCD_;
    ...
    unsigned int counter_cached_FatJet_deepTagMD_ZvsQCD_;
    unsigned int counter_uncached_FatJet_deepTagMD_ZvsQCD_;
    ...
    unsigned int counter_cached_FatJet_deepTagMD_bbvsLight_;
    unsigned int counter_uncached_FatJet_deepTagMD_bbvsLight_;
    ...
    unsigned int counter_cached_FatJet_deepTagMD_ccvsLight_;
    unsigned int counter_uncached_FatJet_deepTagMD_ccvsLight_;
    ...
    unsigned int counter_cached_FatJet_deepTag_H_;
    unsigned int counter_uncached_FatJet_deepTag_H_;
    ...
    unsigned int counter_cached_FatJet_deepTag_QCD_;
    unsigned int counter_uncached_FatJet_deepTag_QCD_;
    ...
    unsigned int counter_cached_FatJet_deepTag_QCDothers_;
    unsigned int counter_uncached_FatJet_deepTag_QCDothers_;
    ...
    unsigned int counter_cached_FatJet_deepTag_TvsQCD_;
    unsigned int counter_uncached_FatJet_deepTag_TvsQCD_;
    ...
    unsigned int counter_cached_FatJet_deepTag_WvsQCD_;
    unsigned int counter_uncached_FatJet_deepTag_WvsQCD_;
    ...
    unsigned int counter_cached_FatJet_deepTag_ZvsQCD_;
    unsigned int counter_uncached_FatJet_deepTag_ZvsQCD_;
    ...
    unsigned int counter_cached_FatJet_electronIdx3SJ_;
    unsigned int counter_uncached_FatJet_electronIdx3SJ_;
    float FatJet_eta_[NFATJET_MAX];
    vector<float> v_FatJet_eta_;
    TBranch *b_FatJet_eta_;
    bool loaded_FatJet_eta_;
    unsigned int counter_cached_FatJet_eta_;
    unsigned int counter_uncached_FatJet_eta_;
    ...
    unsigned int counter_cached_FatJet_genJetAK8Idx_;
    unsigned int counter_uncached_FatJet_genJetAK8Idx_;
    ...
    unsigned int counter_cached_FatJet_hadronFlavour_;
    unsigned int counter_uncached_FatJet_hadronFlavour_;
    int FatJet_jetId_[NFATJET_MAX];
    vector<int> v_FatJet_jetId_;
    TBranch *b_FatJet_jetId_;
    bool loaded_FatJet_jetId_;
    unsigned int counter_cached_FatJet_jetId_;
    unsigned int counter_uncached_FatJet_jetId_;
    float FatJet_lsf3_[NFATJET_MAX];
    vector<float> v_FatJet_lsf3_;
    TBranch *b_FatJet_lsf3_;
    bool loaded_FatJet_lsf3_;
    unsigned int counter_cached_FatJet_lsf3_;
    unsigned int counter_uncached_FatJet_lsf3_;
    ...
    unsigned int counter_cached_FatJet_muonIdx3SJ_;
    unsigned int counter_uncached_FatJet_muonIdx3SJ_;
    float FatJet_n2b1_[NFATJET_MAX];
    vector<float> v_FatJet_n2b1_;
    TBranch *b_FatJet_n2b1_;
    bool loaded_FatJet_n2b1_;
    unsigned int counter_cached_FatJet_n2b1_;
    unsigned int counter_uncached_FatJet_n2b1_;
    float FatJet_n3b1_[NFATJET_MAX];
    vector<float> v_FatJet_n3b1_;
    TBranch *b_FatJet_n3b1_;
    bool loaded_FatJet_n3b1_;
    unsigned int counter_cached_FatJet_n3b1_;
    unsigned int counter_uncached_FatJet_n3b1_;
    ...
    unsigned int counter_cached_FatJet_nBHadrons_;
    unsigned int counter_uncached_FatJet_nBHadrons_;
    ...
    unsigned int counter_cached_FatJet_phi_;
    unsigned int counter_uncached_FatJet_phi_;
    ...
    unsigned int counter_cached_FatJet_rawFactor_;
    unsigned int counter_uncached_FatJet_rawFactor_;
    ...
    unsigned int counter_cached_FatJet_subJetIdx1_;
    unsigned int counter_uncached_FatJet_subJetIdx1_;
    ...
    unsigned int counter_cached_FatJet_subJetIdx2_;
    unsigned int counter_uncached_FatJet_subJetIdx2_;
    float FatJet_tau1_[NFATJET_MAX];
    vector<float> v_FatJet_tau1_;
    TBranch *b_FatJet_tau1_;
    bool loaded_FatJet_tau1_;
    unsigned int counter_cached_FatJet_tau1_;
    unsigned int counter_uncached_FatJet_tau1_;
    float FatJet_tau2_[NFATJET_MAX];
    vector<float> v_FatJet_tau2_;
    TBranch *b_FatJet_tau2_;
    bool loaded_FatJet_tau2_;
    unsigned int counter_cached_FatJet_tau2_;
    unsigned int counter_uncached_FatJet_tau2_;
    float FatJet_tau3_[NFATJET_MAX];
    vector<float> v_FatJet_tau3_;
    TBranch *b_FatJet_tau3_;
    bool loaded_FatJet_tau3_;
    unsigned int counter_cached_FatJet_tau3_;
    unsigned int counter_uncached_FatJet_tau3_;
    float FatJet_tau4_[NFATJET_MAX];
    vector<float> v_FatJet_tau4_;
    TBranch *b_FatJet_tau4_;
    bool loaded_FatJet_tau4_;
    unsigned int counter_cached_FatJet_tau4_;
    unsigned int counter_uncached_FatJet_tau4_;
    bool Flag_BadChargedCandidateFilter_;
    TBranch *b_Flag_BadChargedCandidateFilter_;
    bool loaded_Flag_BadChargedCandidateFilter_;
    unsigned int counter_cached_Flag_BadChargedCandidateFilter_;
    unsigned int counter_uncached_Flag_BadChargedCandidateFilter_;
    ...
    unsigned int counter_cached_Flag_BadPFMuonFilter_;
    unsigned int counter_uncached_Flag_BadPFMuonFilter_;
    bool Flag_BadPFMuonSummer16Filter_;
    TBranch *b_Flag_BadPFMuonSummer16Filter_;
    bool loaded_Flag_BadPFMuonSummer16Filter_;
    unsigned int counter_cached_Flag_BadPFMuonSummer16Filter_;
    unsigned int counter_uncached_Flag_BadPFMuonSummer16Filter_;
    bool Flag_CSCTightHalo2015Filter_;
    TBranch *b_Flag_CSCTightHalo2015Filter_;
    bool loaded_Flag_CSCTightHalo2015Filter_;
    unsigned int counter_cached_Flag_CSCTightHalo2015Filter_;
    unsigned int counter_uncached_Flag_CSCTightHalo2015Filter_;
    bool Flag_CSCTightHaloFilter_;
    TBranch *b_Flag_CSCTightHaloFilter_;
    bool loaded_Flag_CSCTightHaloFilter_;
    unsigned int counter_cached_Flag_CSCTightHaloFilter_;
    unsigned int counter_uncached_Flag_CSCTightHaloFilter_;
    ...
    unsigned int counter_cached_Flag_CSCTightHaloTrkMuUnvetoFilter_;
    unsigned int counter_uncached_Flag_CSCTightHaloTrkMuUnvetoFilter_;
    ...
    unsigned int counter_cached_Flag_EcalDeadCellBoundaryEnergyFilter_;
    unsigned int counter_uncached_Flag_EcalDeadCellBoundaryEnergyFilter_;
    ...
    unsigned int counter_cached_Flag_EcalDeadCellTriggerPrimitiveFilter_;
    unsigned int counter_uncached_Flag_EcalDeadCellTriggerPrimitiveFilter_;
    bool Flag_HBHENoiseFilter_;
    TBranch *b_Flag_HBHENoiseFilter_;
    bool loaded_Flag_HBHENoiseFilter_;
    unsigned int counter_cached_Flag_HBHENoiseFilter_;
    unsigned int counter_uncached_Flag_HBHENoiseFilter_;
    bool Flag_HBHENoiseIsoFilter_;
    TBranch *b_Flag_HBHENoiseIsoFilter_;
    bool loaded_Flag_HBHENoiseIsoFilter_;
    unsigned int counter_cached_Flag_HBHENoiseIsoFilter_;
    unsigned int counter_uncached_Flag_HBHENoiseIsoFilter_;
    bool Flag_HcalStripHaloFilter_;
    TBranch *b_Flag_HcalStripHaloFilter_;
    bool loaded_Flag_HcalStripHaloFilter_;
    unsigned int counter_cached_Flag_HcalStripHaloFilter_;
    unsigned int counter_uncached_Flag_HcalStripHaloFilter_;
    bool Flag_METFilters_;
    TBranch *b_Flag_METFilters_;
    bool loaded_Flag_METFilters_;
    unsigned int counter_cached_Flag_METFilters_;
    unsigned int counter_uncached_Flag_METFilters_;
    ...
    unsigned int counter_cached_Flag_chargedHadronTrackResolutionFilter_;
    unsigned int counter_uncached_Flag_chargedHadronTrackResolutionFilter_;
    bool Flag_ecalBadCalibFilter_;
    TBranch *b_Flag_ecalBadCalibFilter_;
    bool loaded_Flag_ecalBadCalibFilter_;
    unsigned int counter_cached_Flag_ecalBadCalibFilter_;
    unsigned int counter_uncached_Flag_ecalBadCalibFilter_;
    bool Flag_ecalBadCalibFilterV2_;
    TBranch *b_Flag_ecalBadCalibFilterV2_;
    bool loaded_Flag_ecalBadCalibFilterV2_;
    unsigned int counter_cached_Flag_ecalBadCalibFilterV2_;
    unsigned int counter_uncached_Flag_ecalBadCalibFilterV2_;
    bool Flag_ecalLaserCorrFilter_;
    TBranch *b_Flag_ecalLaserCorrFilter_;
    bool loaded_Flag_ecalLaserCorrFilter_;
    unsigned int counter_cached_Flag_ecalLaserCorrFilter_;
    unsigned int counter_uncached_Flag_ecalLaserCorrFilter_;
    bool Flag_eeBadScFilter_;
    TBranch *b_Flag_eeBadScFilter_;
    bool loaded_Flag_eeBadScFilter_;
    unsigned int counter_cached_Flag_eeBadScFilter_;
    unsigned int counter_uncached_Flag_eeBadScFilter_;
    ...
    unsigned int counter_cached_Flag_globalSuperTightHalo2016Filter_;
    unsigned int counter_uncached_Flag_globalSuperTightHalo2016Filter_;
    bool Flag_globalTightHalo2016Filter_;
    TBranch *b_Flag_globalTightHalo2016Filter_;
    bool loaded_Flag_globalTightHalo2016Filter_;
    unsigned int counter_cached_Flag_globalTightHalo2016Filter_;
    unsigned int counter_uncached_Flag_globalTightHalo2016Filter_;
    bool Flag_goodVertices_;
    TBranch *b_Flag_goodVertices_;
    bool loaded_Flag_goodVertices_;
    unsigned int counter_cached_Flag_goodVertices_;
    unsigned int counter_uncached_Flag_goodVertices_;
    ...
    unsigned int counter_cached_Flag_muonBadTrackFilter_;
    unsigned int counter_uncached_Flag_muonBadTrackFilter_;
    bool Flag_trkPOGFilters_;
    TBranch *b_Flag_trkPOGFilters_;
    bool loaded_Flag_trkPOGFilters_;
    unsigned int counter_cached_Flag_trkPOGFilters_;
    unsigned int counter_uncached_Flag_trkPOGFilters_;
    ...
    unsigned int counter_cached_Flag_trkPOG_logErrorTooManyClusters_;
    unsigned int counter_uncached_Flag_trkPOG_logErrorTooManyClusters_;
    bool Flag_trkPOG_manystripclus53X_;
    TBranch *b_Flag_trkPOG_manystripclus53X_;
    bool loaded_Flag_trkPOG_manystripclus53X_;
    unsigned int counter_cached_Flag_trkPOG_manystripclus53X_;
    unsigned int counter_uncached_Flag_trkPOG_manystripclus53X_;
    ...
    unsigned int counter_cached_Flag_trkPOG_toomanystripclus53X_;
    unsigned int counter_uncached_Flag_trkPOG_toomanystripclus53X_;
    ...
    unsigned int counter_cached_FsrPhoton_dROverEt2_;
    unsigned int counter_uncached_FsrPhoton_dROverEt2_;
    float FsrPhoton_eta_[NFSRPHOTON_MAX];
    vector<float> v_FsrPhoton_eta_;
    TBranch *b_FsrPhoton_eta_;
    bool loaded_FsrPhoton_eta_;
    unsigned int counter_cached_FsrPhoton_eta_;
    unsigned int counter_uncached_FsrPhoton_eta_;
    ...
    unsigned int counter_cached_FsrPhoton_muonIdx_;
    unsigned int counter_uncached_FsrPhoton_muonIdx_;
    float FsrPhoton_phi_[NFSRPHOTON_MAX];
    vector<float> v_FsrPhoton_phi_;
    TBranch *b_FsrPhoton_phi_;
    bool loaded_FsrPhoton_phi_;
    unsigned int counter_cached_FsrPhoton_phi_;
    unsigned int counter_uncached_FsrPhoton_phi_;
    float FsrPhoton_pt_[NFSRPHOTON_MAX];
    vector<float> v_FsrPhoton_pt_;
    TBranch *b_FsrPhoton_pt_;
    bool loaded_FsrPhoton_pt_;
    unsigned int counter_cached_FsrPhoton_pt_;
    unsigned int counter_uncached_FsrPhoton_pt_;
    ...
    unsigned int counter_cached_FsrPhoton_relIso03_;
    unsigned int counter_uncached_FsrPhoton_relIso03_;
    ...
    unsigned int counter_cached_GenDressedLepton_eta_;
    unsigned int counter_uncached_GenDressedLepton_eta_;
    ...
    unsigned int counter_cached_GenDressedLepton_hasTauAnc_;
    unsigned int counter_uncached_GenDressedLepton_hasTauAnc_;
    ...
    unsigned int counter_cached_GenDressedLepton_mass_;
    unsigned int counter_uncached_GenDressedLepton_mass_;
    vector<LorentzVector> v_GenDressedLepton_p4_;
    TBranch *b_GenDressedLepton_p4_;
    bool loaded_GenDressedLepton_p4_;
    unsigned int counter_cached_GenDressedLepton_p4_;
    unsigned int counter_uncached_GenDressedLepton_p4_;
    ...
    unsigned int counter_cached_GenDressedLepton_pdgId_;
    unsigned int counter_uncached_GenDressedLepton_pdgId_;
    ...
    unsigned int counter_cached_GenDressedLepton_phi_;
    unsigned int counter_uncached_GenDressedLepton_phi_;
    ...
    unsigned int counter_cached_GenDressedLepton_pt_;
    unsigned int counter_uncached_GenDressedLepton_pt_;
    ...
    unsigned int counter_cached_GenIsolatedPhoton_eta_;
    unsigned int counter_uncached_GenIsolatedPhoton_eta_;
    ...
    unsigned int counter_cached_GenIsolatedPhoton_mass_;
    unsigned int counter_uncached_GenIsolatedPhoton_mass_;
    vector<LorentzVector> v_GenIsolatedPhoton_p4_;
    TBranch *b_GenIsolatedPhoton_p4_;
    bool loaded_GenIsolatedPhoton_p4_;
    unsigned int counter_cached_GenIsolatedPhoton_p4_;
    unsigned int counter_uncached_GenIsolatedPhoton_p4_;
    ...
    unsigned int counter_cached_GenIsolatedPhoton_phi_;
    unsigned int counter_uncached_GenIsolatedPhoton_phi_;
    ...
    unsigned int counter_cached_GenIsolatedPhoton_pt_;
    unsigned int counter_uncached_GenIsolatedPhoton_pt_;
    float GenJetAK8_eta_[NGENJETAK8_MAX];
    vector<float> v_GenJetAK8_eta_;
    TBranch *b_GenJetAK8_eta_;
    bool loaded_GenJetAK8_eta_;
    unsigned int counter_cached_GenJetAK8_eta_;
    unsigned int counter_uncached_GenJetAK8_eta_;
    ...
    unsigned int counter_cached_GenJetAK8_hadronFlavour_;
    unsigned int counter_uncached_GenJetAK8_hadronFlavour_;
    float GenJetAK8_mass_[NGENJETAK8_MAX];
    vector<float> v_GenJetAK8_mass_;
    TBranch *b_GenJetAK8_mass_;
    bool loaded_GenJetAK8_mass_;
    unsigned int counter_cached_GenJetAK8_mass_;
    unsigned int counter_uncached_GenJetAK8_mass_;
    vector<LorentzVector> v_GenJetAK8_p4_;
    TBranch *b_GenJetAK8_p4_;
    bool loaded_GenJetAK8_p4_;
    unsigned int counter_cached_GenJetAK8_p4_;
    unsigned int counter_uncached_GenJetAK8_p4_;
    ...
    unsigned int counter_cached_GenJetAK8_partonFlavour_;
    unsigned int counter_uncached_GenJetAK8_partonFlavour_;
    float GenJetAK8_phi_[NGENJETAK8_MAX];
    vector<float> v_GenJetAK8_phi_;
    TBranch *b_GenJetAK8_phi_;
    bool loaded_GenJetAK8_phi_;
    unsigned int counter_cached_GenJetAK8_phi_;
    unsigned int counter_uncached_GenJetAK8_phi_;
    float GenJetAK8_pt_[NGENJETAK8_MAX];
    vector<float> v_GenJetAK8_pt_;
    TBranch *b_GenJetAK8_pt_;
    bool loaded_GenJetAK8_pt_;
    unsigned int counter_cached_GenJetAK8_pt_;
    unsigned int counter_uncached_GenJetAK8_pt_;
    float GenJet_eta_[NGENJET_MAX];
    vector<float> v_GenJet_eta_;
    TBranch *b_GenJet_eta_;
    bool loaded_GenJet_eta_;
    unsigned int counter_cached_GenJet_eta_;
    unsigned int counter_uncached_GenJet_eta_;
    ...
    unsigned int counter_cached_GenJet_hadronFlavour_;
    unsigned int counter_uncached_GenJet_hadronFlavour_;
    float GenJet_mass_[NGENJET_MAX];
    vector<float> v_GenJet_mass_;
    TBranch *b_GenJet_mass_;
    bool loaded_GenJet_mass_;
    unsigned int counter_cached_GenJet_mass_;
    unsigned int counter_uncached_GenJet_mass_;
    vector<LorentzVector> v_GenJet_p4_;
    TBranch *b_GenJet_p4_;
    bool loaded_GenJet_p4_;
    unsigned int counter_cached_GenJet_p4_;
    unsigned int counter_uncached_GenJet_p4_;
    ...
    unsigned int counter_cached_GenJet_partonFlavour_;
    unsigned int counter_uncached_GenJet_partonFlavour_;
    float GenJet_phi_[NGENJET_MAX];
    vector<float> v_GenJet_phi_;
    TBranch *b_GenJet_phi_;
    bool loaded_GenJet_phi_;
    unsigned int counter_cached_GenJet_phi_;
    unsigned int counter_uncached_GenJet_phi_;
    float GenJet_pt_[NGENJET_MAX];
    vector<float> v_GenJet_pt_;
    TBranch *b_GenJet_pt_;
    bool loaded_GenJet_pt_;
    unsigned int counter_cached_GenJet_pt_;
    unsigned int counter_uncached_GenJet_pt_;
    float GenMET_phi_;
    TBranch *b_GenMET_phi_;
    bool loaded_GenMET_phi_;
    unsigned int counter_cached_GenMET_phi_;
    unsigned int counter_uncached_GenMET_phi_;
    float GenMET_pt_;
    TBranch *b_GenMET_pt_;
    bool loaded_GenMET_pt_;
    unsigned int counter_cached_GenMET_pt_;
    unsigned int counter_uncached_GenMET_pt_;
    ...
    unsigned int counter_cached_GenPart_genPartIdxMother_;
    unsigned int counter_uncached_GenPart_genPartIdxMother_;
    float GenPart_mass_[NGENPART_MAX];
    vector<float> v_GenPart_mass_;
    TBranch *b_GenPart_mass_;
    bool loaded_GenPart_mass_;
    unsigned int counter_cached_GenPart_mass_;
    unsigned int counter_uncached_GenPart_mass_;
    vector<LorentzVector> v_GenPart_p4_;
    TBranch *b_GenPart_p4_;
    bool loaded_GenPart_p4_;
    unsigned int counter_cached_GenPart_p4_;
    unsigned int counter_uncached_GenPart_p4_;
    int GenPart_pdgId_[NGENPART_MAX];
    vector<int> v_GenPart_pdgId_;
    TBranch *b_GenPart_pdgId_;
    bool loaded_GenPart_pdgId_;
    unsigned int counter_cached_GenPart_pdgId_;
    unsigned int counter_uncached_GenPart_pdgId_;
    float GenPart_phi_[NGENPART_MAX];
    vector<float> v_GenPart_phi_;
    TBranch *b_GenPart_phi_;
    bool loaded_GenPart_phi_;
    unsigned int counter_cached_GenPart_phi_;
    unsigned int counter_uncached_GenPart_phi_;
    float GenPart_pt_[NGENPART_MAX];
    vector<float> v_GenPart_pt_;
    TBranch *b_GenPart_pt_;
    bool loaded_GenPart_pt_;
    unsigned int counter_cached_GenPart_pt_;
    unsigned int counter_uncached_GenPart_pt_;
    ...
    unsigned int counter_cached_GenPart_statusFlags_;
    unsigned int counter_uncached_GenPart_statusFlags_;
    ...
    unsigned int counter_cached_GenVisTau_charge_;
    unsigned int counter_uncached_GenVisTau_charge_;
    ...
    unsigned int counter_cached_GenVisTau_genPartIdxMother_;
    unsigned int counter_uncached_GenVisTau_genPartIdxMother_;
    float GenVisTau_mass_[NGENVISTAU_MAX];
    vector<float> v_GenVisTau_mass_;
    TBranch *b_GenVisTau_mass_;
    bool loaded_GenVisTau_mass_;
    unsigned int counter_cached_GenVisTau_mass_;
    unsigned int counter_uncached_GenVisTau_mass_;
    vector<LorentzVector> v_GenVisTau_p4_;
    TBranch *b_GenVisTau_p4_;
    bool loaded_GenVisTau_p4_;
    unsigned int counter_cached_GenVisTau_p4_;
    unsigned int counter_uncached_GenVisTau_p4_;
    float GenVisTau_phi_[NGENVISTAU_MAX];
    vector<float> v_GenVisTau_phi_;
    TBranch *b_GenVisTau_phi_;
    bool loaded_GenVisTau_phi_;
    unsigned int counter_cached_GenVisTau_phi_;
    unsigned int counter_uncached_GenVisTau_phi_;
    float GenVisTau_pt_[NGENVISTAU_MAX];
    vector<float> v_GenVisTau_pt_;
    TBranch *b_GenVisTau_pt_;
    bool loaded_GenVisTau_pt_;
    unsigned int counter_cached_GenVisTau_pt_;
    unsigned int counter_uncached_GenVisTau_pt_;
    ...
    unsigned int counter_cached_Generator_binvar_;
    unsigned int counter_uncached_Generator_binvar_;
    int Generator_id1_;
    TBranch *b_Generator_id1_;
    bool loaded_Generator_id1_;
    unsigned int counter_cached_Generator_id1_;
    unsigned int counter_uncached_Generator_id1_;
    int Generator_id2_;
    TBranch *b_Generator_id2_;
    bool loaded_Generator_id2_;
    unsigned int counter_cached_Generator_id2_;
    unsigned int counter_uncached_Generator_id2_;
    float Generator_scalePDF_;
    TBranch *b_Generator_scalePDF_;
    bool loaded_Generator_scalePDF_;
    unsigned int counter_cached_Generator_scalePDF_;
    unsigned int counter_uncached_Generator_scalePDF_;
    float Generator_weight_;
    TBranch *b_Generator_weight_;
    bool loaded_Generator_weight_;
    unsigned int counter_cached_Generator_weight_;
    unsigned int counter_uncached_Generator_weight_;
    float Generator_x1_;
    TBranch *b_Generator_x1_;
    bool loaded_Generator_x1_;
    unsigned int counter_cached_Generator_x1_;
    unsigned int counter_uncached_Generator_x1_;
    float Generator_x2_;
    TBranch *b_Generator_x2_;
    bool loaded_Generator_x2_;
    unsigned int counter_cached_Generator_x2_;
    unsigned int counter_uncached_Generator_x2_;
    float Generator_xpdf1_;
    TBranch *b_Generator_xpdf1_;
    bool loaded_Generator_xpdf1_;
    unsigned int counter_cached_Generator_xpdf1_;
    unsigned int counter_uncached_Generator_xpdf1_;
    float Generator_xpdf2_;
    TBranch *b_Generator_xpdf2_;
    bool loaded_Generator_xpdf2_;
    unsigned int counter_cached_Generator_xpdf2_;
    unsigned int counter_uncached_Generator_xpdf2_;
    bool HLT_AK4CaloJet100_;
    TBranch *b_HLT_AK4CaloJet100_;
    bool loaded_HLT_AK4CaloJet100_;
    unsigned int counter_cached_HLT_AK4CaloJet100_;
    unsigned int counter_uncached_HLT_AK4CaloJet100_;
    bool HLT_AK4CaloJet120_;
    TBranch *b_HLT_AK4CaloJet120_;
    bool loaded_HLT_AK4CaloJet120_;
    unsigned int counter_cached_HLT_AK4CaloJet120_;
    unsigned int counter_uncached_HLT_AK4CaloJet120_;
    bool HLT_AK4CaloJet30_;
    TBranch *b_HLT_AK4CaloJet30_;
    bool loaded_HLT_AK4CaloJet30_;
    unsigned int counter_cached_HLT_AK4CaloJet30_;
    unsigned int counter_uncached_HLT_AK4CaloJet30_;
    bool HLT_AK4CaloJet40_;
    TBranch *b_HLT_AK4CaloJet40_;
    bool loaded_HLT_AK4CaloJet40_;
    unsigned int counter_cached_HLT_AK4CaloJet40_;
    unsigned int counter_uncached_HLT_AK4CaloJet40_;
    bool HLT_AK4CaloJet50_;
    TBranch *b_HLT_AK4CaloJet50_;
    bool loaded_HLT_AK4CaloJet50_;
    unsigned int counter_cached_HLT_AK4CaloJet50_;
    unsigned int counter_uncached_HLT_AK4CaloJet50_;
    bool HLT_AK4CaloJet80_;
    TBranch *b_HLT_AK4CaloJet80_;
    bool loaded_HLT_AK4CaloJet80_;
    unsigned int counter_cached_HLT_AK4CaloJet80_;
    unsigned int counter_uncached_HLT_AK4CaloJet80_;
    bool HLT_AK4PFJet100_;
    TBranch *b_HLT_AK4PFJet100_;
    bool loaded_HLT_AK4PFJet100_;
    unsigned int counter_cached_HLT_AK4PFJet100_;
    unsigned int counter_uncached_HLT_AK4PFJet100_;
    bool HLT_AK4PFJet120_;
    TBranch *b_HLT_AK4PFJet120_;
    bool loaded_HLT_AK4PFJet120_;
    unsigned int counter_cached_HLT_AK4PFJet120_;
    unsigned int counter_uncached_HLT_AK4PFJet120_;
    bool HLT_AK4PFJet30_;
    TBranch *b_HLT_AK4PFJet30_;
    bool loaded_HLT_AK4PFJet30_;
    unsigned int counter_cached_HLT_AK4PFJet30_;
    unsigned int counter_uncached_HLT_AK4PFJet30_;
    bool HLT_AK4PFJet50_;
    TBranch *b_HLT_AK4PFJet50_;
    bool loaded_HLT_AK4PFJet50_;
    unsigned int counter_cached_HLT_AK4PFJet50_;
    unsigned int counter_uncached_HLT_AK4PFJet50_;
    bool HLT_AK4PFJet80_;
    TBranch *b_HLT_AK4PFJet80_;
    bool loaded_HLT_AK4PFJet80_;
    unsigned int counter_cached_HLT_AK4PFJet80_;
    unsigned int counter_uncached_HLT_AK4PFJet80_;
    bool HLT_AK8PFHT750_TrimMass50_;
    TBranch *b_HLT_AK8PFHT750_TrimMass50_;
    bool loaded_HLT_AK8PFHT750_TrimMass50_;
    unsigned int counter_cached_HLT_AK8PFHT750_TrimMass50_;
    unsigned int counter_uncached_HLT_AK8PFHT750_TrimMass50_;
    bool HLT_AK8PFHT800_TrimMass50_;
    TBranch *b_HLT_AK8PFHT800_TrimMass50_;
    bool loaded_HLT_AK8PFHT800_TrimMass50_;
    unsigned int counter_cached_HLT_AK8PFHT800_TrimMass50_;
    unsigned int counter_uncached_HLT_AK8PFHT800_TrimMass50_;
    bool HLT_AK8PFHT850_TrimMass50_;
    TBranch *b_HLT_AK8PFHT850_TrimMass50_;
    bool loaded_HLT_AK8PFHT850_TrimMass50_;
    unsigned int counter_cached_HLT_AK8PFHT850_TrimMass50_;
    unsigned int counter_uncached_HLT_AK8PFHT850_TrimMass50_;
    bool HLT_AK8PFHT900_TrimMass50_;
    TBranch *b_HLT_AK8PFHT900_TrimMass50_;
    bool loaded_HLT_AK8PFHT900_TrimMass50_;
    unsigned int counter_cached_HLT_AK8PFHT900_TrimMass50_;
    unsigned int counter_uncached_HLT_AK8PFHT900_TrimMass50_;
    bool HLT_AK8PFJet140_;
    TBranch *b_HLT_AK8PFJet140_;
    bool loaded_HLT_AK8PFJet140_;
    unsigned int counter_cached_HLT_AK8PFJet140_;
    unsigned int counter_uncached_HLT_AK8PFJet140_;
    bool HLT_AK8PFJet15_;
    TBranch *b_HLT_AK8PFJet15_;
    bool loaded_HLT_AK8PFJet15_;
    unsigned int counter_cached_HLT_AK8PFJet15_;
    unsigned int counter_uncached_HLT_AK8PFJet15_;
    bool HLT_AK8PFJet200_;
    TBranch *b_HLT_AK8PFJet200_;
    bool loaded_HLT_AK8PFJet200_;
    unsigned int counter_cached_HLT_AK8PFJet200_;
    unsigned int counter_uncached_HLT_AK8PFJet200_;
    bool HLT_AK8PFJet25_;
    TBranch *b_HLT_AK8PFJet25_;
    bool loaded_HLT_AK8PFJet25_;
    unsigned int counter_cached_HLT_AK8PFJet25_;
    unsigned int counter_uncached_HLT_AK8PFJet25_;
    bool HLT_AK8PFJet260_;
    TBranch *b_HLT_AK8PFJet260_;
    bool loaded_HLT_AK8PFJet260_;
    unsigned int counter_cached_HLT_AK8PFJet260_;
    unsigned int counter_uncached_HLT_AK8PFJet260_;
    bool HLT_AK8PFJet320_;
    TBranch *b_HLT_AK8PFJet320_;
    bool loaded_HLT_AK8PFJet320_;
    unsigned int counter_cached_HLT_AK8PFJet320_;
    unsigned int counter_uncached_HLT_AK8PFJet320_;
    ...
    unsigned int counter_cached_HLT_AK8PFJet330_TrimMass30_PFAK8BTagDeepCSV_p1_;
    unsigned int counter_uncached_HLT_AK8PFJet330_TrimMass30_PFAK8BTagDeepCSV_p1_;
    ...
    unsigned int counter_cached_HLT_AK8PFJet330_TrimMass30_PFAK8BTagDeepCSV_p17_;
    unsigned int counter_uncached_HLT_AK8PFJet330_TrimMass30_PFAK8BTagDeepCSV_p17_;
    ...
    unsigned int counter_cached_HLT_AK8PFJet330_TrimMass30_PFAK8BoostedDoubleB_np2_;
    unsigned int counter_uncached_HLT_AK8PFJet330_TrimMass30_PFAK8BoostedDoubleB_np2_;
    ...
    unsigned int counter_cached_HLT_AK8PFJet330_TrimMass30_PFAK8BoostedDoubleB_np4_;
    unsigned int counter_uncached_HLT_AK8PFJet330_TrimMass30_PFAK8BoostedDoubleB_np4_;
    ...
    unsigned int counter_cached_HLT_AK8PFJet330_TrimMass30_PFAK8BoostedDoubleB_p02_;
    unsigned int counter_uncached_HLT_AK8PFJet330_TrimMass30_PFAK8BoostedDoubleB_p02_;
    bool HLT_AK8PFJet360_TrimMass30_;
    TBranch *b_HLT_AK8PFJet360_TrimMass30_;
    bool loaded_HLT_AK8PFJet360_TrimMass30_;
    unsigned int counter_cached_HLT_AK8PFJet360_TrimMass30_;
    unsigned int counter_uncached_HLT_AK8PFJet360_TrimMass30_;
    bool HLT_AK8PFJet380_TrimMass30_;
    TBranch *b_HLT_AK8PFJet380_TrimMass30_;
    bool loaded_HLT_AK8PFJet380_TrimMass30_;
    unsigned int counter_cached_HLT_AK8PFJet380_TrimMass30_;
    unsigned int counter_uncached_HLT_AK8PFJet380_TrimMass30_;
    bool HLT_AK8PFJet40_;
    TBranch *b_HLT_AK8PFJet40_;
    bool loaded_HLT_AK8PFJet40_;
    unsigned int counter_cached_HLT_AK8PFJet40_;
    unsigned int counter_uncached_HLT_AK8PFJet40_;
    bool HLT_AK8PFJet400_;
    TBranch *b_HLT_AK8PFJet400_;
    bool loaded_HLT_AK8PFJet400_;
    unsigned int counter_cached_HLT_AK8PFJet400_;
    unsigned int counter_uncached_HLT_AK8PFJet400_;
    bool HLT_AK8PFJet400_TrimMass30_;
    TBranch *b_HLT_AK8PFJet400_TrimMass30_;
    bool loaded_HLT_AK8PFJet400_TrimMass30_;
    unsigned int counter_cached_HLT_AK8PFJet400_TrimMass30_;
    unsigned int counter_uncached_HLT_AK8PFJet400_TrimMass30_;
    bool HLT_AK8PFJet420_TrimMass30_;
    TBranch *b_HLT_AK8PFJet420_TrimMass30_;
    bool loaded_HLT_AK8PFJet420_TrimMass30_;
    unsigned int counter_cached_HLT_AK8PFJet420_TrimMass30_;
    unsigned int counter_uncached_HLT_AK8PFJet420_TrimMass30_;
    bool HLT_AK8PFJet450_;
    TBranch *b_HLT_AK8PFJet450_;
    bool loaded_HLT_AK8PFJet450_;
    unsigned int counter_cached_HLT_AK8PFJet450_;
    unsigned int counter_uncached_HLT_AK8PFJet450_;
    bool HLT_AK8PFJet500_;
    TBranch *b_HLT_AK8PFJet500_;
    bool loaded_HLT_AK8PFJet500_;
    unsigned int counter_cached_HLT_AK8PFJet500_;
    unsigned int counter_uncached_HLT_AK8PFJet500_;
    bool HLT_AK8PFJet550_;
    TBranch *b_HLT_AK8PFJet550_;
    bool loaded_HLT_AK8PFJet550_;
    unsigned int counter_cached_HLT_AK8PFJet550_;
    unsigned int counter_uncached_HLT_AK8PFJet550_;
    bool HLT_AK8PFJet60_;
    TBranch *b_HLT_AK8PFJet60_;
    bool loaded_HLT_AK8PFJet60_;
    unsigned int counter_cached_HLT_AK8PFJet60_;
    unsigned int counter_uncached_HLT_AK8PFJet60_;
    bool HLT_AK8PFJet80_;
    TBranch *b_HLT_AK8PFJet80_;
    bool loaded_HLT_AK8PFJet80_;
    unsigned int counter_cached_HLT_AK8PFJet80_;
    unsigned int counter_uncached_HLT_AK8PFJet80_;
    bool HLT_AK8PFJetFwd140_;
    TBranch *b_HLT_AK8PFJetFwd140_;
    bool loaded_HLT_AK8PFJetFwd140_;
    unsigned int counter_cached_HLT_AK8PFJetFwd140_;
    unsigned int counter_uncached_HLT_AK8PFJetFwd140_;
    bool HLT_AK8PFJetFwd15_;
    TBranch *b_HLT_AK8PFJetFwd15_;
    bool loaded_HLT_AK8PFJetFwd15_;
    unsigned int counter_cached_HLT_AK8PFJetFwd15_;
    unsigned int counter_uncached_HLT_AK8PFJetFwd15_;
    bool HLT_AK8PFJetFwd200_;
    TBranch *b_HLT_AK8PFJetFwd200_;
    bool loaded_HLT_AK8PFJetFwd200_;
    unsigned int counter_cached_HLT_AK8PFJetFwd200_;
    unsigned int counter_uncached_HLT_AK8PFJetFwd200_;
    bool HLT_AK8PFJetFwd25_;
    TBranch *b_HLT_AK8PFJetFwd25_;
    bool loaded_HLT_AK8PFJetFwd25_;
    unsigned int counter_cached_HLT_AK8PFJetFwd25_;
    unsigned int counter_uncached_HLT_AK8PFJetFwd25_;
    bool HLT_AK8PFJetFwd260_;
    TBranch *b_HLT_AK8PFJetFwd260_;
    bool loaded_HLT_AK8PFJetFwd260_;
    unsigned int counter_cached_HLT_AK8PFJetFwd260_;
    unsigned int counter_uncached_HLT_AK8PFJetFwd260_;
    bool HLT_AK8PFJetFwd320_;
    TBranch *b_HLT_AK8PFJetFwd320_;
    bool loaded_HLT_AK8PFJetFwd320_;
    unsigned int counter_cached_HLT_AK8PFJetFwd320_;
    unsigned int counter_uncached_HLT_AK8PFJetFwd320_;
    bool HLT_AK8PFJetFwd40_;
    TBranch *b_HLT_AK8PFJetFwd40_;
    bool loaded_HLT_AK8PFJetFwd40_;
    unsigned int counter_cached_HLT_AK8PFJetFwd40_;
    unsigned int counter_uncached_HLT_AK8PFJetFwd40_;
    bool HLT_AK8PFJetFwd400_;
    TBranch *b_HLT_AK8PFJetFwd400_;
    bool loaded_HLT_AK8PFJetFwd400_;
    unsigned int counter_cached_HLT_AK8PFJetFwd400_;
    unsigned int counter_uncached_HLT_AK8PFJetFwd400_;
    bool HLT_AK8PFJetFwd450_;
    TBranch *b_HLT_AK8PFJetFwd450_;
    bool loaded_HLT_AK8PFJetFwd450_;
    unsigned int counter_cached_HLT_AK8PFJetFwd450_;
    unsigned int counter_uncached_HLT_AK8PFJetFwd450_;
    bool HLT_AK8PFJetFwd500_;
    TBranch *b_HLT_AK8PFJetFwd500_;
    bool loaded_HLT_AK8PFJetFwd500_;
    unsigned int counter_cached_HLT_AK8PFJetFwd500_;
    unsigned int counter_uncached_HLT_AK8PFJetFwd500_;
    bool HLT_AK8PFJetFwd60_;
    TBranch *b_HLT_AK8PFJetFwd60_;
    bool loaded_HLT_AK8PFJetFwd60_;
    unsigned int counter_cached_HLT_AK8PFJetFwd60_;
    unsigned int counter_uncached_HLT_AK8PFJetFwd60_;
    bool HLT_AK8PFJetFwd80_;
    TBranch *b_HLT_AK8PFJetFwd80_;
    bool loaded_HLT_AK8PFJetFwd80_;
    unsigned int counter_cached_HLT_AK8PFJetFwd80_;
    unsigned int counter_uncached_HLT_AK8PFJetFwd80_;
    bool HLT_BTagMu_AK4DiJet110_Mu5_;
    TBranch *b_HLT_BTagMu_AK4DiJet110_Mu5_;
    bool loaded_HLT_BTagMu_AK4DiJet110_Mu5_;
    unsigned int counter_cached_HLT_BTagMu_AK4DiJet110_Mu5_;
    unsigned int counter_uncached_HLT_BTagMu_AK4DiJet110_Mu5_;
    ...
    unsigned int counter_cached_HLT_BTagMu_AK4DiJet110_Mu5_noalgo_;
    unsigned int counter_uncached_HLT_BTagMu_AK4DiJet110_Mu5_noalgo_;
    bool HLT_BTagMu_AK4DiJet170_Mu5_;
    TBranch *b_HLT_BTagMu_AK4DiJet170_Mu5_;
    bool loaded_HLT_BTagMu_AK4DiJet170_Mu5_;
    unsigned int counter_cached_HLT_BTagMu_AK4DiJet170_Mu5_;
    unsigned int counter_uncached_HLT_BTagMu_AK4DiJet170_Mu5_;
    ...
    unsigned int counter_cached_HLT_BTagMu_AK4DiJet170_Mu5_noalgo_;
    unsigned int counter_uncached_HLT_BTagMu_AK4DiJet170_Mu5_noalgo_;
    bool HLT_BTagMu_AK4DiJet20_Mu5_;
    TBranch *b_HLT_BTagMu_AK4DiJet20_Mu5_;
    bool loaded_HLT_BTagMu_AK4DiJet20_Mu5_;
    unsigned int counter_cached_HLT_BTagMu_AK4DiJet20_Mu5_;
    unsigned int counter_uncached_HLT_BTagMu_AK4DiJet20_Mu5_;
    ...
    unsigned int counter_cached_HLT_BTagMu_AK4DiJet20_Mu5_noalgo_;
    unsigned int counter_uncached_HLT_BTagMu_AK4DiJet20_Mu5_noalgo_;
    bool HLT_BTagMu_AK4DiJet40_Mu5_;
    TBranch *b_HLT_BTagMu_AK4DiJet40_Mu5_;
    bool loaded_HLT_BTagMu_AK4DiJet40_Mu5_;
    unsigned int counter_cached_HLT_BTagMu_AK4DiJet40_Mu5_;
    unsigned int counter_uncached_HLT_BTagMu_AK4DiJet40_Mu5_;
    ...
    unsigned int counter_cached_HLT_BTagMu_AK4DiJet40_Mu5_noalgo_;
    unsigned int counter_uncached_HLT_BTagMu_AK4DiJet40_Mu5_noalgo_;
    bool HLT_BTagMu_AK4DiJet70_Mu5_;
    TBranch *b_HLT_BTagMu_AK4DiJet70_Mu5_;
    bool loaded_HLT_BTagMu_AK4DiJet70_Mu5_;
    unsigned int counter_cached_HLT_BTagMu_AK4DiJet70_Mu5_;
    unsigned int counter_uncached_HLT_BTagMu_AK4DiJet70_Mu5_;
    ...
    unsigned int counter_cached_HLT_BTagMu_AK4DiJet70_Mu5_noalgo_;
    unsigned int counter_uncached_HLT_BTagMu_AK4DiJet70_Mu5_noalgo_;
    bool HLT_BTagMu_AK4Jet300_Mu5_;
    TBranch *b_HLT_BTagMu_AK4Jet300_Mu5_;
    bool loaded_HLT_BTagMu_AK4Jet300_Mu5_;
    unsigned int counter_cached_HLT_BTagMu_AK4Jet300_Mu5_;
    unsigned int counter_uncached_HLT_BTagMu_AK4Jet300_Mu5_;
    ...
    unsigned int counter_cached_HLT_BTagMu_AK4Jet300_Mu5_noalgo_;
    unsigned int counter_uncached_HLT_BTagMu_AK4Jet300_Mu5_noalgo_;
    bool HLT_BTagMu_AK8DiJet170_Mu5_;
    TBranch *b_HLT_BTagMu_AK8DiJet170_Mu5_;
    bool loaded_HLT_BTagMu_AK8DiJet170_Mu5_;
    unsigned int counter_cached_HLT_BTagMu_AK8DiJet170_Mu5_;
    unsigned int counter_uncached_HLT_BTagMu_AK8DiJet170_Mu5_;
    ...
    unsigned int counter_cached_HLT_BTagMu_AK8DiJet170_Mu5_noalgo_;
    unsigned int counter_uncached_HLT_BTagMu_AK8DiJet170_Mu5_noalgo_;
    bool HLT_BTagMu_AK8Jet170_DoubleMu5_;
    TBranch *b_HLT_BTagMu_AK8Jet170_DoubleMu5_;
    bool loaded_HLT_BTagMu_AK8Jet170_DoubleMu5_;
    unsigned int counter_cached_HLT_BTagMu_AK8Jet170_DoubleMu5_;
    unsigned int counter_uncached_HLT_BTagMu_AK8Jet170_DoubleMu5_;
    ...
    unsigned int counter_cached_HLT_BTagMu_AK8Jet170_DoubleMu5_noalgo_;
    unsigned int counter_uncached_HLT_BTagMu_AK8Jet170_DoubleMu5_noalgo_;
    bool HLT_BTagMu_AK8Jet300_Mu5_;
    TBranch *b_HLT_BTagMu_AK8Jet300_Mu5_;
    bool loaded_HLT_BTagMu_AK8Jet300_Mu5_;
    unsigned int counter_cached_HLT_BTagMu_AK8Jet300_Mu5_;
    unsigned int counter_uncached_HLT_BTagMu_AK8Jet300_Mu5_;
    ...
    unsigned int counter_cached_HLT_BTagMu_AK8Jet300_Mu5_noalgo_;
    unsigned int counter_uncached_HLT_BTagMu_AK8Jet300_Mu5_noalgo_;
    bool HLT_CDC_L2cosmic_5_er1p0_;
    TBranch *b_HLT_CDC_L2cosmic_5_er1p0_;
    bool loaded_HLT_CDC_L2cosmic_5_er1p0_;
    unsigned int counter_cached_HLT_CDC_L2cosmic_5_er1p0_;
    unsigned int counter_uncached_HLT_CDC_L2cosmic_5_er1p0_;
    bool HLT_CDC_L2cosmic_5p5_er1p0_;
    TBranch *b_HLT_CDC_L2cosmic_5p5_er1p0_;
    bool loaded_HLT_CDC_L2cosmic_5p5_er1p0_;
    unsigned int counter_cached_HLT_CDC_L2cosmic_5p5_er1p0_;
    unsigned int counter_uncached_HLT_CDC_L2cosmic_5p5_er1p0_;
    bool HLT_CaloJet500_NoJetID_;
    TBranch *b_HLT_CaloJet500_NoJetID_;
    bool loaded_HLT_CaloJet500_NoJetID_;
    unsigned int counter_cached_HLT_CaloJet500_NoJetID_;
    unsigned int counter_uncached_HLT_CaloJet500_NoJetID_;
    bool HLT_CaloJet550_NoJetID_;
    TBranch *b_HLT_CaloJet550_NoJetID_;
    bool loaded_HLT_CaloJet550_NoJetID_;
    unsigned int counter_cached_HLT_CaloJet550_NoJetID_;
    unsigned int counter_uncached_HLT_CaloJet550_NoJetID_;
    bool HLT_CaloMET100_HBHECleaned_;
    TBranch *b_HLT_CaloMET100_HBHECleaned_;
    bool loaded_HLT_CaloMET100_HBHECleaned_;
    unsigned int counter_cached_HLT_CaloMET100_HBHECleaned_;
    unsigned int counter_uncached_HLT_CaloMET100_HBHECleaned_;
    bool HLT_CaloMET100_NotCleaned_;
    TBranch *b_HLT_CaloMET100_NotCleaned_;
    bool loaded_HLT_CaloMET100_NotCleaned_;
    unsigned int counter_cached_HLT_CaloMET100_NotCleaned_;
    unsigned int counter_uncached_HLT_CaloMET100_NotCleaned_;
    bool HLT_CaloMET110_NotCleaned_;
    TBranch *b_HLT_CaloMET110_NotCleaned_;
    bool loaded_HLT_CaloMET110_NotCleaned_;
    unsigned int counter_cached_HLT_CaloMET110_NotCleaned_;
    unsigned int counter_uncached_HLT_CaloMET110_NotCleaned_;
    bool HLT_CaloMET250_HBHECleaned_;
    TBranch *b_HLT_CaloMET250_HBHECleaned_;
    bool loaded_HLT_CaloMET250_HBHECleaned_;
    unsigned int counter_cached_HLT_CaloMET250_HBHECleaned_;
    unsigned int counter_uncached_HLT_CaloMET250_HBHECleaned_;
    bool HLT_CaloMET250_NotCleaned_;
    TBranch *b_HLT_CaloMET250_NotCleaned_;
    bool loaded_HLT_CaloMET250_NotCleaned_;
    unsigned int counter_cached_HLT_CaloMET250_NotCleaned_;
    unsigned int counter_uncached_HLT_CaloMET250_NotCleaned_;
    bool HLT_CaloMET300_HBHECleaned_;
    TBranch *b_HLT_CaloMET300_HBHECleaned_;
    bool loaded_HLT_CaloMET300_HBHECleaned_;
    unsigned int counter_cached_HLT_CaloMET300_HBHECleaned_;
    unsigned int counter_uncached_HLT_CaloMET300_HBHECleaned_;
    bool HLT_CaloMET350_HBHECleaned_;
    TBranch *b_HLT_CaloMET350_HBHECleaned_;
    bool loaded_HLT_CaloMET350_HBHECleaned_;
    unsigned int counter_cached_HLT_CaloMET350_HBHECleaned_;
    unsigned int counter_uncached_HLT_CaloMET350_HBHECleaned_;
    bool HLT_CaloMET70_HBHECleaned_;
    TBranch *b_HLT_CaloMET70_HBHECleaned_;
    bool loaded_HLT_CaloMET70_HBHECleaned_;
    unsigned int counter_cached_HLT_CaloMET70_HBHECleaned_;
    unsigned int counter_uncached_HLT_CaloMET70_HBHECleaned_;
    bool HLT_CaloMET80_HBHECleaned_;
    TBranch *b_HLT_CaloMET80_HBHECleaned_;
    bool loaded_HLT_CaloMET80_HBHECleaned_;
    unsigned int counter_cached_HLT_CaloMET80_HBHECleaned_;
    unsigned int counter_uncached_HLT_CaloMET80_HBHECleaned_;
    bool HLT_CaloMET80_NotCleaned_;
    TBranch *b_HLT_CaloMET80_NotCleaned_;
    bool loaded_HLT_CaloMET80_NotCleaned_;
    unsigned int counter_cached_HLT_CaloMET80_NotCleaned_;
    unsigned int counter_uncached_HLT_CaloMET80_NotCleaned_;
    bool HLT_CaloMET90_HBHECleaned_;
    TBranch *b_HLT_CaloMET90_HBHECleaned_;
    bool loaded_HLT_CaloMET90_HBHECleaned_;
    unsigned int counter_cached_HLT_CaloMET90_HBHECleaned_;
    unsigned int counter_uncached_HLT_CaloMET90_HBHECleaned_;
    bool HLT_CaloMET90_NotCleaned_;
    TBranch *b_HLT_CaloMET90_NotCleaned_;
    bool loaded_HLT_CaloMET90_NotCleaned_;
    unsigned int counter_cached_HLT_CaloMET90_NotCleaned_;
    unsigned int counter_uncached_HLT_CaloMET90_NotCleaned_;
    bool HLT_CaloMHT90_;
    TBranch *b_HLT_CaloMHT90_;
    bool loaded_HLT_CaloMHT90_;
    unsigned int counter_cached_HLT_CaloMHT90_;
    unsigned int counter_uncached_HLT_CaloMHT90_;
    ...
    unsigned int counter_cached_HLT_DiEle27_WPTightCaloOnly_L1DoubleEG_;
    unsigned int counter_uncached_HLT_DiEle27_WPTightCaloOnly_L1DoubleEG_;
    ...
    unsigned int counter_cached_HLT_DiJet110_35_Mjj650_PFMET110_;
    unsigned int counter_uncached_HLT_DiJet110_35_Mjj650_PFMET110_;
    ...
    unsigned int counter_cached_HLT_DiJet110_35_Mjj650_PFMET120_;
    unsigned int counter_uncached_HLT_DiJet110_35_Mjj650_PFMET120_;
    ...
    unsigned int counter_cached_HLT_DiJet110_35_Mjj650_PFMET130_;
    unsigned int counter_uncached_HLT_DiJet110_35_Mjj650_PFMET130_;
    ...
    unsigned int counter_cached_HLT_DiMu4_Ele9_CaloIdL_TrackIdL_DZ_Mass3p8_;
    unsigned int counter_uncached_HLT_DiMu4_Ele9_CaloIdL_TrackIdL_DZ_Mass3p8_;
    ...
    unsigned int counter_cached_HLT_DiMu9_Ele9_CaloIdL_TrackIdL_;
    unsigned int counter_uncached_HLT_DiMu9_Ele9_CaloIdL_TrackIdL_;
    ...
    unsigned int counter_cached_HLT_DiMu9_Ele9_CaloIdL_TrackIdL_DZ_;
    unsigned int counter_uncached_HLT_DiMu9_Ele9_CaloIdL_TrackIdL_DZ_;
    bool HLT_DiPFJetAve100_HFJEC_;
    TBranch *b_HLT_DiPFJetAve100_HFJEC_;
    bool loaded_HLT_DiPFJetAve100_HFJEC_;
    unsigned int counter_cached_HLT_DiPFJetAve100_HFJEC_;
    unsigned int counter_uncached_HLT_DiPFJetAve100_HFJEC_;
    bool HLT_DiPFJetAve140_;
    TBranch *b_HLT_DiPFJetAve140_;
    bool loaded_HLT_DiPFJetAve140_;
    unsigned int counter_cached_HLT_DiPFJetAve140_;
    unsigned int counter_uncached_HLT_DiPFJetAve140_;
    bool HLT_DiPFJetAve160_HFJEC_;
    TBranch *b_HLT_DiPFJetAve160_HFJEC_;
    bool loaded_HLT_DiPFJetAve160_HFJEC_;
    unsigned int counter_cached_HLT_DiPFJetAve160_HFJEC_;
    unsigned int counter_uncached_HLT_DiPFJetAve160_HFJEC_;
    bool HLT_DiPFJetAve200_;
    TBranch *b_HLT_DiPFJetAve200_;
    bool loaded_HLT_DiPFJetAve200_;
    unsigned int counter_cached_HLT_DiPFJetAve200_;
    unsigned int counter_uncached_HLT_DiPFJetAve200_;
    bool HLT_DiPFJetAve220_HFJEC_;
    TBranch *b_HLT_DiPFJetAve220_HFJEC_;
    bool loaded_HLT_DiPFJetAve220_HFJEC_;
    unsigned int counter_cached_HLT_DiPFJetAve220_HFJEC_;
    unsigned int counter_uncached_HLT_DiPFJetAve220_HFJEC_;
    bool HLT_DiPFJetAve260_;
    TBranch *b_HLT_DiPFJetAve260_;
    bool loaded_HLT_DiPFJetAve260_;
    unsigned int counter_cached_HLT_DiPFJetAve260_;
    unsigned int counter_uncached_HLT_DiPFJetAve260_;
    bool HLT_DiPFJetAve300_HFJEC_;
    TBranch *b_HLT_DiPFJetAve300_HFJEC_;
    bool loaded_HLT_DiPFJetAve300_HFJEC_;
    unsigned int counter_cached_HLT_DiPFJetAve300_HFJEC_;
    unsigned int counter_uncached_HLT_DiPFJetAve300_HFJEC_;
    bool HLT_DiPFJetAve320_;
    TBranch *b_HLT_DiPFJetAve320_;
    bool loaded_HLT_DiPFJetAve320_;
    unsigned int counter_cached_HLT_DiPFJetAve320_;
    unsigned int counter_uncached_HLT_DiPFJetAve320_;
    bool HLT_DiPFJetAve40_;
    TBranch *b_HLT_DiPFJetAve40_;
    bool loaded_HLT_DiPFJetAve40_;
    unsigned int counter_cached_HLT_DiPFJetAve40_;
    unsigned int counter_uncached_HLT_DiPFJetAve40_;
    bool HLT_DiPFJetAve400_;
    TBranch *b_HLT_DiPFJetAve400_;
    bool loaded_HLT_DiPFJetAve400_;
    unsigned int counter_cached_HLT_DiPFJetAve400_;
    unsigned int counter_uncached_HLT_DiPFJetAve400_;
    bool HLT_DiPFJetAve500_;
    TBranch *b_HLT_DiPFJetAve500_;
    bool loaded_HLT_DiPFJetAve500_;
    unsigned int counter_cached_HLT_DiPFJetAve500_;
    unsigned int counter_uncached_HLT_DiPFJetAve500_;
    bool HLT_DiPFJetAve60_;
    TBranch *b_HLT_DiPFJetAve60_;
    bool loaded_HLT_DiPFJetAve60_;
    unsigned int counter_cached_HLT_DiPFJetAve60_;
    unsigned int counter_uncached_HLT_DiPFJetAve60_;
    bool HLT_DiPFJetAve60_HFJEC_;
    TBranch *b_HLT_DiPFJetAve60_HFJEC_;
    bool loaded_HLT_DiPFJetAve60_HFJEC_;
    unsigned int counter_cached_HLT_DiPFJetAve60_HFJEC_;
    unsigned int counter_uncached_HLT_DiPFJetAve60_HFJEC_;
    bool HLT_DiPFJetAve80_;
    TBranch *b_HLT_DiPFJetAve80_;
    bool loaded_HLT_DiPFJetAve80_;
    unsigned int counter_cached_HLT_DiPFJetAve80_;
    unsigned int counter_uncached_HLT_DiPFJetAve80_;
    bool HLT_DiPFJetAve80_HFJEC_;
    TBranch *b_HLT_DiPFJetAve80_HFJEC_;
    bool loaded_HLT_DiPFJetAve80_HFJEC_;
    unsigned int counter_cached_HLT_DiPFJetAve80_HFJEC_;
    unsigned int counter_uncached_HLT_DiPFJetAve80_HFJEC_;
    ...
    unsigned int counter_cached_HLT_DiSC30_18_EIso_AND_HE_Mass70_;
    unsigned int counter_uncached_HLT_DiSC30_18_EIso_AND_HE_Mass70_;
    bool HLT_Dimuon0_Jpsi_;
    TBranch *b_HLT_Dimuon0_Jpsi_;
    bool loaded_HLT_Dimuon0_Jpsi_;
    unsigned int counter_cached_HLT_Dimuon0_Jpsi_;
    unsigned int counter_uncached_HLT_Dimuon0_Jpsi_;
    bool HLT_Dimuon0_Jpsi3p5_Muon2_;
    TBranch *b_HLT_Dimuon0_Jpsi3p5_Muon2_;
    bool loaded_HLT_Dimuon0_Jpsi3p5_Muon2_;
    unsigned int counter_cached_HLT_Dimuon0_Jpsi3p5_Muon2_;
    unsigned int counter_uncached_HLT_Dimuon0_Jpsi3p5_Muon2_;
    bool HLT_Dimuon0_Jpsi_L1_4R_0er1p5R_;
    TBranch *b_HLT_Dimuon0_Jpsi_L1_4R_0er1p5R_;
    bool loaded_HLT_Dimuon0_Jpsi_L1_4R_0er1p5R_;
    unsigned int counter_cached_HLT_Dimuon0_Jpsi_L1_4R_0er1p5R_;
    unsigned int counter_uncached_HLT_Dimuon0_Jpsi_L1_4R_0er1p5R_;
    bool HLT_Dimuon0_Jpsi_L1_NoOS_;
    TBranch *b_HLT_Dimuon0_Jpsi_L1_NoOS_;
    bool loaded_HLT_Dimuon0_Jpsi_L1_NoOS_;
    unsigned int counter_cached_HLT_Dimuon0_Jpsi_L1_NoOS_;
    unsigned int counter_uncached_HLT_Dimuon0_Jpsi_L1_NoOS_;
    bool HLT_Dimuon0_Jpsi_NoVertexing_;
    TBranch *b_HLT_Dimuon0_Jpsi_NoVertexing_;
    bool loaded_HLT_Dimuon0_Jpsi_NoVertexing_;
    unsigned int counter_cached_HLT_Dimuon0_Jpsi_NoVertexing_;
    unsigned int counter_uncached_HLT_Dimuon0_Jpsi_NoVertexing_;
    ...
    unsigned int counter_cached_HLT_Dimuon0_Jpsi_NoVertexing_L1_4R_0er1p5R_;
    unsigned int counter_uncached_HLT_Dimuon0_Jpsi_NoVertexing_L1_4R_0er1p5R_;
    ...
    unsigned int counter_cached_HLT_Dimuon0_Jpsi_NoVertexing_NoOS_;
    unsigned int counter_uncached_HLT_Dimuon0_Jpsi_NoVertexing_NoOS_;
    bool HLT_Dimuon0_LowMass_;
    TBranch *b_HLT_Dimuon0_LowMass_;
    bool loaded_HLT_Dimuon0_LowMass_;
    unsigned int counter_cached_HLT_Dimuon0_LowMass_;
    unsigned int counter_uncached_HLT_Dimuon0_LowMass_;
    bool HLT_Dimuon0_LowMass_L1_0er1p5_;
    TBranch *b_HLT_Dimuon0_LowMass_L1_0er1p5_;
    bool loaded_HLT_Dimuon0_LowMass_L1_0er1p5_;
    unsigned int counter_cached_HLT_Dimuon0_LowMass_L1_0er1p5_;
    unsigned int counter_uncached_HLT_Dimuon0_LowMass_L1_0er1p5_;
    bool HLT_Dimuon0_LowMass_L1_0er1p5R_;
    TBranch *b_HLT_Dimuon0_LowMass_L1_0er1p5R_;
    bool loaded_HLT_Dimuon0_LowMass_L1_0er1p5R_;
    unsigned int counter_cached_HLT_Dimuon0_LowMass_L1_0er1p5R_;
    unsigned int counter_uncached_HLT_Dimuon0_LowMass_L1_0er1p5R_;
    bool HLT_Dimuon0_LowMass_L1_4_;
    TBranch *b_HLT_Dimuon0_LowMass_L1_4_;
    bool loaded_HLT_Dimuon0_LowMass_L1_4_;
    unsigned int counter_cached_HLT_Dimuon0_LowMass_L1_4_;
    unsigned int counter_uncached_HLT_Dimuon0_LowMass_L1_4_;
    bool HLT_Dimuon0_LowMass_L1_4R_;
    TBranch *b_HLT_Dimuon0_LowMass_L1_4R_;
    bool loaded_HLT_Dimuon0_LowMass_L1_4R_;
    unsigned int counter_cached_HLT_Dimuon0_LowMass_L1_4R_;
    unsigned int counter_uncached_HLT_Dimuon0_LowMass_L1_4R_;
    bool HLT_Dimuon0_LowMass_L1_TM530_;
    TBranch *b_HLT_Dimuon0_LowMass_L1_TM530_;
    bool loaded_HLT_Dimuon0_LowMass_L1_TM530_;
    unsigned int counter_cached_HLT_Dimuon0_LowMass_L1_TM530_;
    unsigned int counter_uncached_HLT_Dimuon0_LowMass_L1_TM530_;
    bool HLT_Dimuon0_Upsilon_L1_4p5_;
    TBranch *b_HLT_Dimuon0_Upsilon_L1_4p5_;
    bool loaded_HLT_Dimuon0_Upsilon_L1_4p5_;
    unsigned int counter_cached_HLT_Dimuon0_Upsilon_L1_4p5_;
    unsigned int counter_uncached_HLT_Dimuon0_Upsilon_L1_4p5_;
    bool HLT_Dimuon0_Upsilon_L1_4p5NoOS_;
    TBranch *b_HLT_Dimuon0_Upsilon_L1_4p5NoOS_;
    bool loaded_HLT_Dimuon0_Upsilon_L1_4p5NoOS_;
    unsigned int counter_cached_HLT_Dimuon0_Upsilon_L1_4p5NoOS_;
    unsigned int counter_uncached_HLT_Dimuon0_Upsilon_L1_4p5NoOS_;
    ...
    unsigned int counter_cached_HLT_Dimuon0_Upsilon_L1_4p5er2p0_;
    unsigned int counter_uncached_HLT_Dimuon0_Upsilon_L1_4p5er2p0_;
    ...
    unsigned int counter_cached_HLT_Dimuon0_Upsilon_L1_4p5er2p0M_;
    unsigned int counter_uncached_HLT_Dimuon0_Upsilon_L1_4p5er2p0M_;
    bool HLT_Dimuon0_Upsilon_L1_5_;
    TBranch *b_HLT_Dimuon0_Upsilon_L1_5_;
    bool loaded_HLT_Dimuon0_Upsilon_L1_5_;
    unsigned int counter_cached_HLT_Dimuon0_Upsilon_L1_5_;
    unsigned int counter_uncached_HLT_Dimuon0_Upsilon_L1_5_;
    bool HLT_Dimuon0_Upsilon_L1_5M_;
    TBranch *b_HLT_Dimuon0_Upsilon_L1_5M_;
    bool loaded_HLT_Dimuon0_Upsilon_L1_5M_;
    unsigned int counter_cached_HLT_Dimuon0_Upsilon_L1_5M_;
    unsigned int counter_uncached_HLT_Dimuon0_Upsilon_L1_5M_;
    ...
    unsigned int counter_cached_HLT_Dimuon0_Upsilon_Muon_L1_TM0_;
    unsigned int counter_uncached_HLT_Dimuon0_Upsilon_Muon_L1_TM0_;
    ...
    unsigned int counter_cached_HLT_Dimuon0_Upsilon_Muon_NoL1Mass_;
    unsigned int counter_uncached_HLT_Dimuon0_Upsilon_Muon_NoL1Mass_;
    ...
    unsigned int counter_cached_HLT_Dimuon0_Upsilon_NoVertexing_;
    unsigned int counter_uncached_HLT_Dimuon0_Upsilon_NoVertexing_;
    ...
    unsigned int counter_cached_HLT_Dimuon10_PsiPrime_Barrel_Seagulls_;
    unsigned int counter_uncached_HLT_Dimuon10_PsiPrime_Barrel_Seagulls_;
    bool HLT_Dimuon12_Upsilon_y1p4_;
    TBranch *b_HLT_Dimuon12_Upsilon_y1p4_;
    bool loaded_HLT_Dimuon12_Upsilon_y1p4_;
    unsigned int counter_cached_HLT_Dimuon12_Upsilon_y1p4_;
    unsigned int counter_uncached_HLT_Dimuon12_Upsilon_y1p4_;
    ...
    unsigned int counter_cached_HLT_Dimuon14_Phi_Barrel_Seagulls_;
    unsigned int counter_uncached_HLT_Dimuon14_Phi_Barrel_Seagulls_;
    bool HLT_Dimuon18_PsiPrime_;
    TBranch *b_HLT_Dimuon18_PsiPrime_;
    bool loaded_HLT_Dimuon18_PsiPrime_;
    unsigned int counter_cached_HLT_Dimuon18_PsiPrime_;
    unsigned int counter_uncached_HLT_Dimuon18_PsiPrime_;
    bool HLT_Dimuon18_PsiPrime_noCorrL1_;
    TBranch *b_HLT_Dimuon18_PsiPrime_noCorrL1_;
    bool loaded_HLT_Dimuon18_PsiPrime_noCorrL1_;
    unsigned int counter_cached_HLT_Dimuon18_PsiPrime_noCorrL1_;
    unsigned int counter_uncached_HLT_Dimuon18_PsiPrime_noCorrL1_;
    ...
    unsigned int counter_cached_HLT_Dimuon20_Jpsi_Barrel_Seagulls_;
    unsigned int counter_uncached_HLT_Dimuon20_Jpsi_Barrel_Seagulls_;
    bool HLT_Dimuon24_Phi_noCorrL1_;
    TBranch *b_HLT_Dimuon24_Phi_noCorrL1_;
    bool loaded_HLT_Dimuon24_Phi_noCorrL1_;
    unsigned int counter_cached_HLT_Dimuon24_Phi_noCorrL1_;
    unsigned int counter_uncached_HLT_Dimuon24_Phi_noCorrL1_;
    bool HLT_Dimuon24_Upsilon_noCorrL1_;
    TBranch *b_HLT_Dimuon24_Upsilon_noCorrL1_;
    bool loaded_HLT_Dimuon24_Upsilon_noCorrL1_;
    unsigned int counter_cached_HLT_Dimuon24_Upsilon_noCorrL1_;
    unsigned int counter_uncached_HLT_Dimuon24_Upsilon_noCorrL1_;
    bool HLT_Dimuon25_Jpsi_;
    TBranch *b_HLT_Dimuon25_Jpsi_;
    bool loaded_HLT_Dimuon25_Jpsi_;
    unsigned int counter_cached_HLT_Dimuon25_Jpsi_;
    unsigned int counter_uncached_HLT_Dimuon25_Jpsi_;
    bool HLT_Dimuon25_Jpsi_noCorrL1_;
    TBranch *b_HLT_Dimuon25_Jpsi_noCorrL1_;
    bool loaded_HLT_Dimuon25_Jpsi_noCorrL1_;
    unsigned int counter_cached_HLT_Dimuon25_Jpsi_noCorrL1_;
    unsigned int counter_uncached_HLT_Dimuon25_Jpsi_noCorrL1_;
    ...
    unsigned int counter_cached_HLT_Diphoton30PV_18PV_R9Id_AND_IsoCaloId_AND_HE_R9Id_NoPixelVeto_Mass55_;
    unsigned int counter_uncached_HLT_Diphoton30PV_18PV_R9Id_AND_IsoCaloId_AND_HE_R9Id_NoPixelVeto_Mass55_;
    ...
    unsigned int counter_cached_HLT_Diphoton30PV_18PV_R9Id_AND_IsoCaloId_AND_HE_R9Id_PixelVeto_Mass55_;
    unsigned int counter_uncached_HLT_Diphoton30PV_18PV_R9Id_AND_IsoCaloId_AND_HE_R9Id_PixelVeto_Mass55_;
    ...
    unsigned int counter_cached_HLT_Diphoton30_18_R9IdL_AND_HE_AND_IsoCaloId_NoPixelVeto_;
    unsigned int counter_uncached_HLT_Diphoton30_18_R9IdL_AND_HE_AND_IsoCaloId_NoPixelVeto_;
    ...
    unsigned int counter_cached_HLT_Diphoton30_18_R9IdL_AND_HE_AND_IsoCaloId_NoPixelVeto_Mass55_;
    unsigned int counter_uncached_HLT_Diphoton30_18_R9IdL_AND_HE_AND_IsoCaloId_NoPixelVeto_Mass55_;
    ...
    unsigned int counter_cached_HLT_Diphoton30_22_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass90_;
    unsigned int counter_uncached_HLT_Diphoton30_22_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass90_;
    ...
    unsigned int counter_cached_HLT_Diphoton30_22_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass95_;
    unsigned int counter_uncached_HLT_Diphoton30_22_R9Id_OR_IsoCaloId_AND_HE_R9Id_Mass95_;
    ...
    unsigned int counter_cached_HLT_DoubleEle24_eta2p1_WPTight_Gsf_;
    unsigned int counter_uncached_HLT_DoubleEle24_eta2p1_WPTight_Gsf_;
    bool HLT_DoubleEle25_CaloIdL_MW_;
    TBranch *b_HLT_DoubleEle25_CaloIdL_MW_;
    bool loaded_HLT_DoubleEle25_CaloIdL_MW_;
    unsigned int counter_cached_HLT_DoubleEle25_CaloIdL_MW_;
    unsigned int counter_uncached_HLT_DoubleEle25_CaloIdL_MW_;
    bool HLT_DoubleEle27_CaloIdL_MW_;
    TBranch *b_HLT_DoubleEle27_CaloIdL_MW_;
    bool loaded_HLT_DoubleEle27_CaloIdL_MW_;
    unsigned int counter_cached_HLT_DoubleEle27_CaloIdL_MW_;
    unsigned int counter_uncached_HLT_DoubleEle27_CaloIdL_MW_;
    bool HLT_DoubleEle33_CaloIdL_MW_;
    TBranch *b_HLT_DoubleEle33_CaloIdL_MW_;
    bool loaded_HLT_DoubleEle33_CaloIdL_MW_;
    unsigned int counter_cached_HLT_DoubleEle33_CaloIdL_MW_;
    unsigned int counter_uncached_HLT_DoubleEle33_CaloIdL_MW_;
    ...
    unsigned int counter_cached_HLT_DoubleEle8_CaloIdM_TrackIdM_Mass8_DZ_PFHT350_;
    unsigned int counter_uncached_HLT_DoubleEle8_CaloIdM_TrackIdM_Mass8_DZ_PFHT350_;
    ...
    unsigned int counter_cached_HLT_DoubleEle8_CaloIdM_TrackIdM_Mass8_PFHT350_;
    unsigned int counter_uncached_HLT_DoubleEle8_CaloIdM_TrackIdM_Mass8_PFHT350_;
    bool HLT_DoubleIsoMu20_eta2p1_;
    TBranch *b_HLT_DoubleIsoMu20_eta2p1_;
    bool loaded_HLT_DoubleIsoMu20_eta2p1_;
    unsigned int counter_cached_HLT_DoubleIsoMu20_eta2p1_;
    unsigned int counter_uncached_HLT_DoubleIsoMu20_eta2p1_;
    bool HLT_DoubleL2Mu23NoVtx_2Cha_;
    TBranch *b_HLT_DoubleL2Mu23NoVtx_2Cha_;
    bool loaded_HLT_DoubleL2Mu23NoVtx_2Cha_;
    unsigned int counter_cached_HLT_DoubleL2Mu23NoVtx_2Cha_;
    unsigned int counter_uncached_HLT_DoubleL2Mu23NoVtx_2Cha_;
    ...
    unsigned int counter_cached_HLT_DoubleL2Mu23NoVtx_2Cha_CosmicSeed_;
    unsigned int counter_uncached_HLT_DoubleL2Mu23NoVtx_2Cha_CosmicSeed_;
    ...
    unsigned int counter_cached_HLT_DoubleL2Mu23NoVtx_2Cha_CosmicSeed_NoL2Matched_;
    unsigned int counter_uncached_HLT_DoubleL2Mu23NoVtx_2Cha_CosmicSeed_NoL2Matched_;
    ...
    unsigned int counter_cached_HLT_DoubleL2Mu23NoVtx_2Cha_NoL2Matched_;
    unsigned int counter_uncached_HLT_DoubleL2Mu23NoVtx_2Cha_NoL2Matched_;
    bool HLT_DoubleL2Mu25NoVtx_2Cha_;
    TBranch *b_HLT_DoubleL2Mu25NoVtx_2Cha_;
    bool loaded_HLT_DoubleL2Mu25NoVtx_2Cha_;
    unsigned int counter_cached_HLT_DoubleL2Mu25NoVtx_2Cha_;
    unsigned int counter_uncached_HLT_DoubleL2Mu25NoVtx_2Cha_;
    ...
    unsigned int counter_cached_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed_;
    unsigned int counter_uncached_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed_;
    ...
    unsigned int counter_cached_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed_Eta2p4_;
    unsigned int counter_uncached_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed_Eta2p4_;
    ...
    unsigned int counter_cached_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed_NoL2Matched_;
    unsigned int counter_uncached_HLT_DoubleL2Mu25NoVtx_2Cha_CosmicSeed_NoL2Matched_;
    ...
    unsigned int counter_cached_HLT_DoubleL2Mu25NoVtx_2Cha_Eta2p4_;
    unsigned int counter_uncached_HLT_DoubleL2Mu25NoVtx_2Cha_Eta2p4_;
    ...
    unsigned int counter_cached_HLT_DoubleL2Mu25NoVtx_2Cha_NoL2Matched_;
    unsigned int counter_uncached_HLT_DoubleL2Mu25NoVtx_2Cha_NoL2Matched_;
    ...
    unsigned int counter_cached_HLT_DoubleL2Mu30NoVtx_2Cha_CosmicSeed_Eta2p4_;
    unsigned int counter_uncached_HLT_DoubleL2Mu30NoVtx_2Cha_CosmicSeed_Eta2p4_;
    ...
    unsigned int counter_cached_HLT_DoubleL2Mu30NoVtx_2Cha_Eta2p4_;
    unsigned int counter_uncached_HLT_DoubleL2Mu30NoVtx_2Cha_Eta2p4_;
    bool HLT_DoubleL2Mu50_;
    TBranch *b_HLT_DoubleL2Mu50_;
    bool loaded_HLT_DoubleL2Mu50_;
    unsigned int counter_cached_HLT_DoubleL2Mu50_;
    unsigned int counter_uncached_HLT_DoubleL2Mu50_;
    ...
    unsigned int counter_cached_HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_;
    unsigned int counter_uncached_HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_;
    ...
    unsigned int counter_cached_HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_;
    unsigned int counter_uncached_HLT_DoubleMediumChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_;
    ...
    unsigned int counter_cached_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg_;
    unsigned int counter_uncached_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg_;
    ...
    unsigned int counter_cached_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_eta2p1_Reg_;
    unsigned int counter_uncached_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_eta2p1_Reg_;
    ...
    unsigned int counter_cached_HLT_DoubleMu20_7_Mass0to30_L1_DM4_;
    unsigned int counter_uncached_HLT_DoubleMu20_7_Mass0to30_L1_DM4_;
    ...
    unsigned int counter_cached_HLT_DoubleMu20_7_Mass0to30_L1_DM4EG_;
    unsigned int counter_uncached_HLT_DoubleMu20_7_Mass0to30_L1_DM4EG_;
    ...
    unsigned int counter_cached_HLT_DoubleMu20_7_Mass0to30_Photon23_;
    unsigned int counter_uncached_HLT_DoubleMu20_7_Mass0to30_Photon23_;
    ...
    unsigned int counter_cached_HLT_DoubleMu2_Jpsi_DoubleTkMu0_Phi_;
    unsigned int counter_uncached_HLT_DoubleMu2_Jpsi_DoubleTkMu0_Phi_;
    ...
    unsigned int counter_cached_HLT_DoubleMu2_Jpsi_DoubleTrk1_Phi1p05_;
    unsigned int counter_uncached_HLT_DoubleMu2_Jpsi_DoubleTrk1_Phi1p05_;
    ...
    unsigned int counter_cached_HLT_DoubleMu33NoFiltersNoVtxDisplaced_;
    unsigned int counter_uncached_HLT_DoubleMu33NoFiltersNoVtxDisplaced_;
    ...
    unsigned int counter_cached_HLT_DoubleMu3_DCA_PFMET50_PFMHT60_;
    unsigned int counter_uncached_HLT_DoubleMu3_DCA_PFMET50_PFMHT60_;
    ...
    unsigned int counter_cached_HLT_DoubleMu3_DZ_PFMET50_PFMHT60_;
    unsigned int counter_uncached_HLT_DoubleMu3_DZ_PFMET50_PFMHT60_;
    ...
    unsigned int counter_cached_HLT_DoubleMu3_DZ_PFMET70_PFMHT70_;
    unsigned int counter_uncached_HLT_DoubleMu3_DZ_PFMET70_PFMHT70_;
    ...
    unsigned int counter_cached_HLT_DoubleMu3_DZ_PFMET90_PFMHT90_;
    unsigned int counter_uncached_HLT_DoubleMu3_DZ_PFMET90_PFMHT90_;
    ...
    unsigned int counter_cached_HLT_DoubleMu3_DoubleEle7p5_CaloIdL_TrackIdL_Upsilon_;
    unsigned int counter_uncached_HLT_DoubleMu3_DoubleEle7p5_CaloIdL_TrackIdL_Upsilon_;
    bool HLT_DoubleMu3_TkMu_DsTau3Mu_;
    TBranch *b_HLT_DoubleMu3_TkMu_DsTau3Mu_;
    bool loaded_HLT_DoubleMu3_TkMu_DsTau3Mu_;
    unsigned int counter_cached_HLT_DoubleMu3_TkMu_DsTau3Mu_;
    unsigned int counter_uncached_HLT_DoubleMu3_TkMu_DsTau3Mu_;
    bool HLT_DoubleMu3_Trk_Tau3mu_;
    TBranch *b_HLT_DoubleMu3_Trk_Tau3mu_;
    bool loaded_HLT_DoubleMu3_Trk_Tau3mu_;
    unsigned int counter_cached_HLT_DoubleMu3_Trk_Tau3mu_;
    unsigned int counter_uncached_HLT_DoubleMu3_Trk_Tau3mu_;
    ...
    unsigned int counter_cached_HLT_DoubleMu3_Trk_Tau3mu_NoL1Mass_;
    unsigned int counter_uncached_HLT_DoubleMu3_Trk_Tau3mu_NoL1Mass_;
    ...
    unsigned int counter_cached_HLT_DoubleMu40NoFiltersNoVtxDisplaced_;
    unsigned int counter_uncached_HLT_DoubleMu40NoFiltersNoVtxDisplaced_;
    bool HLT_DoubleMu43NoFiltersNoVtx_;
    TBranch *b_HLT_DoubleMu43NoFiltersNoVtx_;
    bool loaded_HLT_DoubleMu43NoFiltersNoVtx_;
    unsigned int counter_cached_HLT_DoubleMu43NoFiltersNoVtx_;
    unsigned int counter_uncached_HLT_DoubleMu43NoFiltersNoVtx_;
    bool HLT_DoubleMu48NoFiltersNoVtx_;
    TBranch *b_HLT_DoubleMu48NoFiltersNoVtx_;
    bool loaded_HLT_DoubleMu48NoFiltersNoVtx_;
    unsigned int counter_cached_HLT_DoubleMu48NoFiltersNoVtx_;
    unsigned int counter_uncached_HLT_DoubleMu48NoFiltersNoVtx_;
    bool HLT_DoubleMu4_3_Bs_;
    TBranch *b_HLT_DoubleMu4_3_Bs_;
    bool loaded_HLT_DoubleMu4_3_Bs_;
    unsigned int counter_cached_HLT_DoubleMu4_3_Bs_;
    unsigned int counter_uncached_HLT_DoubleMu4_3_Bs_;
    bool HLT_DoubleMu4_3_Jpsi_;
    TBranch *b_HLT_DoubleMu4_3_Jpsi_;
    bool loaded_HLT_DoubleMu4_3_Jpsi_;
    unsigned int counter_cached_HLT_DoubleMu4_3_Jpsi_;
    unsigned int counter_uncached_HLT_DoubleMu4_3_Jpsi_;
    ...
    unsigned int counter_cached_HLT_DoubleMu4_JpsiTrkTrk_Displaced_;
    unsigned int counter_uncached_HLT_DoubleMu4_JpsiTrkTrk_Displaced_;
    ...
    unsigned int counter_cached_HLT_DoubleMu4_JpsiTrk_Displaced_;
    unsigned int counter_uncached_HLT_DoubleMu4_JpsiTrk_Displaced_;
    bool HLT_DoubleMu4_Jpsi_Displaced_;
    TBranch *b_HLT_DoubleMu4_Jpsi_Displaced_;
    bool loaded_HLT_DoubleMu4_Jpsi_Displaced_;
    unsigned int counter_cached_HLT_DoubleMu4_Jpsi_Displaced_;
    unsigned int counter_uncached_HLT_DoubleMu4_Jpsi_Displaced_;
    bool HLT_DoubleMu4_Jpsi_NoVertexing_;
    TBranch *b_HLT_DoubleMu4_Jpsi_NoVertexing_;
    bool loaded_HLT_DoubleMu4_Jpsi_NoVertexing_;
    unsigned int counter_cached_HLT_DoubleMu4_Jpsi_NoVertexing_;
    unsigned int counter_uncached_HLT_DoubleMu4_Jpsi_NoVertexing_;
    ...
    unsigned int counter_cached_HLT_DoubleMu4_LowMassNonResonantTrk_Displaced_;
    unsigned int counter_uncached_HLT_DoubleMu4_LowMassNonResonantTrk_Displaced_;
    ...
    unsigned int counter_cached_HLT_DoubleMu4_Mass3p8_DZ_PFHT350_;
    unsigned int counter_uncached_HLT_DoubleMu4_Mass3p8_DZ_PFHT350_;
    ...
    unsigned int counter_cached_HLT_DoubleMu4_PsiPrimeTrk_Displaced_;
    unsigned int counter_uncached_HLT_DoubleMu4_PsiPrimeTrk_Displaced_;
    ...
    unsigned int counter_cached_HLT_DoubleMu5_Upsilon_DoubleEle3_CaloIdL_TrackIdL_;
    unsigned int counter_uncached_HLT_DoubleMu5_Upsilon_DoubleEle3_CaloIdL_TrackIdL_;
    ...
    unsigned int counter_cached_HLT_DoublePFJets100_CaloBTagDeepCSV_p71_;
    unsigned int counter_uncached_HLT_DoublePFJets100_CaloBTagDeepCSV_p71_;
    ...
    unsigned int counter_cached_HLT_DoublePFJets116MaxDeta1p6_DoubleCaloBTagDeepCSV_p71_;
    unsigned int counter_uncached_HLT_DoublePFJets116MaxDeta1p6_DoubleCaloBTagDeepCSV_p71_;
    ...
    unsigned int counter_cached_HLT_DoublePFJets128MaxDeta1p6_DoubleCaloBTagDeepCSV_p71_;
    unsigned int counter_uncached_HLT_DoublePFJets128MaxDeta1p6_DoubleCaloBTagDeepCSV_p71_;
    ...
    unsigned int counter_cached_HLT_DoublePFJets200_CaloBTagDeepCSV_p71_;
    unsigned int counter_uncached_HLT_DoublePFJets200_CaloBTagDeepCSV_p71_;
    ...
    unsigned int counter_cached_HLT_DoublePFJets350_CaloBTagDeepCSV_p71_;
    unsigned int counter_uncached_HLT_DoublePFJets350_CaloBTagDeepCSV_p71_;
    ...
    unsigned int counter_cached_HLT_DoublePFJets40_CaloBTagDeepCSV_p71_;
    unsigned int counter_uncached_HLT_DoublePFJets40_CaloBTagDeepCSV_p71_;
    bool HLT_DoublePhoton33_CaloIdL_;
    TBranch *b_HLT_DoublePhoton33_CaloIdL_;
    bool loaded_HLT_DoublePhoton33_CaloIdL_;
    unsigned int counter_cached_HLT_DoublePhoton33_CaloIdL_;
    unsigned int counter_uncached_HLT_DoublePhoton33_CaloIdL_;
    bool HLT_DoublePhoton70_;
    TBranch *b_HLT_DoublePhoton70_;
    bool loaded_HLT_DoublePhoton70_;
    unsigned int counter_cached_HLT_DoublePhoton70_;
    unsigned int counter_uncached_HLT_DoublePhoton70_;
    bool HLT_DoublePhoton85_;
    TBranch *b_HLT_DoublePhoton85_;
    bool loaded_HLT_DoublePhoton85_;
    unsigned int counter_cached_HLT_DoublePhoton85_;
    unsigned int counter_uncached_HLT_DoublePhoton85_;
    ...
    unsigned int counter_cached_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_;
    unsigned int counter_uncached_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_;
    ...
    unsigned int counter_cached_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_;
    unsigned int counter_uncached_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_;
    ...
    unsigned int counter_cached_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg_;
    unsigned int counter_uncached_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_TightID_eta2p1_Reg_;
    ...
    unsigned int counter_cached_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_eta2p1_Reg_;
    unsigned int counter_uncached_HLT_DoubleTightChargedIsoPFTauHPS40_Trk1_eta2p1_Reg_;
    ...
    unsigned int counter_cached_HLT_DoubleTrkMu_16_6_NoFiltersNoVtx_;
    unsigned int counter_uncached_HLT_DoubleTrkMu_16_6_NoFiltersNoVtx_;
    bool HLT_ECALHT800_;
    TBranch *b_HLT_ECALHT800_;
    bool loaded_HLT_ECALHT800_;
    unsigned int counter_cached_HLT_ECALHT800_;
    unsigned int counter_uncached_HLT_ECALHT800_;
    bool HLT_EcalCalibration_;
    TBranch *b_HLT_EcalCalibration_;
    bool loaded_HLT_EcalCalibration_;
    unsigned int counter_cached_HLT_EcalCalibration_;
    unsigned int counter_uncached_HLT_EcalCalibration_;
    bool HLT_Ele115_CaloIdVT_GsfTrkIdT_;
    TBranch *b_HLT_Ele115_CaloIdVT_GsfTrkIdT_;
    bool loaded_HLT_Ele115_CaloIdVT_GsfTrkIdT_;
    unsigned int counter_cached_HLT_Ele115_CaloIdVT_GsfTrkIdT_;
    unsigned int counter_uncached_HLT_Ele115_CaloIdVT_GsfTrkIdT_;
    ...
    unsigned int counter_cached_HLT_Ele12_CaloIdL_TrackIdL_IsoVL_PFJet30_;
    unsigned int counter_uncached_HLT_Ele12_CaloIdL_TrackIdL_IsoVL_PFJet30_;
    bool HLT_Ele135_CaloIdVT_GsfTrkIdT_;
    TBranch *b_HLT_Ele135_CaloIdVT_GsfTrkIdT_;
    bool loaded_HLT_Ele135_CaloIdVT_GsfTrkIdT_;
    unsigned int counter_cached_HLT_Ele135_CaloIdVT_GsfTrkIdT_;
    unsigned int counter_uncached_HLT_Ele135_CaloIdVT_GsfTrkIdT_;
    bool HLT_Ele145_CaloIdVT_GsfTrkIdT_;
    TBranch *b_HLT_Ele145_CaloIdVT_GsfTrkIdT_;
    bool loaded_HLT_Ele145_CaloIdVT_GsfTrkIdT_;
    unsigned int counter_cached_HLT_Ele145_CaloIdVT_GsfTrkIdT_;
    unsigned int counter_uncached_HLT_Ele145_CaloIdVT_GsfTrkIdT_;
    ...
    unsigned int counter_cached_HLT_Ele15_CaloIdL_TrackIdL_IsoVL_PFJet30_;
    unsigned int counter_uncached_HLT_Ele15_CaloIdL_TrackIdL_IsoVL_PFJet30_;
    ...
    unsigned int counter_cached_HLT_Ele15_Ele8_CaloIdL_TrackIdL_IsoVL_;
    unsigned int counter_uncached_HLT_Ele15_Ele8_CaloIdL_TrackIdL_IsoVL_;
    bool HLT_Ele15_IsoVVVL_PFHT450_;
    TBranch *b_HLT_Ele15_IsoVVVL_PFHT450_;
    bool loaded_HLT_Ele15_IsoVVVL_PFHT450_;
    unsigned int counter_cached_HLT_Ele15_IsoVVVL_PFHT450_;
    unsigned int counter_uncached_HLT_Ele15_IsoVVVL_PFHT450_;
    ...
    unsigned int counter_cached_HLT_Ele15_IsoVVVL_PFHT450_CaloBTagDeepCSV_4p5_;
    unsigned int counter_uncached_HLT_Ele15_IsoVVVL_PFHT450_CaloBTagDeepCSV_4p5_;
    ...
    unsigned int counter_cached_HLT_Ele15_IsoVVVL_PFHT450_PFMET50_;
    unsigned int counter_uncached_HLT_Ele15_IsoVVVL_PFHT450_PFMET50_;
    bool HLT_Ele15_IsoVVVL_PFHT600_;
    TBranch *b_HLT_Ele15_IsoVVVL_PFHT600_;
    bool loaded_HLT_Ele15_IsoVVVL_PFHT600_;
    unsigned int counter_cached_HLT_Ele15_IsoVVVL_PFHT600_;
    unsigned int counter_uncached_HLT_Ele15_IsoVVVL_PFHT600_;
    bool HLT_Ele15_WPLoose_Gsf_;
    TBranch *b_HLT_Ele15_WPLoose_Gsf_;
    bool loaded_HLT_Ele15_WPLoose_Gsf_;
    unsigned int counter_cached_HLT_Ele15_WPLoose_Gsf_;
    unsigned int counter_uncached_HLT_Ele15_WPLoose_Gsf_;
    ...
    unsigned int counter_cached_HLT_Ele16_Ele12_Ele8_CaloIdL_TrackIdL_;
    unsigned int counter_uncached_HLT_Ele16_Ele12_Ele8_CaloIdL_TrackIdL_;
    ...
    unsigned int counter_cached_HLT_Ele17_CaloIdM_TrackIdM_PFJet30_;
    unsigned int counter_uncached_HLT_Ele17_CaloIdM_TrackIdM_PFJet30_;
    bool HLT_Ele17_WPLoose_Gsf_;
    TBranch *b_HLT_Ele17_WPLoose_Gsf_;
    bool loaded_HLT_Ele17_WPLoose_Gsf_;
    unsigned int counter_cached_HLT_Ele17_WPLoose_Gsf_;
    unsigned int counter_uncached_HLT_Ele17_WPLoose_Gsf_;
    bool HLT_Ele200_CaloIdVT_GsfTrkIdT_;
    TBranch *b_HLT_Ele200_CaloIdVT_GsfTrkIdT_;
    bool loaded_HLT_Ele200_CaloIdVT_GsfTrkIdT_;
    unsigned int counter_cached_HLT_Ele200_CaloIdVT_GsfTrkIdT_;
    unsigned int counter_uncached_HLT_Ele200_CaloIdVT_GsfTrkIdT_;
    bool HLT_Ele20_WPLoose_Gsf_;
    TBranch *b_HLT_Ele20_WPLoose_Gsf_;
    bool loaded_HLT_Ele20_WPLoose_Gsf_;
    unsigned int counter_cached_HLT_Ele20_WPLoose_Gsf_;
    unsigned int counter_uncached_HLT_Ele20_WPLoose_Gsf_;
    bool HLT_Ele20_WPTight_Gsf_;
    TBranch *b_HLT_Ele20_WPTight_Gsf_;
    bool loaded_HLT_Ele20_WPTight_Gsf_;
    unsigned int counter_cached_HLT_Ele20_WPTight_Gsf_;
    unsigned int counter_uncached_HLT_Ele20_WPTight_Gsf_;
    bool HLT_Ele20_eta2p1_WPLoose_Gsf_;
    TBranch *b_HLT_Ele20_eta2p1_WPLoose_Gsf_;
    bool loaded_HLT_Ele20_eta2p1_WPLoose_Gsf_;
    unsigned int counter_cached_HLT_Ele20_eta2p1_WPLoose_Gsf_;
    unsigned int counter_uncached_HLT_Ele20_eta2p1_WPLoose_Gsf_;
    ...
    unsigned int counter_cached_HLT_Ele23_CaloIdL_TrackIdL_IsoVL_PFJet30_;
    unsigned int counter_uncached_HLT_Ele23_CaloIdL_TrackIdL_IsoVL_PFJet30_;
    ...
    unsigned int counter_cached_HLT_Ele23_CaloIdM_TrackIdM_PFJet30_;
    unsigned int counter_uncached_HLT_Ele23_CaloIdM_TrackIdM_PFJet30_;
    ...
    unsigned int counter_cached_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_;
    unsigned int counter_uncached_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_;
    ...
    unsigned int counter_cached_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_;
    unsigned int counter_uncached_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_;
    ...
    unsigned int counter_cached_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_CrossL1_;
    unsigned int counter_uncached_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_CrossL1_;
    ...
    unsigned int counter_cached_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1_;
    unsigned int counter_uncached_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1_;
    ...
    unsigned int counter_cached_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_CrossL1_;
    unsigned int counter_uncached_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_CrossL1_;
    ...
    unsigned int counter_cached_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1_;
    unsigned int counter_uncached_HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1_;
    ...
    unsigned int counter_cached_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_CrossL1_;
    unsigned int counter_uncached_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_CrossL1_;
    ...
    unsigned int counter_cached_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1_;
    unsigned int counter_uncached_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_TightID_CrossL1_;
    bool HLT_Ele250_CaloIdVT_GsfTrkIdT_;
    TBranch *b_HLT_Ele250_CaloIdVT_GsfTrkIdT_;
    bool loaded_HLT_Ele250_CaloIdVT_GsfTrkIdT_;
    unsigned int counter_cached_HLT_Ele250_CaloIdVT_GsfTrkIdT_;
    unsigned int counter_uncached_HLT_Ele250_CaloIdVT_GsfTrkIdT_;
    bool HLT_Ele27_Ele37_CaloIdL_MW_;
    TBranch *b_HLT_Ele27_Ele37_CaloIdL_MW_;
    bool loaded_HLT_Ele27_Ele37_CaloIdL_MW_;
    unsigned int counter_cached_HLT_Ele27_Ele37_CaloIdL_MW_;
    unsigned int counter_uncached_HLT_Ele27_Ele37_CaloIdL_MW_;
    bool HLT_Ele27_WPTight_Gsf_;
    TBranch *b_HLT_Ele27_WPTight_Gsf_;
    bool loaded_HLT_Ele27_WPTight_Gsf_;
    unsigned int counter_cached_HLT_Ele27_WPTight_Gsf_;
    unsigned int counter_uncached_HLT_Ele27_WPTight_Gsf_;
    bool HLT_Ele28_HighEta_SC20_Mass55_;
    TBranch *b_HLT_Ele28_HighEta_SC20_Mass55_;
    bool loaded_HLT_Ele28_HighEta_SC20_Mass55_;
    unsigned int counter_cached_HLT_Ele28_HighEta_SC20_Mass55_;
    unsigned int counter_uncached_HLT_Ele28_HighEta_SC20_Mass55_;
    bool HLT_Ele28_WPTight_Gsf_;
    TBranch *b_HLT_Ele28_WPTight_Gsf_;
    bool loaded_HLT_Ele28_WPTight_Gsf_;
    unsigned int counter_cached_HLT_Ele28_WPTight_Gsf_;
    unsigned int counter_uncached_HLT_Ele28_WPTight_Gsf_;
    ...
    unsigned int counter_cached_HLT_Ele28_eta2p1_WPTight_Gsf_HT150_;
    unsigned int counter_uncached_HLT_Ele28_eta2p1_WPTight_Gsf_HT150_;
    bool HLT_Ele300_CaloIdVT_GsfTrkIdT_;
    TBranch *b_HLT_Ele300_CaloIdVT_GsfTrkIdT_;
    bool loaded_HLT_Ele300_CaloIdVT_GsfTrkIdT_;
    unsigned int counter_cached_HLT_Ele300_CaloIdVT_GsfTrkIdT_;
    unsigned int counter_uncached_HLT_Ele300_CaloIdVT_GsfTrkIdT_;
    bool HLT_Ele30_WPTight_Gsf_;
    TBranch *b_HLT_Ele30_WPTight_Gsf_;
    bool loaded_HLT_Ele30_WPTight_Gsf_;
    unsigned int counter_cached_HLT_Ele30_WPTight_Gsf_;
    unsigned int counter_uncached_HLT_Ele30_WPTight_Gsf_;
    ...
    unsigned int counter_cached_HLT_Ele30_eta2p1_WPTight_Gsf_CentralPFJet35_EleCleaned_;
    unsigned int counter_uncached_HLT_Ele30_eta2p1_WPTight_Gsf_CentralPFJet35_EleCleaned_;
    bool HLT_Ele32_WPTight_Gsf_;
    TBranch *b_HLT_Ele32_WPTight_Gsf_;
    bool loaded_HLT_Ele32_WPTight_Gsf_;
    unsigned int counter_cached_HLT_Ele32_WPTight_Gsf_;
    unsigned int counter_uncached_HLT_Ele32_WPTight_Gsf_;
    ...
    unsigned int counter_cached_HLT_Ele32_WPTight_Gsf_L1DoubleEG_;
    unsigned int counter_uncached_HLT_Ele32_WPTight_Gsf_L1DoubleEG_;
    bool HLT_Ele35_WPTight_Gsf_;
    TBranch *b_HLT_Ele35_WPTight_Gsf_;
    bool loaded_HLT_Ele35_WPTight_Gsf_;
    unsigned int counter_cached_HLT_Ele35_WPTight_Gsf_;
    unsigned int counter_uncached_HLT_Ele35_WPTight_Gsf_;
    bool HLT_Ele35_WPTight_Gsf_L1EGMT_;
    TBranch *b_HLT_Ele35_WPTight_Gsf_L1EGMT_;
    bool loaded_HLT_Ele35_WPTight_Gsf_L1EGMT_;
    unsigned int counter_cached_HLT_Ele35_WPTight_Gsf_L1EGMT_;
    unsigned int counter_uncached_HLT_Ele35_WPTight_Gsf_L1EGMT_;
    bool HLT_Ele38_WPTight_Gsf_;
    TBranch *b_HLT_Ele38_WPTight_Gsf_;
    bool loaded_HLT_Ele38_WPTight_Gsf_;
    unsigned int counter_cached_HLT_Ele38_WPTight_Gsf_;
    unsigned int counter_uncached_HLT_Ele38_WPTight_Gsf_;
    bool HLT_Ele40_WPTight_Gsf_;
    TBranch *b_HLT_Ele40_WPTight_Gsf_;
    bool loaded_HLT_Ele40_WPTight_Gsf_;
    unsigned int counter_cached_HLT_Ele40_WPTight_Gsf_;
    unsigned int counter_uncached_HLT_Ele40_WPTight_Gsf_;
    ...
    unsigned int counter_cached_HLT_Ele50_CaloIdVT_GsfTrkIdT_PFJet165_;
    unsigned int counter_uncached_HLT_Ele50_CaloIdVT_GsfTrkIdT_PFJet165_;
    bool HLT_Ele50_IsoVVVL_PFHT450_;
    TBranch *b_HLT_Ele50_IsoVVVL_PFHT450_;
    bool loaded_HLT_Ele50_IsoVVVL_PFHT450_;
    unsigned int counter_cached_HLT_Ele50_IsoVVVL_PFHT450_;
    unsigned int counter_uncached_HLT_Ele50_IsoVVVL_PFHT450_;
    ...
    unsigned int counter_cached_HLT_Ele8_CaloIdL_TrackIdL_IsoVL_PFJet30_;
    unsigned int counter_uncached_HLT_Ele8_CaloIdL_TrackIdL_IsoVL_PFJet30_;
    ...
    unsigned int counter_cached_HLT_Ele8_CaloIdM_TrackIdM_PFJet30_;
    unsigned int counter_uncached_HLT_Ele8_CaloIdM_TrackIdM_PFJet30_;
    bool HLT_HT300_Beamspot_;
    TBranch *b_HLT_HT300_Beamspot_;
    bool loaded_HLT_HT300_Beamspot_;
    unsigned int counter_cached_HLT_HT300_Beamspot_;
    unsigned int counter_uncached_HLT_HT300_Beamspot_;
    ...
    unsigned int counter_cached_HLT_HT400_DisplacedDijet40_DisplacedTrack_;
    unsigned int counter_uncached_HLT_HT400_DisplacedDijet40_DisplacedTrack_;
    bool HLT_HT425_;
    TBranch *b_HLT_HT425_;
    bool loaded_HLT_HT425_;
    unsigned int counter_cached_HLT_HT425_;
    unsigned int counter_uncached_HLT_HT425_;
    ...
    unsigned int counter_cached_HLT_HT430_DisplacedDijet40_DisplacedTrack_;
    unsigned int counter_uncached_HLT_HT430_DisplacedDijet40_DisplacedTrack_;
    ...
    unsigned int counter_cached_HLT_HT430_DisplacedDijet60_DisplacedTrack_;
    unsigned int counter_uncached_HLT_HT430_DisplacedDijet60_DisplacedTrack_;
    bool HLT_HT450_Beamspot_;
    TBranch *b_HLT_HT450_Beamspot_;
    bool loaded_HLT_HT450_Beamspot_;
    unsigned int counter_cached_HLT_HT450_Beamspot_;
    unsigned int counter_uncached_HLT_HT450_Beamspot_;
    ...
    unsigned int counter_cached_HLT_HT500_DisplacedDijet40_DisplacedTrack_;
    unsigned int counter_uncached_HLT_HT500_DisplacedDijet40_DisplacedTrack_;
    ...
    unsigned int counter_cached_HLT_HT550_DisplacedDijet60_Inclusive_;
    unsigned int counter_uncached_HLT_HT550_DisplacedDijet60_Inclusive_;
    ...
    unsigned int counter_cached_HLT_HT650_DisplacedDijet60_Inclusive_;
    unsigned int counter_uncached_HLT_HT650_DisplacedDijet60_Inclusive_;
    bool HLT_HcalCalibration_;
    TBranch *b_HLT_HcalCalibration_;
    bool loaded_HLT_HcalCalibration_;
    unsigned int counter_cached_HLT_HcalCalibration_;
    unsigned int counter_uncached_HLT_HcalCalibration_;
    bool HLT_HcalIsolatedbunch_;
    TBranch *b_HLT_HcalIsolatedbunch_;
    bool loaded_HLT_HcalIsolatedbunch_;
    unsigned int counter_cached_HLT_HcalIsolatedbunch_;
    unsigned int counter_uncached_HLT_HcalIsolatedbunch_;
    bool HLT_HcalNZS_;
    TBranch *b_HLT_HcalNZS_;
    bool loaded_HLT_HcalNZS_;
    unsigned int counter_cached_HLT_HcalNZS_;
    unsigned int counter_uncached_HLT_HcalNZS_;
    bool HLT_HcalPhiSym_;
    TBranch *b_HLT_HcalPhiSym_;
    bool loaded_HLT_HcalPhiSym_;
    unsigned int counter_cached_HLT_HcalPhiSym_;
    unsigned int counter_uncached_HLT_HcalPhiSym_;
    bool HLT_IsoMu20_;
    TBranch *b_HLT_IsoMu20_;
    bool loaded_HLT_IsoMu20_;
    unsigned int counter_cached_HLT_IsoMu20_;
    unsigned int counter_uncached_HLT_IsoMu20_;
    ...
    unsigned int counter_cached_HLT_IsoMu20_eta2p1_LooseChargedIsoPFTauHPS27_eta2p1_CrossL1_;
    unsigned int counter_uncached_HLT_IsoMu20_eta2p1_LooseChargedIsoPFTauHPS27_eta2p1_CrossL1_;
    ...
    unsigned int counter_cached_HLT_IsoMu20_eta2p1_LooseChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1_;
    unsigned int counter_uncached_HLT_IsoMu20_eta2p1_LooseChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1_;
    ...
    unsigned int counter_cached_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_CrossL1_;
    unsigned int counter_uncached_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_CrossL1_;
    ...
    unsigned int counter_cached_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1_;
    unsigned int counter_uncached_HLT_IsoMu20_eta2p1_MediumChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1_;
    ...
    unsigned int counter_cached_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_CrossL1_;
    unsigned int counter_uncached_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_CrossL1_;
    ...
    unsigned int counter_cached_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1_;
    unsigned int counter_uncached_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_TightID_CrossL1_;
    bool HLT_IsoMu24_;
    TBranch *b_HLT_IsoMu24_;
    bool loaded_HLT_IsoMu24_;
    unsigned int counter_cached_HLT_IsoMu24_;
    unsigned int counter_uncached_HLT_IsoMu24_;
    bool HLT_IsoMu24_TwoProngs35_;
    TBranch *b_HLT_IsoMu24_TwoProngs35_;
    bool loaded_HLT_IsoMu24_TwoProngs35_;
    unsigned int counter_cached_HLT_IsoMu24_TwoProngs35_;
    unsigned int counter_uncached_HLT_IsoMu24_TwoProngs35_;
    bool HLT_IsoMu24_eta2p1_;
    TBranch *b_HLT_IsoMu24_eta2p1_;
    bool loaded_HLT_IsoMu24_eta2p1_;
    unsigned int counter_cached_HLT_IsoMu24_eta2p1_;
    unsigned int counter_uncached_HLT_IsoMu24_eta2p1_;
    ...
    unsigned int counter_cached_HLT_IsoMu24_eta2p1_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_;
    unsigned int counter_uncached_HLT_IsoMu24_eta2p1_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_;
    ...
    unsigned int counter_cached_HLT_IsoMu24_eta2p1_MediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1_;
    unsigned int counter_uncached_HLT_IsoMu24_eta2p1_MediumChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1_;
    ...
    unsigned int counter_cached_HLT_IsoMu24_eta2p1_MediumChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_CrossL1_;
    unsigned int counter_uncached_HLT_IsoMu24_eta2p1_MediumChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_CrossL1_;
    ...
    unsigned int counter_cached_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1_;
    unsigned int counter_uncached_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_TightID_eta2p1_Reg_CrossL1_;
    ...
    unsigned int counter_cached_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_CrossL1_;
    unsigned int counter_uncached_HLT_IsoMu24_eta2p1_TightChargedIsoPFTauHPS35_Trk1_eta2p1_Reg_CrossL1_;
    bool HLT_IsoMu27_;
    TBranch *b_HLT_IsoMu27_;
    bool loaded_HLT_IsoMu27_;
    unsigned int counter_cached_HLT_IsoMu27_;
    unsigned int counter_uncached_HLT_IsoMu27_;
    ...
    unsigned int counter_cached_HLT_IsoMu27_LooseChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1_;
    unsigned int counter_uncached_HLT_IsoMu27_LooseChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1_;
    bool HLT_IsoMu27_MET90_;
    TBranch *b_HLT_IsoMu27_MET90_;
    bool loaded_HLT_IsoMu27_MET90_;
    unsigned int counter_cached_HLT_IsoMu27_MET90_;
    unsigned int counter_uncached_HLT_IsoMu27_MET90_;
    ...
    unsigned int counter_cached_HLT_IsoMu27_MediumChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1_;
    unsigned int counter_uncached_HLT_IsoMu27_MediumChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1_;
    ...
    unsigned int counter_cached_HLT_IsoMu27_TightChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1_;
    unsigned int counter_uncached_HLT_IsoMu27_TightChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1_;
    bool HLT_IsoMu30_;
    TBranch *b_HLT_IsoMu30_;
    bool loaded_HLT_IsoMu30_;
    unsigned int counter_cached_HLT_IsoMu30_;
    unsigned int counter_uncached_HLT_IsoMu30_;
    bool HLT_IsoTrackHB_;
    TBranch *b_HLT_IsoTrackHB_;
    bool loaded_HLT_IsoTrackHB_;
    unsigned int counter_cached_HLT_IsoTrackHB_;
    unsigned int counter_uncached_HLT_IsoTrackHB_;
    bool HLT_IsoTrackHE_;
    TBranch *b_HLT_IsoTrackHE_;
    bool loaded_HLT_IsoTrackHE_;
    unsigned int counter_cached_HLT_IsoTrackHE_;
    unsigned int counter_uncached_HLT_IsoTrackHE_;
    bool HLT_L1ETMHadSeeds_;
    TBranch *b_HLT_L1ETMHadSeeds_;
    bool loaded_HLT_L1ETMHadSeeds_;
    unsigned int counter_cached_HLT_L1ETMHadSeeds_;
    unsigned int counter_uncached_HLT_L1ETMHadSeeds_;
    bool HLT_L1NotBptxOR_;
    TBranch *b_HLT_L1NotBptxOR_;
    bool loaded_HLT_L1NotBptxOR_;
    unsigned int counter_cached_HLT_L1NotBptxOR_;
    unsigned int counter_uncached_HLT_L1NotBptxOR_;
    bool HLT_L1SingleMu18_;
    TBranch *b_HLT_L1SingleMu18_;
    bool loaded_HLT_L1SingleMu18_;
    unsigned int counter_cached_HLT_L1SingleMu18_;
    unsigned int counter_uncached_HLT_L1SingleMu18_;
    bool HLT_L1SingleMu25_;
    TBranch *b_HLT_L1SingleMu25_;
    bool loaded_HLT_L1SingleMu25_;
    unsigned int counter_cached_HLT_L1SingleMu25_;
    unsigned int counter_uncached_HLT_L1SingleMu25_;
    bool HLT_L1UnpairedBunchBptxMinus_;
    TBranch *b_HLT_L1UnpairedBunchBptxMinus_;
    bool loaded_HLT_L1UnpairedBunchBptxMinus_;
    unsigned int counter_cached_HLT_L1UnpairedBunchBptxMinus_;
    unsigned int counter_uncached_HLT_L1UnpairedBunchBptxMinus_;
    bool HLT_L1UnpairedBunchBptxPlus_;
    TBranch *b_HLT_L1UnpairedBunchBptxPlus_;
    bool loaded_HLT_L1UnpairedBunchBptxPlus_;
    unsigned int counter_cached_HLT_L1UnpairedBunchBptxPlus_;
    unsigned int counter_uncached_HLT_L1UnpairedBunchBptxPlus_;
    ...
    unsigned int counter_cached_HLT_L1_CDC_SingleMu_3_er1p2_TOP120_DPHI2p618_3p142_;
    unsigned int counter_uncached_HLT_L1_CDC_SingleMu_3_er1p2_TOP120_DPHI2p618_3p142_;
    bool HLT_L2Mu10_;
    TBranch *b_HLT_L2Mu10_;
    bool loaded_HLT_L2Mu10_;
    unsigned int counter_cached_HLT_L2Mu10_;
    unsigned int counter_uncached_HLT_L2Mu10_;
    bool HLT_L2Mu10_NoVertex_NoBPTX_;
    TBranch *b_HLT_L2Mu10_NoVertex_NoBPTX_;
    bool loaded_HLT_L2Mu10_NoVertex_NoBPTX_;
    unsigned int counter_cached_HLT_L2Mu10_NoVertex_NoBPTX_;
    unsigned int counter_uncached_HLT_L2Mu10_NoVertex_NoBPTX_;
    bool HLT_L2Mu10_NoVertex_NoBPTX3BX_;
    TBranch *b_HLT_L2Mu10_NoVertex_NoBPTX3BX_;
    bool loaded_HLT_L2Mu10_NoVertex_NoBPTX3BX_;
    unsigned int counter_cached_HLT_L2Mu10_NoVertex_NoBPTX3BX_;
    unsigned int counter_uncached_HLT_L2Mu10_NoVertex_NoBPTX3BX_;
    bool HLT_L2Mu23NoVtx_2Cha_;
    TBranch *b_HLT_L2Mu23NoVtx_2Cha_;
    bool loaded_HLT_L2Mu23NoVtx_2Cha_;
    unsigned int counter_cached_HLT_L2Mu23NoVtx_2Cha_;
    unsigned int counter_uncached_HLT_L2Mu23NoVtx_2Cha_;
    ...
    unsigned int counter_cached_HLT_L2Mu23NoVtx_2Cha_CosmicSeed_;
    unsigned int counter_uncached_HLT_L2Mu23NoVtx_2Cha_CosmicSeed_;
    ...
    unsigned int counter_cached_HLT_L2Mu40_NoVertex_3Sta_NoBPTX3BX_;
    unsigned int counter_uncached_HLT_L2Mu40_NoVertex_3Sta_NoBPTX3BX_;
    ...
    unsigned int counter_cached_HLT_L2Mu45_NoVertex_3Sta_NoBPTX3BX_;
    unsigned int counter_uncached_HLT_L2Mu45_NoVertex_3Sta_NoBPTX3BX_;
    bool HLT_L2Mu50_;
    TBranch *b_HLT_L2Mu50_;
    bool loaded_HLT_L2Mu50_;
    unsigned int counter_cached_HLT_L2Mu50_;
    unsigned int counter_uncached_HLT_L2Mu50_;
    bool HLT_MET105_IsoTrk50_;
    TBranch *b_HLT_MET105_IsoTrk50_;
    bool loaded_HLT_MET105_IsoTrk50_;
    unsigned int counter_cached_HLT_MET105_IsoTrk50_;
    unsigned int counter_uncached_HLT_MET105_IsoTrk50_;
    bool HLT_MET120_IsoTrk50_;
    TBranch *b_HLT_MET120_IsoTrk50_;
    bool loaded_HLT_MET120_IsoTrk50_;
    unsigned int counter_cached_HLT_MET120_IsoTrk50_;
    unsigned int counter_uncached_HLT_MET120_IsoTrk50_;
    ...
    unsigned int counter_cached_HLT_MediumChargedIsoPFTau180HighPtRelaxedIso_Trk50_eta2p1_;
    unsigned int counter_uncached_HLT_MediumChargedIsoPFTau180HighPtRelaxedIso_Trk50_eta2p1_;
    ...
    unsigned int counter_cached_HLT_MediumChargedIsoPFTau180HighPtRelaxedIso_Trk50_eta2p1_1pr_;
    unsigned int counter_uncached_HLT_MediumChargedIsoPFTau180HighPtRelaxedIso_Trk50_eta2p1_1pr_;
    ...
    unsigned int counter_cached_HLT_MediumChargedIsoPFTau200HighPtRelaxedIso_Trk50_eta2p1_;
    unsigned int counter_uncached_HLT_MediumChargedIsoPFTau200HighPtRelaxedIso_Trk50_eta2p1_;
    ...
    unsigned int counter_cached_HLT_MediumChargedIsoPFTau220HighPtRelaxedIso_Trk50_eta2p1_;
    unsigned int counter_uncached_HLT_MediumChargedIsoPFTau220HighPtRelaxedIso_Trk50_eta2p1_;
    ...
    unsigned int counter_cached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_;
    unsigned int counter_uncached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_;
    ...
    unsigned int counter_cached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_MET100_;
    unsigned int counter_uncached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_MET100_;
    ...
    unsigned int counter_cached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_MET110_;
    unsigned int counter_uncached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_MET110_;
    ...
    unsigned int counter_cached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_MET120_;
    unsigned int counter_uncached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_MET120_;
    ...
    unsigned int counter_cached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_MET130_;
    unsigned int counter_uncached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_MET130_;
    ...
    unsigned int counter_cached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_MET140_;
    unsigned int counter_uncached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_MET140_;
    ...
    unsigned int counter_cached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_MET90_;
    unsigned int counter_uncached_HLT_MediumChargedIsoPFTau50_Trk30_eta2p1_1pr_MET90_;
    ...
    unsigned int counter_cached_HLT_MonoCentralPFJet80_PFMETNoMu110_PFMHTNoMu110_IDTight_;
    unsigned int counter_uncached_HLT_MonoCentralPFJet80_PFMETNoMu110_PFMHTNoMu110_IDTight_;
    ...
    unsigned int counter_cached_HLT_MonoCentralPFJet80_PFMETNoMu120_PFMHTNoMu120_IDTight_;
    unsigned int counter_uncached_HLT_MonoCentralPFJet80_PFMETNoMu120_PFMHTNoMu120_IDTight_;
    ...
    unsigned int counter_cached_HLT_MonoCentralPFJet80_PFMETNoMu130_PFMHTNoMu130_IDTight_;
    unsigned int counter_uncached_HLT_MonoCentralPFJet80_PFMETNoMu130_PFMHTNoMu130_IDTight_;
    ...
    unsigned int counter_cached_HLT_MonoCentralPFJet80_PFMETNoMu140_PFMHTNoMu140_IDTight_;
    unsigned int counter_uncached_HLT_MonoCentralPFJet80_PFMETNoMu140_PFMHTNoMu140_IDTight_;
    ...
    unsigned int counter_cached_HLT_Mu10_TrkIsoVVL_DiPFJet40_DEta3p5_MJJ750_HTT350_PFMETNoMu60_;
    unsigned int counter_uncached_HLT_Mu10_TrkIsoVVL_DiPFJet40_DEta3p5_MJJ750_HTT350_PFMETNoMu60_;
    bool HLT_Mu12_;
    TBranch *b_HLT_Mu12_;
    bool loaded_HLT_Mu12_;
    unsigned int counter_cached_HLT_Mu12_;
    unsigned int counter_uncached_HLT_Mu12_;
    ...
    unsigned int counter_cached_HLT_Mu12_DoublePFJets100_CaloBTagDeepCSV_p71_;
    unsigned int counter_uncached_HLT_Mu12_DoublePFJets100_CaloBTagDeepCSV_p71_;
    ...
    unsigned int counter_cached_HLT_Mu12_DoublePFJets200_CaloBTagDeepCSV_p71_;
    unsigned int counter_uncached_HLT_Mu12_DoublePFJets200_CaloBTagDeepCSV_p71_;
    ...
    unsigned int counter_cached_HLT_Mu12_DoublePFJets350_CaloBTagDeepCSV_p71_;
    unsigned int counter_uncached_HLT_Mu12_DoublePFJets350_CaloBTagDeepCSV_p71_;
    ...
    unsigned int counter_cached_HLT_Mu12_DoublePFJets40MaxDeta1p6_DoubleCaloBTagDeepCSV_p71_;
    unsigned int counter_uncached_HLT_Mu12_DoublePFJets40MaxDeta1p6_DoubleCaloBTagDeepCSV_p71_;
    ...
    unsigned int counter_cached_HLT_Mu12_DoublePFJets40_CaloBTagDeepCSV_p71_;
    unsigned int counter_uncached_HLT_Mu12_DoublePFJets40_CaloBTagDeepCSV_p71_;
    ...
    unsigned int counter_cached_HLT_Mu12_DoublePFJets54MaxDeta1p6_DoubleCaloBTagDeepCSV_p71_;
    unsigned int counter_uncached_HLT_Mu12_DoublePFJets54MaxDeta1p6_DoubleCaloBTagDeepCSV_p71_;
    ...
    unsigned int counter_cached_HLT_Mu12_DoublePFJets62MaxDeta1p6_DoubleCaloBTagDeepCSV_p71_;
    unsigned int counter_uncached_HLT_Mu12_DoublePFJets62MaxDeta1p6_DoubleCaloBTagDeepCSV_p71_;
    bool HLT_Mu12_DoublePhoton20_;
    TBranch *b_HLT_Mu12_DoublePhoton20_;
    bool loaded_HLT_Mu12_DoublePhoton20_;
    unsigned int counter_cached_HLT_Mu12_DoublePhoton20_;
    unsigned int counter_uncached_HLT_Mu12_DoublePhoton20_;
    bool HLT_Mu12_IP6_part0_;
    TBranch *b_HLT_Mu12_IP6_part0_;
    bool loaded_HLT_Mu12_IP6_part0_;
    unsigned int counter_cached_HLT_Mu12_IP6_part0_;
    unsigned int counter_uncached_HLT_Mu12_IP6_part0_;
    bool HLT_Mu12_IP6_part1_;
    TBranch *b_HLT_Mu12_IP6_part1_;
    bool loaded_HLT_Mu12_IP6_part1_;
    unsigned int counter_cached_HLT_Mu12_IP6_part1_;
    unsigned int counter_uncached_HLT_Mu12_IP6_part1_;
    bool HLT_Mu12_IP6_part2_;
    TBranch *b_HLT_Mu12_IP6_part2_;
    bool loaded_HLT_Mu12_IP6_part2_;
    unsigned int counter_cached_HLT_Mu12_IP6_part2_;
    unsigned int counter_uncached_HLT_Mu12_IP6_part2_;
    bool HLT_Mu12_IP6_part3_;
    TBranch *b_HLT_Mu12_IP6_part3_;
    bool loaded_HLT_Mu12_IP6_part3_;
    unsigned int counter_cached_HLT_Mu12_IP6_part3_;
    unsigned int counter_uncached_HLT_Mu12_IP6_part3_;
    bool HLT_Mu12_IP6_part4_;
    TBranch *b_HLT_Mu12_IP6_part4_;
    bool loaded_HLT_Mu12_IP6_part4_;
    unsigned int counter_cached_HLT_Mu12_IP6_part4_;
    unsigned int counter_uncached_HLT_Mu12_IP6_part4_;
    ...
    unsigned int counter_cached_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_;
    unsigned int counter_uncached_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_;
    ...
    unsigned int counter_cached_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_;
    unsigned int counter_uncached_HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_;
    bool HLT_Mu15_;
    TBranch *b_HLT_Mu15_;
    bool loaded_HLT_Mu15_;
    unsigned int counter_cached_HLT_Mu15_;
    unsigned int counter_uncached_HLT_Mu15_;
    bool HLT_Mu15_IsoVVVL_PFHT450_;
    TBranch *b_HLT_Mu15_IsoVVVL_PFHT450_;
    bool loaded_HLT_Mu15_IsoVVVL_PFHT450_;
    unsigned int counter_cached_HLT_Mu15_IsoVVVL_PFHT450_;
    unsigned int counter_uncached_HLT_Mu15_IsoVVVL_PFHT450_;
    ...
    unsigned int counter_cached_HLT_Mu15_IsoVVVL_PFHT450_CaloBTagDeepCSV_4p5_;
    unsigned int counter_uncached_HLT_Mu15_IsoVVVL_PFHT450_CaloBTagDeepCSV_4p5_;
    ...
    unsigned int counter_cached_HLT_Mu15_IsoVVVL_PFHT450_PFMET50_;
    unsigned int counter_uncached_HLT_Mu15_IsoVVVL_PFHT450_PFMET50_;
    bool HLT_Mu15_IsoVVVL_PFHT600_;
    TBranch *b_HLT_Mu15_IsoVVVL_PFHT600_;
    bool loaded_HLT_Mu15_IsoVVVL_PFHT600_;
    unsigned int counter_cached_HLT_Mu15_IsoVVVL_PFHT600_;
    unsigned int counter_uncached_HLT_Mu15_IsoVVVL_PFHT600_;
    bool HLT_Mu17_;
    TBranch *b_HLT_Mu17_;
    bool loaded_HLT_Mu17_;
    unsigned int counter_cached_HLT_Mu17_;
    unsigned int counter_uncached_HLT_Mu17_;
    bool HLT_Mu17_Photon30_IsoCaloId_;
    TBranch *b_HLT_Mu17_Photon30_IsoCaloId_;
    bool loaded_HLT_Mu17_Photon30_IsoCaloId_;
    unsigned int counter_cached_HLT_Mu17_Photon30_IsoCaloId_;
    unsigned int counter_uncached_HLT_Mu17_Photon30_IsoCaloId_;
    bool HLT_Mu17_TrkIsoVVL_;
    TBranch *b_HLT_Mu17_TrkIsoVVL_;
    bool loaded_HLT_Mu17_TrkIsoVVL_;
    unsigned int counter_cached_HLT_Mu17_TrkIsoVVL_;
    unsigned int counter_uncached_HLT_Mu17_TrkIsoVVL_;
    ...
    unsigned int counter_cached_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_;
    unsigned int counter_uncached_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_;
    ...
    unsigned int counter_cached_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_;
    unsigned int counter_uncached_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_;
    ...
    unsigned int counter_cached_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_;
    unsigned int counter_uncached_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_;
    ...
    unsigned int counter_cached_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_;
    unsigned int counter_uncached_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_;
    bool HLT_Mu18_Mu9_;
    TBranch *b_HLT_Mu18_Mu9_;
    bool loaded_HLT_Mu18_Mu9_;
    unsigned int counter_cached_HLT_Mu18_Mu9_;
    unsigned int counter_uncached_HLT_Mu18_Mu9_;
    bool HLT_Mu18_Mu9_DZ_;
    TBranch *b_HLT_Mu18_Mu9_DZ_;
    bool loaded_HLT_Mu18_Mu9_DZ_;
    unsigned int counter_cached_HLT_Mu18_Mu9_DZ_;
    unsigned int counter_uncached_HLT_Mu18_Mu9_DZ_;
    bool HLT_Mu18_Mu9_SameSign_;
    TBranch *b_HLT_Mu18_Mu9_SameSign_;
    bool loaded_HLT_Mu18_Mu9_SameSign_;
    unsigned int counter_cached_HLT_Mu18_Mu9_SameSign_;
    unsigned int counter_uncached_HLT_Mu18_Mu9_SameSign_;
    bool HLT_Mu18_Mu9_SameSign_DZ_;
    TBranch *b_HLT_Mu18_Mu9_SameSign_DZ_;
    bool loaded_HLT_Mu18_Mu9_SameSign_DZ_;
    unsigned int counter_cached_HLT_Mu18_Mu9_SameSign_DZ_;
    unsigned int counter_uncached_HLT_Mu18_Mu9_SameSign_DZ_;
    bool HLT_Mu19_;
    TBranch *b_HLT_Mu19_;
    bool loaded_HLT_Mu19_;
    unsigned int counter_cached_HLT_Mu19_;
    unsigned int counter_uncached_HLT_Mu19_;
    bool HLT_Mu19_TrkIsoVVL_;
    TBranch *b_HLT_Mu19_TrkIsoVVL_;
    bool loaded_HLT_Mu19_TrkIsoVVL_;
    unsigned int counter_cached_HLT_Mu19_TrkIsoVVL_;
    unsigned int counter_uncached_HLT_Mu19_TrkIsoVVL_;
    ...
    unsigned int counter_cached_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_;
    unsigned int counter_uncached_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_;
    ...
    unsigned int counter_cached_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_;
    unsigned int counter_uncached_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_;
    ...
    unsigned int counter_cached_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass3p8_;
    unsigned int counter_uncached_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass3p8_;
    ...
    unsigned int counter_cached_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass8_;
    unsigned int counter_uncached_HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass8_;
    bool HLT_Mu20_;
    TBranch *b_HLT_Mu20_;
    bool loaded_HLT_Mu20_;
    unsigned int counter_cached_HLT_Mu20_;
    unsigned int counter_uncached_HLT_Mu20_;
    bool HLT_Mu20_Mu10_;
    TBranch *b_HLT_Mu20_Mu10_;
    bool loaded_HLT_Mu20_Mu10_;
    unsigned int counter_cached_HLT_Mu20_Mu10_;
    unsigned int counter_uncached_HLT_Mu20_Mu10_;
    bool HLT_Mu20_Mu10_DZ_;
    TBranch *b_HLT_Mu20_Mu10_DZ_;
    bool loaded_HLT_Mu20_Mu10_DZ_;
    unsigned int counter_cached_HLT_Mu20_Mu10_DZ_;
    unsigned int counter_uncached_HLT_Mu20_Mu10_DZ_;
    bool HLT_Mu20_Mu10_SameSign_;
    TBranch *b_HLT_Mu20_Mu10_SameSign_;
    bool loaded_HLT_Mu20_Mu10_SameSign_;
    unsigned int counter_cached_HLT_Mu20_Mu10_SameSign_;
    unsigned int counter_uncached_HLT_Mu20_Mu10_SameSign_;
    bool HLT_Mu20_Mu10_SameSign_DZ_;
    TBranch *b_HLT_Mu20_Mu10_SameSign_DZ_;
    bool loaded_HLT_Mu20_Mu10_SameSign_DZ_;
    unsigned int counter_cached_HLT_Mu20_Mu10_SameSign_DZ_;
    unsigned int counter_uncached_HLT_Mu20_Mu10_SameSign_DZ_;
    bool HLT_Mu20_TkMu0_Phi_;
    TBranch *b_HLT_Mu20_TkMu0_Phi_;
    bool loaded_HLT_Mu20_TkMu0_Phi_;
    unsigned int counter_cached_HLT_Mu20_TkMu0_Phi_;
    unsigned int counter_uncached_HLT_Mu20_TkMu0_Phi_;
    bool HLT_Mu23_Mu12_;
    TBranch *b_HLT_Mu23_Mu12_;
    bool loaded_HLT_Mu23_Mu12_;
    unsigned int counter_cached_HLT_Mu23_Mu12_;
    unsigned int counter_uncached_HLT_Mu23_Mu12_;
    bool HLT_Mu23_Mu12_DZ_;
    TBranch *b_HLT_Mu23_Mu12_DZ_;
    bool loaded_HLT_Mu23_Mu12_DZ_;
    unsigned int counter_cached_HLT_Mu23_Mu12_DZ_;
    unsigned int counter_uncached_HLT_Mu23_Mu12_DZ_;
    bool HLT_Mu23_Mu12_SameSign_;
    TBranch *b_HLT_Mu23_Mu12_SameSign_;
    bool loaded_HLT_Mu23_Mu12_SameSign_;
    unsigned int counter_cached_HLT_Mu23_Mu12_SameSign_;
    unsigned int counter_uncached_HLT_Mu23_Mu12_SameSign_;
    bool HLT_Mu23_Mu12_SameSign_DZ_;
    TBranch *b_HLT_Mu23_Mu12_SameSign_DZ_;
    bool loaded_HLT_Mu23_Mu12_SameSign_DZ_;
    unsigned int counter_cached_HLT_Mu23_Mu12_SameSign_DZ_;
    unsigned int counter_uncached_HLT_Mu23_Mu12_SameSign_DZ_;
    ...
    unsigned int counter_cached_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_;
    unsigned int counter_uncached_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_;
    ...
    unsigned int counter_cached_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_;
    unsigned int counter_uncached_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_;
    bool HLT_Mu25_TkMu0_Onia_;
    TBranch *b_HLT_Mu25_TkMu0_Onia_;
    bool loaded_HLT_Mu25_TkMu0_Onia_;
    unsigned int counter_cached_HLT_Mu25_TkMu0_Onia_;
    unsigned int counter_uncached_HLT_Mu25_TkMu0_Onia_;
    bool HLT_Mu25_TkMu0_Phi_;
    TBranch *b_HLT_Mu25_TkMu0_Phi_;
    bool loaded_HLT_Mu25_TkMu0_Phi_;
    unsigned int counter_cached_HLT_Mu25_TkMu0_Phi_;
    unsigned int counter_uncached_HLT_Mu25_TkMu0_Phi_;
    bool HLT_Mu27_;
    TBranch *b_HLT_Mu27_;
    bool loaded_HLT_Mu27_;
    unsigned int counter_cached_HLT_Mu27_;
    unsigned int counter_uncached_HLT_Mu27_;
    bool HLT_Mu27_Ele37_CaloIdL_MW_;
    TBranch *b_HLT_Mu27_Ele37_CaloIdL_MW_;
    bool loaded_HLT_Mu27_Ele37_CaloIdL_MW_;
    unsigned int counter_cached_HLT_Mu27_Ele37_CaloIdL_MW_;
    unsigned int counter_uncached_HLT_Mu27_Ele37_CaloIdL_MW_;
    bool HLT_Mu30_TkMu0_Psi_;
    TBranch *b_HLT_Mu30_TkMu0_Psi_;
    bool loaded_HLT_Mu30_TkMu0_Psi_;
    unsigned int counter_cached_HLT_Mu30_TkMu0_Psi_;
    unsigned int counter_uncached_HLT_Mu30_TkMu0_Psi_;
    bool HLT_Mu30_TkMu0_Upsilon_;
    TBranch *b_HLT_Mu30_TkMu0_Upsilon_;
    bool loaded_HLT_Mu30_TkMu0_Upsilon_;
    unsigned int counter_cached_HLT_Mu30_TkMu0_Upsilon_;
    unsigned int counter_uncached_HLT_Mu30_TkMu0_Upsilon_;
    bool HLT_Mu37_Ele27_CaloIdL_MW_;
    TBranch *b_HLT_Mu37_Ele27_CaloIdL_MW_;
    bool loaded_HLT_Mu37_Ele27_CaloIdL_MW_;
    unsigned int counter_cached_HLT_Mu37_Ele27_CaloIdL_MW_;
    unsigned int counter_uncached_HLT_Mu37_Ele27_CaloIdL_MW_;
    bool HLT_Mu37_TkMu27_;
    TBranch *b_HLT_Mu37_TkMu27_;
    bool loaded_HLT_Mu37_TkMu27_;
    unsigned int counter_cached_HLT_Mu37_TkMu27_;
    unsigned int counter_uncached_HLT_Mu37_TkMu27_;
    ...
    unsigned int counter_cached_HLT_Mu38NoFiltersNoVtxDisplaced_Photon38_CaloIdL_;
    unsigned int counter_uncached_HLT_Mu38NoFiltersNoVtxDisplaced_Photon38_CaloIdL_;
    bool HLT_Mu3_L1SingleMu5orSingleMu7_;
    TBranch *b_HLT_Mu3_L1SingleMu5orSingleMu7_;
    bool loaded_HLT_Mu3_L1SingleMu5orSingleMu7_;
    unsigned int counter_cached_HLT_Mu3_L1SingleMu5orSingleMu7_;
    unsigned int counter_uncached_HLT_Mu3_L1SingleMu5orSingleMu7_;
    bool HLT_Mu3_PFJet40_;
    TBranch *b_HLT_Mu3_PFJet40_;
    bool loaded_HLT_Mu3_PFJet40_;
    unsigned int counter_cached_HLT_Mu3_PFJet40_;
    unsigned int counter_uncached_HLT_Mu3_PFJet40_;
    ...
    unsigned int counter_cached_HLT_Mu3er1p5_PFJet100er2p5_PFMET100_PFMHT100_IDTight_;
    unsigned int counter_uncached_HLT_Mu3er1p5_PFJet100er2p5_PFMET100_PFMHT100_IDTight_;
    ...
    unsigned int counter_cached_HLT_Mu3er1p5_PFJet100er2p5_PFMET70_PFMHT70_IDTight_;
    unsigned int counter_uncached_HLT_Mu3er1p5_PFJet100er2p5_PFMET70_PFMHT70_IDTight_;
    ...
    unsigned int counter_cached_HLT_Mu3er1p5_PFJet100er2p5_PFMET80_PFMHT80_IDTight_;
    unsigned int counter_uncached_HLT_Mu3er1p5_PFJet100er2p5_PFMET80_PFMHT80_IDTight_;
    ...
    unsigned int counter_cached_HLT_Mu3er1p5_PFJet100er2p5_PFMET90_PFMHT90_IDTight_;
    unsigned int counter_uncached_HLT_Mu3er1p5_PFJet100er2p5_PFMET90_PFMHT90_IDTight_;
    ...
    unsigned int counter_cached_HLT_Mu3er1p5_PFJet100er2p5_PFMETNoMu100_PFMHTNoMu100_IDTight_;
    unsigned int counter_uncached_HLT_Mu3er1p5_PFJet100er2p5_PFMETNoMu100_PFMHTNoMu100_IDTight_;
    ...
    unsigned int counter_cached_HLT_Mu3er1p5_PFJet100er2p5_PFMETNoMu70_PFMHTNoMu70_IDTight_;
    unsigned int counter_uncached_HLT_Mu3er1p5_PFJet100er2p5_PFMETNoMu70_PFMHTNoMu70_IDTight_;
    ...
    unsigned int counter_cached_HLT_Mu3er1p5_PFJet100er2p5_PFMETNoMu80_PFMHTNoMu80_IDTight_;
    unsigned int counter_uncached_HLT_Mu3er1p5_PFJet100er2p5_PFMETNoMu80_PFMHTNoMu80_IDTight_;
    ...
    unsigned int counter_cached_HLT_Mu3er1p5_PFJet100er2p5_PFMETNoMu90_PFMHTNoMu90_IDTight_;
    unsigned int counter_uncached_HLT_Mu3er1p5_PFJet100er2p5_PFMETNoMu90_PFMHTNoMu90_IDTight_;
    ...
    unsigned int counter_cached_HLT_Mu43NoFiltersNoVtxDisplaced_Photon43_CaloIdL_;
    unsigned int counter_uncached_HLT_Mu43NoFiltersNoVtxDisplaced_Photon43_CaloIdL_;
    ...
    unsigned int counter_cached_HLT_Mu43NoFiltersNoVtx_Photon43_CaloIdL_;
    unsigned int counter_uncached_HLT_Mu43NoFiltersNoVtx_Photon43_CaloIdL_;
    ...
    unsigned int counter_cached_HLT_Mu48NoFiltersNoVtx_Photon48_CaloIdL_;
    unsigned int counter_uncached_HLT_Mu48NoFiltersNoVtx_Photon48_CaloIdL_;
    ...
    unsigned int counter_cached_HLT_Mu4_TrkIsoVVL_DiPFJet90_40_DEta3p5_MJJ750_HTT300_PFMETNoMu60_;
    unsigned int counter_uncached_HLT_Mu4_TrkIsoVVL_DiPFJet90_40_DEta3p5_MJJ750_HTT300_PFMETNoMu60_;
    bool HLT_Mu50_;
    TBranch *b_HLT_Mu50_;
    bool loaded_HLT_Mu50_;
    unsigned int counter_cached_HLT_Mu50_;
    unsigned int counter_uncached_HLT_Mu50_;
    bool HLT_Mu50_IsoVVVL_PFHT450_;
    TBranch *b_HLT_Mu50_IsoVVVL_PFHT450_;
    bool loaded_HLT_Mu50_IsoVVVL_PFHT450_;
    unsigned int counter_cached_HLT_Mu50_IsoVVVL_PFHT450_;
    unsigned int counter_uncached_HLT_Mu50_IsoVVVL_PFHT450_;
    bool HLT_Mu55_;
    TBranch *b_HLT_Mu55_;
    bool loaded_HLT_Mu55_;
    unsigned int counter_cached_HLT_Mu55_;
    unsigned int counter_uncached_HLT_Mu55_;
    bool HLT_Mu7_IP4_part0_;
    TBranch *b_HLT_Mu7_IP4_part0_;
    bool loaded_HLT_Mu7_IP4_part0_;
    unsigned int counter_cached_HLT_Mu7_IP4_part0_;
    unsigned int counter_uncached_HLT_Mu7_IP4_part0_;
    bool HLT_Mu7_IP4_part1_;
    TBranch *b_HLT_Mu7_IP4_part1_;
    bool loaded_HLT_Mu7_IP4_part1_;
    unsigned int counter_cached_HLT_Mu7_IP4_part1_;
    unsigned int counter_uncached_HLT_Mu7_IP4_part1_;
    bool HLT_Mu7_IP4_part2_;
    TBranch *b_HLT_Mu7_IP4_part2_;
    bool loaded_HLT_Mu7_IP4_part2_;
    unsigned int counter_cached_HLT_Mu7_IP4_part2_;
    unsigned int counter_uncached_HLT_Mu7_IP4_part2_;
    bool HLT_Mu7_IP4_part3_;
    TBranch *b_HLT_Mu7_IP4_part3_;
    bool loaded_HLT_Mu7_IP4_part3_;
    unsigned int counter_cached_HLT_Mu7_IP4_part3_;
    unsigned int counter_uncached_HLT_Mu7_IP4_part3_;
    bool HLT_Mu7_IP4_part4_;
    TBranch *b_HLT_Mu7_IP4_part4_;
    bool loaded_HLT_Mu7_IP4_part4_;
    unsigned int counter_cached_HLT_Mu7_IP4_part4_;
    unsigned int counter_uncached_HLT_Mu7_IP4_part4_;
    bool HLT_Mu7p5_L2Mu2_Jpsi_;
    TBranch *b_HLT_Mu7p5_L2Mu2_Jpsi_;
    bool loaded_HLT_Mu7p5_L2Mu2_Jpsi_;
    unsigned int counter_cached_HLT_Mu7p5_L2Mu2_Jpsi_;
    unsigned int counter_uncached_HLT_Mu7p5_L2Mu2_Jpsi_;
    bool HLT_Mu7p5_L2Mu2_Upsilon_;
    TBranch *b_HLT_Mu7p5_L2Mu2_Upsilon_;
    bool loaded_HLT_Mu7p5_L2Mu2_Upsilon_;
    unsigned int counter_cached_HLT_Mu7p5_L2Mu2_Upsilon_;
    unsigned int counter_uncached_HLT_Mu7p5_L2Mu2_Upsilon_;
    bool HLT_Mu7p5_Track2_Jpsi_;
    TBranch *b_HLT_Mu7p5_Track2_Jpsi_;
    bool loaded_HLT_Mu7p5_Track2_Jpsi_;
    unsigned int counter_cached_HLT_Mu7p5_Track2_Jpsi_;
    unsigned int counter_uncached_HLT_Mu7p5_Track2_Jpsi_;
    bool HLT_Mu7p5_Track2_Upsilon_;
    TBranch *b_HLT_Mu7p5_Track2_Upsilon_;
    bool loaded_HLT_Mu7p5_Track2_Upsilon_;
    unsigned int counter_cached_HLT_Mu7p5_Track2_Upsilon_;
    unsigned int counter_uncached_HLT_Mu7p5_Track2_Upsilon_;
    bool HLT_Mu7p5_Track3p5_Jpsi_;
    TBranch *b_HLT_Mu7p5_Track3p5_Jpsi_;
    bool loaded_HLT_Mu7p5_Track3p5_Jpsi_;
    unsigned int counter_cached_HLT_Mu7p5_Track3p5_Jpsi_;
    unsigned int counter_uncached_HLT_Mu7p5_Track3p5_Jpsi_;
    bool HLT_Mu7p5_Track3p5_Upsilon_;
    TBranch *b_HLT_Mu7p5_Track3p5_Upsilon_;
    bool loaded_HLT_Mu7p5_Track3p5_Upsilon_;
    unsigned int counter_cached_HLT_Mu7p5_Track3p5_Upsilon_;
    unsigned int counter_uncached_HLT_Mu7p5_Track3p5_Upsilon_;
    bool HLT_Mu7p5_Track7_Jpsi_;
    TBranch *b_HLT_Mu7p5_Track7_Jpsi_;
    bool loaded_HLT_Mu7p5_Track7_Jpsi_;
    unsigned int counter_cached_HLT_Mu7p5_Track7_Jpsi_;
    unsigned int counter_uncached_HLT_Mu7p5_Track7_Jpsi_;
    bool HLT_Mu7p5_Track7_Upsilon_;
    TBranch *b_HLT_Mu7p5_Track7_Upsilon_;
    bool loaded_HLT_Mu7p5_Track7_Upsilon_;
    unsigned int counter_cached_HLT_Mu7p5_Track7_Upsilon_;
    unsigned int counter_uncached_HLT_Mu7p5_Track7_Upsilon_;
    bool HLT_Mu8_;
    TBranch *b_HLT_Mu8_;
    bool loaded_HLT_Mu8_;
    unsigned int counter_cached_HLT_Mu8_;
    unsigned int counter_uncached_HLT_Mu8_;
    ...
    unsigned int counter_cached_HLT_Mu8_DiEle12_CaloIdL_TrackIdL_;
    unsigned int counter_uncached_HLT_Mu8_DiEle12_CaloIdL_TrackIdL_;
    ...
    unsigned int counter_cached_HLT_Mu8_DiEle12_CaloIdL_TrackIdL_DZ_;
    unsigned int counter_uncached_HLT_Mu8_DiEle12_CaloIdL_TrackIdL_DZ_;
    ...
    unsigned int counter_cached_HLT_Mu8_Ele8_CaloIdM_TrackIdM_Mass8_PFHT350_;
    unsigned int counter_uncached_HLT_Mu8_Ele8_CaloIdM_TrackIdM_Mass8_PFHT350_;
    ...
    unsigned int counter_cached_HLT_Mu8_Ele8_CaloIdM_TrackIdM_Mass8_PFHT350_DZ_;
    unsigned int counter_uncached_HLT_Mu8_Ele8_CaloIdM_TrackIdM_Mass8_PFHT350_DZ_;
    bool HLT_Mu8_IP3_part0_;
    TBranch *b_HLT_Mu8_IP3_part0_;
    bool loaded_HLT_Mu8_IP3_part0_;
    unsigned int counter_cached_HLT_Mu8_IP3_part0_;
    unsigned int counter_uncached_HLT_Mu8_IP3_part0_;
    bool HLT_Mu8_IP3_part1_;
    TBranch *b_HLT_Mu8_IP3_part1_;
    bool loaded_HLT_Mu8_IP3_part1_;
    unsigned int counter_cached_HLT_Mu8_IP3_part1_;
    unsigned int counter_uncached_HLT_Mu8_IP3_part1_;
    bool HLT_Mu8_IP3_part2_;
    TBranch *b_HLT_Mu8_IP3_part2_;
    bool loaded_HLT_Mu8_IP3_part2_;
    unsigned int counter_cached_HLT_Mu8_IP3_part2_;
    unsigned int counter_uncached_HLT_Mu8_IP3_part2_;
    bool HLT_Mu8_IP3_part3_;
    TBranch *b_HLT_Mu8_IP3_part3_;
    bool loaded_HLT_Mu8_IP3_part3_;
    unsigned int counter_cached_HLT_Mu8_IP3_part3_;
    unsigned int counter_uncached_HLT_Mu8_IP3_part3_;
    bool HLT_Mu8_IP3_part4_;
    TBranch *b_HLT_Mu8_IP3_part4_;
    bool loaded_HLT_Mu8_IP3_part4_;
    unsigned int counter_cached_HLT_Mu8_IP3_part4_;
    unsigned int counter_uncached_HLT_Mu8_IP3_part4_;
    bool HLT_Mu8_IP5_part0_;
    TBranch *b_HLT_Mu8_IP5_part0_;
    bool loaded_HLT_Mu8_IP5_part0_;
    unsigned int counter_cached_HLT_Mu8_IP5_part0_;
    unsigned int counter_uncached_HLT_Mu8_IP5_part0_;
    bool HLT_Mu8_IP5_part1_;
    TBranch *b_HLT_Mu8_IP5_part1_;
    bool loaded_HLT_Mu8_IP5_part1_;
    unsigned int counter_cached_HLT_Mu8_IP5_part1_;
    unsigned int counter_uncached_HLT_Mu8_IP5_part1_;
    bool HLT_Mu8_IP5_part2_;
    TBranch *b_HLT_Mu8_IP5_part2_;
    bool loaded_HLT_Mu8_IP5_part2_;
    unsigned int counter_cached_HLT_Mu8_IP5_part2_;
    unsigned int counter_uncached_HLT_Mu8_IP5_part2_;
    bool HLT_Mu8_IP5_part3_;
    TBranch *b_HLT_Mu8_IP5_part3_;
    bool loaded_HLT_Mu8_IP5_part3_;
    unsigned int counter_cached_HLT_Mu8_IP5_part3_;
    unsigned int counter_uncached_HLT_Mu8_IP5_part3_;
    bool HLT_Mu8_IP5_part4_;
    TBranch *b_HLT_Mu8_IP5_part4_;
    bool loaded_HLT_Mu8_IP5_part4_;
    unsigned int counter_cached_HLT_Mu8_IP5_part4_;
    unsigned int counter_uncached_HLT_Mu8_IP5_part4_;
    bool HLT_Mu8_IP6_part0_;
    TBranch *b_HLT_Mu8_IP6_part0_;
    bool loaded_HLT_Mu8_IP6_part0_;
    unsigned int counter_cached_HLT_Mu8_IP6_part0_;
    unsigned int counter_uncached_HLT_Mu8_IP6_part0_;
    bool HLT_Mu8_IP6_part1_;
    TBranch *b_HLT_Mu8_IP6_part1_;
    bool loaded_HLT_Mu8_IP6_part1_;
    unsigned int counter_cached_HLT_Mu8_IP6_part1_;
    unsigned int counter_uncached_HLT_Mu8_IP6_part1_;
    bool HLT_Mu8_IP6_part2_;
    TBranch *b_HLT_Mu8_IP6_part2_;
    bool loaded_HLT_Mu8_IP6_part2_;
    unsigned int counter_cached_HLT_Mu8_IP6_part2_;
    unsigned int counter_uncached_HLT_Mu8_IP6_part2_;
    bool HLT_Mu8_IP6_part3_;
    TBranch *b_HLT_Mu8_IP6_part3_;
    bool loaded_HLT_Mu8_IP6_part3_;
    unsigned int counter_cached_HLT_Mu8_IP6_part3_;
    unsigned int counter_uncached_HLT_Mu8_IP6_part3_;
    bool HLT_Mu8_IP6_part4_;
    TBranch *b_HLT_Mu8_IP6_part4_;
    bool loaded_HLT_Mu8_IP6_part4_;
    unsigned int counter_cached_HLT_Mu8_IP6_part4_;
    unsigned int counter_uncached_HLT_Mu8_IP6_part4_;
    bool HLT_Mu8_TrkIsoVVL_;
    TBranch *b_HLT_Mu8_TrkIsoVVL_;
    bool loaded_HLT_Mu8_TrkIsoVVL_;
    unsigned int counter_cached_HLT_Mu8_TrkIsoVVL_;
    unsigned int counter_uncached_HLT_Mu8_TrkIsoVVL_;
    ...
    unsigned int counter_cached_HLT_Mu8_TrkIsoVVL_DiPFJet40_DEta3p5_MJJ750_HTT300_PFMETNoMu60_;
    unsigned int counter_uncached_HLT_Mu8_TrkIsoVVL_DiPFJet40_DEta3p5_MJJ750_HTT300_PFMETNoMu60_;
    ...
    unsigned int counter_cached_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_;
    unsigned int counter_uncached_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_;
    ...
    unsigned int counter_cached_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_;
    unsigned int counter_uncached_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_;
    ...
    unsigned int counter_cached_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30_;
    unsigned int counter_uncached_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30_;
    ...
    unsigned int counter_cached_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30_CaloBtagDeepCSV_1p5_;
    unsigned int counter_uncached_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_CaloDiJet30_CaloBtagDeepCSV_1p5_;
    ...
    unsigned int counter_cached_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30_;
    unsigned int counter_uncached_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30_;
    ...
    unsigned int counter_cached_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30_PFBtagDeepCSV_1p5_;
    unsigned int counter_uncached_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_PFDiJet30_PFBtagDeepCSV_1p5_;
    bool HLT_Mu9_IP4_part0_;
    TBranch *b_HLT_Mu9_IP4_part0_;
    bool loaded_HLT_Mu9_IP4_part0_;
    unsigned int counter_cached_HLT_Mu9_IP4_part0_;
    unsigned int counter_uncached_HLT_Mu9_IP4_part0_;
    bool HLT_Mu9_IP4_part1_;
    TBranch *b_HLT_Mu9_IP4_part1_;
    bool loaded_HLT_Mu9_IP4_part1_;
    unsigned int counter_cached_HLT_Mu9_IP4_part1_;
    unsigned int counter_uncached_HLT_Mu9_IP4_part1_;
    bool HLT_Mu9_IP4_part2_;
    TBranch *b_HLT_Mu9_IP4_part2_;
    bool loaded_HLT_Mu9_IP4_part2_;
    unsigned int counter_cached_HLT_Mu9_IP4_part2_;
    unsigned int counter_uncached_HLT_Mu9_IP4_part2_;
    bool HLT_Mu9_IP4_part3_;
    TBranch *b_HLT_Mu9_IP4_part3_;
    bool loaded_HLT_Mu9_IP4_part3_;
    unsigned int counter_cached_HLT_Mu9_IP4_part3_;
    unsigned int counter_uncached_HLT_Mu9_IP4_part3_;
    bool HLT_Mu9_IP4_part4_;
    TBranch *b_HLT_Mu9_IP4_part4_;
    bool loaded_HLT_Mu9_IP4_part4_;
    unsigned int counter_cached_HLT_Mu9_IP4_part4_;
    unsigned int counter_uncached_HLT_Mu9_IP4_part4_;
    bool HLT_Mu9_IP5_part0_;
    TBranch *b_HLT_Mu9_IP5_part0_;
    bool loaded_HLT_Mu9_IP5_part0_;
    unsigned int counter_cached_HLT_Mu9_IP5_part0_;
    unsigned int counter_uncached_HLT_Mu9_IP5_part0_;
    bool HLT_Mu9_IP5_part1_;
    TBranch *b_HLT_Mu9_IP5_part1_;
    bool loaded_HLT_Mu9_IP5_part1_;
    unsigned int counter_cached_HLT_Mu9_IP5_part1_;
    unsigned int counter_uncached_HLT_Mu9_IP5_part1_;
    bool HLT_Mu9_IP5_part2_;
    TBranch *b_HLT_Mu9_IP5_part2_;
    bool loaded_HLT_Mu9_IP5_part2_;
    unsigned int counter_cached_HLT_Mu9_IP5_part2_;
    unsigned int counter_uncached_HLT_Mu9_IP5_part2_;
    bool HLT_Mu9_IP5_part3_;
    TBranch *b_HLT_Mu9_IP5_part3_;
    bool loaded_HLT_Mu9_IP5_part3_;
    unsigned int counter_cached_HLT_Mu9_IP5_part3_;
    unsigned int counter_uncached_HLT_Mu9_IP5_part3_;
    bool HLT_Mu9_IP5_part4_;
    TBranch *b_HLT_Mu9_IP5_part4_;
    bool loaded_HLT_Mu9_IP5_part4_;
    unsigned int counter_cached_HLT_Mu9_IP5_part4_;
    unsigned int counter_uncached_HLT_Mu9_IP5_part4_;
    bool HLT_Mu9_IP6_part0_;
    TBranch *b_HLT_Mu9_IP6_part0_;
    bool loaded_HLT_Mu9_IP6_part0_;
    unsigned int counter_cached_HLT_Mu9_IP6_part0_;
    unsigned int counter_uncached_HLT_Mu9_IP6_part0_;
    bool HLT_Mu9_IP6_part1_;
    TBranch *b_HLT_Mu9_IP6_part1_;
    bool loaded_HLT_Mu9_IP6_part1_;
    unsigned int counter_cached_HLT_Mu9_IP6_part1_;
    unsigned int counter_uncached_HLT_Mu9_IP6_part1_;
    bool HLT_Mu9_IP6_part2_;
    TBranch *b_HLT_Mu9_IP6_part2_;
    bool loaded_HLT_Mu9_IP6_part2_;
    unsigned int counter_cached_HLT_Mu9_IP6_part2_;
    unsigned int counter_uncached_HLT_Mu9_IP6_part2_;
    bool HLT_Mu9_IP6_part3_;
    TBranch *b_HLT_Mu9_IP6_part3_;
    bool loaded_HLT_Mu9_IP6_part3_;
    unsigned int counter_cached_HLT_Mu9_IP6_part3_;
    unsigned int counter_uncached_HLT_Mu9_IP6_part3_;
    bool HLT_Mu9_IP6_part4_;
    TBranch *b_HLT_Mu9_IP6_part4_;
    bool loaded_HLT_Mu9_IP6_part4_;
    unsigned int counter_cached_HLT_Mu9_IP6_part4_;
    unsigned int counter_uncached_HLT_Mu9_IP6_part4_;
    bool HLT_OldMu100_;
    TBranch *b_HLT_OldMu100_;
    bool loaded_HLT_OldMu100_;
    unsigned int counter_cached_HLT_OldMu100_;
    unsigned int counter_uncached_HLT_OldMu100_;
    bool HLT_PFHT1050_;
    TBranch *b_HLT_PFHT1050_;
    bool loaded_HLT_PFHT1050_;
    unsigned int counter_cached_HLT_PFHT1050_;
    unsigned int counter_uncached_HLT_PFHT1050_;
    bool HLT_PFHT180_;
    TBranch *b_HLT_PFHT180_;
    bool loaded_HLT_PFHT180_;
    unsigned int counter_cached_HLT_PFHT180_;
    unsigned int counter_uncached_HLT_PFHT180_;
    bool HLT_PFHT250_;
    TBranch *b_HLT_PFHT250_;
    bool loaded_HLT_PFHT250_;
    unsigned int counter_cached_HLT_PFHT250_;
    unsigned int counter_uncached_HLT_PFHT250_;
    ...
    unsigned int counter_cached_HLT_PFHT330PT30_QuadPFJet_75_60_45_40_;
    unsigned int counter_uncached_HLT_PFHT330PT30_QuadPFJet_75_60_45_40_;
    ...
    unsigned int counter_cached_HLT_PFHT330PT30_QuadPFJet_75_60_45_40_TriplePFBTagDeepCSV_4p5_;
    unsigned int counter_uncached_HLT_PFHT330PT30_QuadPFJet_75_60_45_40_TriplePFBTagDeepCSV_4p5_;
    bool HLT_PFHT350_;
    TBranch *b_HLT_PFHT350_;
    bool loaded_HLT_PFHT350_;
    unsigned int counter_cached_HLT_PFHT350_;
    unsigned int counter_uncached_HLT_PFHT350_;
    bool HLT_PFHT350MinPFJet15_;
    TBranch *b_HLT_PFHT350MinPFJet15_;
    bool loaded_HLT_PFHT350MinPFJet15_;
    unsigned int counter_cached_HLT_PFHT350MinPFJet15_;
    unsigned int counter_uncached_HLT_PFHT350MinPFJet15_;
    bool HLT_PFHT370_;
    TBranch *b_HLT_PFHT370_;
    bool loaded_HLT_PFHT370_;
    unsigned int counter_cached_HLT_PFHT370_;
    unsigned int counter_uncached_HLT_PFHT370_;
    bool HLT_PFHT400_SixPFJet32_;
    TBranch *b_HLT_PFHT400_SixPFJet32_;
    bool loaded_HLT_PFHT400_SixPFJet32_;
    unsigned int counter_cached_HLT_PFHT400_SixPFJet32_;
    unsigned int counter_uncached_HLT_PFHT400_SixPFJet32_;
    ...
    unsigned int counter_cached_HLT_PFHT400_SixPFJet32_DoublePFBTagDeepCSV_2p94_;
    unsigned int counter_uncached_HLT_PFHT400_SixPFJet32_DoublePFBTagDeepCSV_2p94_;
    bool HLT_PFHT430_;
    TBranch *b_HLT_PFHT430_;
    bool loaded_HLT_PFHT430_;
    unsigned int counter_cached_HLT_PFHT430_;
    unsigned int counter_uncached_HLT_PFHT430_;
    bool HLT_PFHT450_SixPFJet36_;
    TBranch *b_HLT_PFHT450_SixPFJet36_;
    bool loaded_HLT_PFHT450_SixPFJet36_;
    unsigned int counter_cached_HLT_PFHT450_SixPFJet36_;
    unsigned int counter_uncached_HLT_PFHT450_SixPFJet36_;
    ...
    unsigned int counter_cached_HLT_PFHT450_SixPFJet36_PFBTagDeepCSV_1p59_;
    unsigned int counter_uncached_HLT_PFHT450_SixPFJet36_PFBTagDeepCSV_1p59_;
    ...
    unsigned int counter_cached_HLT_PFHT500_PFMET100_PFMHT100_IDTight_;
    unsigned int counter_uncached_HLT_PFHT500_PFMET100_PFMHT100_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFHT500_PFMET110_PFMHT110_IDTight_;
    unsigned int counter_uncached_HLT_PFHT500_PFMET110_PFMHT110_IDTight_;
    bool HLT_PFHT510_;
    TBranch *b_HLT_PFHT510_;
    bool loaded_HLT_PFHT510_;
    unsigned int counter_cached_HLT_PFHT510_;
    unsigned int counter_uncached_HLT_PFHT510_;
    bool HLT_PFHT590_;
    TBranch *b_HLT_PFHT590_;
    bool loaded_HLT_PFHT590_;
    unsigned int counter_cached_HLT_PFHT590_;
    unsigned int counter_uncached_HLT_PFHT590_;
    bool HLT_PFHT680_;
    TBranch *b_HLT_PFHT680_;
    bool loaded_HLT_PFHT680_;
    unsigned int counter_cached_HLT_PFHT680_;
    unsigned int counter_uncached_HLT_PFHT680_;
    ...
    unsigned int counter_cached_HLT_PFHT700_PFMET85_PFMHT85_IDTight_;
    unsigned int counter_uncached_HLT_PFHT700_PFMET85_PFMHT85_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFHT700_PFMET95_PFMHT95_IDTight_;
    unsigned int counter_uncached_HLT_PFHT700_PFMET95_PFMHT95_IDTight_;
    bool HLT_PFHT780_;
    TBranch *b_HLT_PFHT780_;
    bool loaded_HLT_PFHT780_;
    unsigned int counter_cached_HLT_PFHT780_;
    unsigned int counter_uncached_HLT_PFHT780_;
    ...
    unsigned int counter_cached_HLT_PFHT800_PFMET75_PFMHT75_IDTight_;
    unsigned int counter_uncached_HLT_PFHT800_PFMET75_PFMHT75_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFHT800_PFMET85_PFMHT85_IDTight_;
    unsigned int counter_uncached_HLT_PFHT800_PFMET85_PFMHT85_IDTight_;
    bool HLT_PFHT890_;
    TBranch *b_HLT_PFHT890_;
    bool loaded_HLT_PFHT890_;
    unsigned int counter_cached_HLT_PFHT890_;
    unsigned int counter_uncached_HLT_PFHT890_;
    bool HLT_PFJet140_;
    TBranch *b_HLT_PFJet140_;
    bool loaded_HLT_PFJet140_;
    unsigned int counter_cached_HLT_PFJet140_;
    unsigned int counter_uncached_HLT_PFJet140_;
    bool HLT_PFJet15_;
    TBranch *b_HLT_PFJet15_;
    bool loaded_HLT_PFJet15_;
    unsigned int counter_cached_HLT_PFJet15_;
    unsigned int counter_uncached_HLT_PFJet15_;
    bool HLT_PFJet200_;
    TBranch *b_HLT_PFJet200_;
    bool loaded_HLT_PFJet200_;
    unsigned int counter_cached_HLT_PFJet200_;
    unsigned int counter_uncached_HLT_PFJet200_;
    bool HLT_PFJet25_;
    TBranch *b_HLT_PFJet25_;
    bool loaded_HLT_PFJet25_;
    unsigned int counter_cached_HLT_PFJet25_;
    unsigned int counter_uncached_HLT_PFJet25_;
    bool HLT_PFJet260_;
    TBranch *b_HLT_PFJet260_;
    bool loaded_HLT_PFJet260_;
    unsigned int counter_cached_HLT_PFJet260_;
    unsigned int counter_uncached_HLT_PFJet260_;
    bool HLT_PFJet320_;
    TBranch *b_HLT_PFJet320_;
    bool loaded_HLT_PFJet320_;
    unsigned int counter_cached_HLT_PFJet320_;
    unsigned int counter_uncached_HLT_PFJet320_;
    bool HLT_PFJet40_;
    TBranch *b_HLT_PFJet40_;
    bool loaded_HLT_PFJet40_;
    unsigned int counter_cached_HLT_PFJet40_;
    unsigned int counter_uncached_HLT_PFJet40_;
    bool HLT_PFJet400_;
    TBranch *b_HLT_PFJet400_;
    bool loaded_HLT_PFJet400_;
    unsigned int counter_cached_HLT_PFJet400_;
    unsigned int counter_uncached_HLT_PFJet400_;
    bool HLT_PFJet450_;
    TBranch *b_HLT_PFJet450_;
    bool loaded_HLT_PFJet450_;
    unsigned int counter_cached_HLT_PFJet450_;
    unsigned int counter_uncached_HLT_PFJet450_;
    bool HLT_PFJet500_;
    TBranch *b_HLT_PFJet500_;
    bool loaded_HLT_PFJet500_;
    unsigned int counter_cached_HLT_PFJet500_;
    unsigned int counter_uncached_HLT_PFJet500_;
    bool HLT_PFJet550_;
    TBranch *b_HLT_PFJet550_;
    bool loaded_HLT_PFJet550_;
    unsigned int counter_cached_HLT_PFJet550_;
    unsigned int counter_uncached_HLT_PFJet550_;
    bool HLT_PFJet60_;
    TBranch *b_HLT_PFJet60_;
    bool loaded_HLT_PFJet60_;
    unsigned int counter_cached_HLT_PFJet60_;
    unsigned int counter_uncached_HLT_PFJet60_;
    bool HLT_PFJet80_;
    TBranch *b_HLT_PFJet80_;
    bool loaded_HLT_PFJet80_;
    unsigned int counter_cached_HLT_PFJet80_;
    unsigned int counter_uncached_HLT_PFJet80_;
    bool HLT_PFJetFwd140_;
    TBranch *b_HLT_PFJetFwd140_;
    bool loaded_HLT_PFJetFwd140_;
    unsigned int counter_cached_HLT_PFJetFwd140_;
    unsigned int counter_uncached_HLT_PFJetFwd140_;
    bool HLT_PFJetFwd15_;
    TBranch *b_HLT_PFJetFwd15_;
    bool loaded_HLT_PFJetFwd15_;
    unsigned int counter_cached_HLT_PFJetFwd15_;
    unsigned int counter_uncached_HLT_PFJetFwd15_;
    bool HLT_PFJetFwd200_;
    TBranch *b_HLT_PFJetFwd200_;
    bool loaded_HLT_PFJetFwd200_;
    unsigned int counter_cached_HLT_PFJetFwd200_;
    unsigned int counter_uncached_HLT_PFJetFwd200_;
    bool HLT_PFJetFwd25_;
    TBranch *b_HLT_PFJetFwd25_;
    bool loaded_HLT_PFJetFwd25_;
    unsigned int counter_cached_HLT_PFJetFwd25_;
    unsigned int counter_uncached_HLT_PFJetFwd25_;
    bool HLT_PFJetFwd260_;
    TBranch *b_HLT_PFJetFwd260_;
    bool loaded_HLT_PFJetFwd260_;
    unsigned int counter_cached_HLT_PFJetFwd260_;
    unsigned int counter_uncached_HLT_PFJetFwd260_;
    bool HLT_PFJetFwd320_;
    TBranch *b_HLT_PFJetFwd320_;
    bool loaded_HLT_PFJetFwd320_;
    unsigned int counter_cached_HLT_PFJetFwd320_;
    unsigned int counter_uncached_HLT_PFJetFwd320_;
    bool HLT_PFJetFwd40_;
    TBranch *b_HLT_PFJetFwd40_;
    bool loaded_HLT_PFJetFwd40_;
    unsigned int counter_cached_HLT_PFJetFwd40_;
    unsigned int counter_uncached_HLT_PFJetFwd40_;
    bool HLT_PFJetFwd400_;
    TBranch *b_HLT_PFJetFwd400_;
    bool loaded_HLT_PFJetFwd400_;
    unsigned int counter_cached_HLT_PFJetFwd400_;
    unsigned int counter_uncached_HLT_PFJetFwd400_;
    bool HLT_PFJetFwd450_;
    TBranch *b_HLT_PFJetFwd450_;
    bool loaded_HLT_PFJetFwd450_;
    unsigned int counter_cached_HLT_PFJetFwd450_;
    unsigned int counter_uncached_HLT_PFJetFwd450_;
    bool HLT_PFJetFwd500_;
    TBranch *b_HLT_PFJetFwd500_;
    bool loaded_HLT_PFJetFwd500_;
    unsigned int counter_cached_HLT_PFJetFwd500_;
    unsigned int counter_uncached_HLT_PFJetFwd500_;
    bool HLT_PFJetFwd60_;
    TBranch *b_HLT_PFJetFwd60_;
    bool loaded_HLT_PFJetFwd60_;
    unsigned int counter_cached_HLT_PFJetFwd60_;
    unsigned int counter_uncached_HLT_PFJetFwd60_;
    bool HLT_PFJetFwd80_;
    TBranch *b_HLT_PFJetFwd80_;
    bool loaded_HLT_PFJetFwd80_;
    unsigned int counter_cached_HLT_PFJetFwd80_;
    unsigned int counter_uncached_HLT_PFJetFwd80_;
    ...
    unsigned int counter_cached_HLT_PFMET100_PFMHT100_IDTight_CaloBTagDeepCSV_3p1_;
    unsigned int counter_uncached_HLT_PFMET100_PFMHT100_IDTight_CaloBTagDeepCSV_3p1_;
    ...
    unsigned int counter_cached_HLT_PFMET100_PFMHT100_IDTight_PFHT60_;
    unsigned int counter_uncached_HLT_PFMET100_PFMHT100_IDTight_PFHT60_;
    bool HLT_PFMET110_PFMHT110_IDTight_;
    TBranch *b_HLT_PFMET110_PFMHT110_IDTight_;
    bool loaded_HLT_PFMET110_PFMHT110_IDTight_;
    unsigned int counter_cached_HLT_PFMET110_PFMHT110_IDTight_;
    unsigned int counter_uncached_HLT_PFMET110_PFMHT110_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFMET110_PFMHT110_IDTight_CaloBTagDeepCSV_3p1_;
    unsigned int counter_uncached_HLT_PFMET110_PFMHT110_IDTight_CaloBTagDeepCSV_3p1_;
    bool HLT_PFMET120_PFMHT120_IDTight_;
    TBranch *b_HLT_PFMET120_PFMHT120_IDTight_;
    bool loaded_HLT_PFMET120_PFMHT120_IDTight_;
    unsigned int counter_cached_HLT_PFMET120_PFMHT120_IDTight_;
    unsigned int counter_uncached_HLT_PFMET120_PFMHT120_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFMET120_PFMHT120_IDTight_CaloBTagDeepCSV_3p1_;
    unsigned int counter_uncached_HLT_PFMET120_PFMHT120_IDTight_CaloBTagDeepCSV_3p1_;
    ...
    unsigned int counter_cached_HLT_PFMET120_PFMHT120_IDTight_PFHT60_;
    unsigned int counter_uncached_HLT_PFMET120_PFMHT120_IDTight_PFHT60_;
    bool HLT_PFMET130_PFMHT130_IDTight_;
    TBranch *b_HLT_PFMET130_PFMHT130_IDTight_;
    bool loaded_HLT_PFMET130_PFMHT130_IDTight_;
    unsigned int counter_cached_HLT_PFMET130_PFMHT130_IDTight_;
    unsigned int counter_uncached_HLT_PFMET130_PFMHT130_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFMET130_PFMHT130_IDTight_CaloBTagDeepCSV_3p1_;
    unsigned int counter_uncached_HLT_PFMET130_PFMHT130_IDTight_CaloBTagDeepCSV_3p1_;
    bool HLT_PFMET140_PFMHT140_IDTight_;
    TBranch *b_HLT_PFMET140_PFMHT140_IDTight_;
    bool loaded_HLT_PFMET140_PFMHT140_IDTight_;
    unsigned int counter_cached_HLT_PFMET140_PFMHT140_IDTight_;
    unsigned int counter_uncached_HLT_PFMET140_PFMHT140_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFMET140_PFMHT140_IDTight_CaloBTagDeepCSV_3p1_;
    unsigned int counter_uncached_HLT_PFMET140_PFMHT140_IDTight_CaloBTagDeepCSV_3p1_;
    bool HLT_PFMET200_HBHECleaned_;
    TBranch *b_HLT_PFMET200_HBHECleaned_;
    bool loaded_HLT_PFMET200_HBHECleaned_;
    unsigned int counter_cached_HLT_PFMET200_HBHECleaned_;
    unsigned int counter_uncached_HLT_PFMET200_HBHECleaned_;
    ...
    unsigned int counter_cached_HLT_PFMET200_HBHE_BeamHaloCleaned_;
    unsigned int counter_uncached_HLT_PFMET200_HBHE_BeamHaloCleaned_;
    bool HLT_PFMET200_NotCleaned_;
    TBranch *b_HLT_PFMET200_NotCleaned_;
    bool loaded_HLT_PFMET200_NotCleaned_;
    unsigned int counter_cached_HLT_PFMET200_NotCleaned_;
    unsigned int counter_uncached_HLT_PFMET200_NotCleaned_;
    bool HLT_PFMET250_HBHECleaned_;
    TBranch *b_HLT_PFMET250_HBHECleaned_;
    bool loaded_HLT_PFMET250_HBHECleaned_;
    unsigned int counter_cached_HLT_PFMET250_HBHECleaned_;
    unsigned int counter_uncached_HLT_PFMET250_HBHECleaned_;
    bool HLT_PFMET300_HBHECleaned_;
    TBranch *b_HLT_PFMET300_HBHECleaned_;
    bool loaded_HLT_PFMET300_HBHECleaned_;
    unsigned int counter_cached_HLT_PFMET300_HBHECleaned_;
    unsigned int counter_uncached_HLT_PFMET300_HBHECleaned_;
    ...
    unsigned int counter_cached_HLT_PFMETNoMu100_PFMHTNoMu100_IDTight_PFHT60_;
    unsigned int counter_uncached_HLT_PFMETNoMu100_PFMHTNoMu100_IDTight_PFHT60_;
    ...
    unsigned int counter_cached_HLT_PFMETNoMu110_PFMHTNoMu110_IDTight_;
    unsigned int counter_uncached_HLT_PFMETNoMu110_PFMHTNoMu110_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_;
    unsigned int counter_uncached_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_PFHT60_;
    unsigned int counter_uncached_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_PFHT60_;
    ...
    unsigned int counter_cached_HLT_PFMETNoMu130_PFMHTNoMu130_IDTight_;
    unsigned int counter_uncached_HLT_PFMETNoMu130_PFMHTNoMu130_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFMETNoMu140_PFMHTNoMu140_IDTight_;
    unsigned int counter_uncached_HLT_PFMETNoMu140_PFMHTNoMu140_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFMETTypeOne100_PFMHT100_IDTight_PFHT60_;
    unsigned int counter_uncached_HLT_PFMETTypeOne100_PFMHT100_IDTight_PFHT60_;
    ...
    unsigned int counter_cached_HLT_PFMETTypeOne110_PFMHT110_IDTight_;
    unsigned int counter_uncached_HLT_PFMETTypeOne110_PFMHT110_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFMETTypeOne120_PFMHT120_IDTight_;
    unsigned int counter_uncached_HLT_PFMETTypeOne120_PFMHT120_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFMETTypeOne120_PFMHT120_IDTight_PFHT60_;
    unsigned int counter_uncached_HLT_PFMETTypeOne120_PFMHT120_IDTight_PFHT60_;
    ...
    unsigned int counter_cached_HLT_PFMETTypeOne130_PFMHT130_IDTight_;
    unsigned int counter_uncached_HLT_PFMETTypeOne130_PFMHT130_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFMETTypeOne140_PFMHT140_IDTight_;
    unsigned int counter_uncached_HLT_PFMETTypeOne140_PFMHT140_IDTight_;
    ...
    unsigned int counter_cached_HLT_PFMETTypeOne200_HBHE_BeamHaloCleaned_;
    unsigned int counter_uncached_HLT_PFMETTypeOne200_HBHE_BeamHaloCleaned_;
    bool HLT_Photon100EBHE10_;
    TBranch *b_HLT_Photon100EBHE10_;
    bool loaded_HLT_Photon100EBHE10_;
    unsigned int counter_cached_HLT_Photon100EBHE10_;
    unsigned int counter_uncached_HLT_Photon100EBHE10_;
    ...
    unsigned int counter_cached_HLT_Photon100EB_TightID_TightIso_;
    unsigned int counter_uncached_HLT_Photon100EB_TightID_TightIso_;
    bool HLT_Photon100EEHE10_;
    TBranch *b_HLT_Photon100EEHE10_;
    bool loaded_HLT_Photon100EEHE10_;
    unsigned int counter_cached_HLT_Photon100EEHE10_;
    unsigned int counter_uncached_HLT_Photon100EEHE10_;
    ...
    unsigned int counter_cached_HLT_Photon100EE_TightID_TightIso_;
    unsigned int counter_uncached_HLT_Photon100EE_TightID_TightIso_;
    ...
    unsigned int counter_cached_HLT_Photon110EB_TightID_TightIso_;
    unsigned int counter_uncached_HLT_Photon110EB_TightID_TightIso_;
    bool HLT_Photon120_;
    TBranch *b_HLT_Photon120_;
    bool loaded_HLT_Photon120_;
    unsigned int counter_cached_HLT_Photon120_;
    unsigned int counter_uncached_HLT_Photon120_;
    ...
    unsigned int counter_cached_HLT_Photon120EB_TightID_TightIso_;
    unsigned int counter_uncached_HLT_Photon120EB_TightID_TightIso_;
    bool HLT_Photon120_R9Id90_HE10_IsoM_;
    TBranch *b_HLT_Photon120_R9Id90_HE10_IsoM_;
    bool loaded_HLT_Photon120_R9Id90_HE10_IsoM_;
    unsigned int counter_cached_HLT_Photon120_R9Id90_HE10_IsoM_;
    unsigned int counter_uncached_HLT_Photon120_R9Id90_HE10_IsoM_;
    bool HLT_Photon150_;
    TBranch *b_HLT_Photon150_;
    bool loaded_HLT_Photon150_;
    unsigned int counter_cached_HLT_Photon150_;
    unsigned int counter_uncached_HLT_Photon150_;
    bool HLT_Photon165_R9Id90_HE10_IsoM_;
    TBranch *b_HLT_Photon165_R9Id90_HE10_IsoM_;
    bool loaded_HLT_Photon165_R9Id90_HE10_IsoM_;
    unsigned int counter_cached_HLT_Photon165_R9Id90_HE10_IsoM_;
    unsigned int counter_uncached_HLT_Photon165_R9Id90_HE10_IsoM_;
    bool HLT_Photon175_;
    TBranch *b_HLT_Photon175_;
    bool loaded_HLT_Photon175_;
    unsigned int counter_cached_HLT_Photon175_;
    unsigned int counter_uncached_HLT_Photon175_;
    bool HLT_Photon20_;
    TBranch *b_HLT_Photon20_;
    bool loaded_HLT_Photon20_;
    unsigned int counter_cached_HLT_Photon20_;
    unsigned int counter_uncached_HLT_Photon20_;
    bool HLT_Photon200_;
    TBranch *b_HLT_Photon200_;
    bool loaded_HLT_Photon200_;
    unsigned int counter_cached_HLT_Photon200_;
    unsigned int counter_uncached_HLT_Photon200_;
    bool HLT_Photon20_HoverELoose_;
    TBranch *b_HLT_Photon20_HoverELoose_;
    bool loaded_HLT_Photon20_HoverELoose_;
    unsigned int counter_cached_HLT_Photon20_HoverELoose_;
    unsigned int counter_uncached_HLT_Photon20_HoverELoose_;
    bool HLT_Photon300_NoHE_;
    TBranch *b_HLT_Photon300_NoHE_;
    bool loaded_HLT_Photon300_NoHE_;
    unsigned int counter_cached_HLT_Photon300_NoHE_;
    unsigned int counter_uncached_HLT_Photon300_NoHE_;
    bool HLT_Photon30_HoverELoose_;
    TBranch *b_HLT_Photon30_HoverELoose_;
    bool loaded_HLT_Photon30_HoverELoose_;
    unsigned int counter_cached_HLT_Photon30_HoverELoose_;
    unsigned int counter_uncached_HLT_Photon30_HoverELoose_;
    bool HLT_Photon33_;
    TBranch *b_HLT_Photon33_;
    bool loaded_HLT_Photon33_;
    unsigned int counter_cached_HLT_Photon33_;
    unsigned int counter_uncached_HLT_Photon33_;
    bool HLT_Photon35_TwoProngs35_;
    TBranch *b_HLT_Photon35_TwoProngs35_;
    bool loaded_HLT_Photon35_TwoProngs35_;
    unsigned int counter_cached_HLT_Photon35_TwoProngs35_;
    unsigned int counter_uncached_HLT_Photon35_TwoProngs35_;
    bool HLT_Photon50_;
    TBranch *b_HLT_Photon50_;
    bool loaded_HLT_Photon50_;
    unsigned int counter_cached_HLT_Photon50_;
    unsigned int counter_uncached_HLT_Photon50_;
    bool HLT_Photon50_R9Id90_HE10_IsoM_;
    TBranch *b_HLT_Photon50_R9Id90_HE10_IsoM_;
    bool loaded_HLT_Photon50_R9Id90_HE10_IsoM_;
    unsigned int counter_cached_HLT_Photon50_R9Id90_HE10_IsoM_;
    unsigned int counter_uncached_HLT_Photon50_R9Id90_HE10_IsoM_;
    ...
    unsigned int counter_cached_HLT_Photon50_R9Id90_HE10_IsoM_EBOnly_PFJetsMJJ300DEta3_PFMET50_;
    unsigned int counter_uncached_HLT_Photon50_R9Id90_HE10_IsoM_EBOnly_PFJetsMJJ300DEta3_PFMET50_;
    ...
    unsigned int counter_cached_HLT_Photon60_R9Id90_CaloIdL_IsoL_;
    unsigned int counter_uncached_HLT_Photon60_R9Id90_CaloIdL_IsoL_;
    ...
    unsigned int counter_cached_HLT_Photon60_R9Id90_CaloIdL_IsoL_DisplacedIdL_;
    unsigned int counter_uncached_HLT_Photon60_R9Id90_CaloIdL_IsoL_DisplacedIdL_;
    ...
    unsigned int counter_cached_HLT_Photon60_R9Id90_CaloIdL_IsoL_DisplacedIdL_PFHT350MinPFJet15_;
    unsigned int counter_uncached_HLT_Photon60_R9Id90_CaloIdL_IsoL_DisplacedIdL_PFHT350MinPFJet15_;
    bool HLT_Photon75_;
    TBranch *b_HLT_Photon75_;
    bool loaded_HLT_Photon75_;
    unsigned int counter_cached_HLT_Photon75_;
    unsigned int counter_uncached_HLT_Photon75_;
    bool HLT_Photon75_R9Id90_HE10_IsoM_;
    TBranch *b_HLT_Photon75_R9Id90_HE10_IsoM_;
    bool loaded_HLT_Photon75_R9Id90_HE10_IsoM_;
    unsigned int counter_cached_HLT_Photon75_R9Id90_HE10_IsoM_;
    unsigned int counter_uncached_HLT_Photon75_R9Id90_HE10_IsoM_;
    ...
    unsigned int counter_cached_HLT_Photon75_R9Id90_HE10_IsoM_EBOnly_CaloMJJ300_PFJetsMJJ400DEta3_;
    unsigned int counter_uncached_HLT_Photon75_R9Id90_HE10_IsoM_EBOnly_CaloMJJ300_PFJetsMJJ400DEta3_;
    ...
    unsigned int counter_cached_HLT_Photon75_R9Id90_HE10_IsoM_EBOnly_CaloMJJ400_PFJetsMJJ600DEta3_;
    unsigned int counter_uncached_HLT_Photon75_R9Id90_HE10_IsoM_EBOnly_CaloMJJ400_PFJetsMJJ600DEta3_;
    ...
    unsigned int counter_cached_HLT_Photon75_R9Id90_HE10_IsoM_EBOnly_PFJetsMJJ300DEta3_;
    unsigned int counter_uncached_HLT_Photon75_R9Id90_HE10_IsoM_EBOnly_PFJetsMJJ300DEta3_;
    ...
    unsigned int counter_cached_HLT_Photon75_R9Id90_HE10_IsoM_EBOnly_PFJetsMJJ600DEta3_;
    unsigned int counter_uncached_HLT_Photon75_R9Id90_HE10_IsoM_EBOnly_PFJetsMJJ600DEta3_;
    bool HLT_Photon90_;
    TBranch *b_HLT_Photon90_;
    bool loaded_HLT_Photon90_;
    unsigned int counter_cached_HLT_Photon90_;
    unsigned int counter_uncached_HLT_Photon90_;
    bool HLT_Photon90_CaloIdL_PFHT700_;
    TBranch *b_HLT_Photon90_CaloIdL_PFHT700_;
    bool loaded_HLT_Photon90_CaloIdL_PFHT700_;
    unsigned int counter_cached_HLT_Photon90_CaloIdL_PFHT700_;
    unsigned int counter_uncached_HLT_Photon90_CaloIdL_PFHT700_;
    bool HLT_Photon90_R9Id90_HE10_IsoM_;
    TBranch *b_HLT_Photon90_R9Id90_HE10_IsoM_;
    bool loaded_HLT_Photon90_R9Id90_HE10_IsoM_;
    unsigned int counter_cached_HLT_Photon90_R9Id90_HE10_IsoM_;
    unsigned int counter_uncached_HLT_Photon90_R9Id90_HE10_IsoM_;
    bool HLT_Physics_;
    TBranch *b_HLT_Physics_;
    bool loaded_HLT_Physics_;
    unsigned int counter_cached_HLT_Physics_;
    unsigned int counter_uncached_HLT_Physics_;
    bool HLT_Physics_part0_;
    TBranch *b_HLT_Physics_part0_;
    bool loaded_HLT_Physics_part0_;
    unsigned int counter_cached_HLT_Physics_part0_;
    unsigned int counter_uncached_HLT_Physics_part0_;
    bool HLT_Physics_part1_;
    TBranch *b_HLT_Physics_part1_;
    bool loaded_HLT_Physics_part1_;
    unsigned int counter_cached_HLT_Physics_part1_;
    unsigned int counter_uncached_HLT_Physics_part1_;
    bool HLT_Physics_part2_;
    TBranch *b_HLT_Physics_part2_;
    bool loaded_HLT_Physics_part2_;
    unsigned int counter_cached_HLT_Physics_part2_;
    unsigned int counter_uncached_HLT_Physics_part2_;
    bool HLT_Physics_part3_;
    TBranch *b_HLT_Physics_part3_;
    bool loaded_HLT_Physics_part3_;
    unsigned int counter_cached_HLT_Physics_part3_;
    unsigned int counter_uncached_HLT_Physics_part3_;
    bool HLT_Physics_part4_;
    TBranch *b_HLT_Physics_part4_;
    bool loaded_HLT_Physics_part4_;
    unsigned int counter_cached_HLT_Physics_part4_;
    unsigned int counter_uncached_HLT_Physics_part4_;
    bool HLT_Physics_part5_;
    TBranch *b_HLT_Physics_part5_;
    bool loaded_HLT_Physics_part5_;
    unsigned int counter_cached_HLT_Physics_part5_;
    unsigned int counter_uncached_HLT_Physics_part5_;
    bool HLT_Physics_part6_;
    TBranch *b_HLT_Physics_part6_;
    bool loaded_HLT_Physics_part6_;
    unsigned int counter_cached_HLT_Physics_part6_;
    unsigned int counter_uncached_HLT_Physics_part6_;
    bool HLT_Physics_part7_;
    TBranch *b_HLT_Physics_part7_;
    bool loaded_HLT_Physics_part7_;
    unsigned int counter_cached_HLT_Physics_part7_;
    unsigned int counter_uncached_HLT_Physics_part7_;
    bool HLT_QuadPFJet103_88_75_15_;
    TBranch *b_HLT_QuadPFJet103_88_75_15_;
    bool loaded_HLT_QuadPFJet103_88_75_15_;
    unsigned int counter_cached_HLT_QuadPFJet103_88_75_15_;
    unsigned int counter_uncached_HLT_QuadPFJet103_88_75_15_;
    ...
    unsigned int counter_cached_HLT_QuadPFJet103_88_75_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1_;
    unsigned int counter_uncached_HLT_QuadPFJet103_88_75_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1_;
    ...
    unsigned int counter_cached_HLT_QuadPFJet103_88_75_15_PFBTagDeepCSV_1p3_VBF2_;
    unsigned int counter_uncached_HLT_QuadPFJet103_88_75_15_PFBTagDeepCSV_1p3_VBF2_;
    bool HLT_QuadPFJet105_88_76_15_;
    TBranch *b_HLT_QuadPFJet105_88_76_15_;
    bool loaded_HLT_QuadPFJet105_88_76_15_;
    unsigned int counter_cached_HLT_QuadPFJet105_88_76_15_;
    unsigned int counter_uncached_HLT_QuadPFJet105_88_76_15_;
    ...
    unsigned int counter_cached_HLT_QuadPFJet105_88_76_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1_;
    unsigned int counter_uncached_HLT_QuadPFJet105_88_76_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1_;
    ...
    unsigned int counter_cached_HLT_QuadPFJet105_88_76_15_PFBTagDeepCSV_1p3_VBF2_;
    unsigned int counter_uncached_HLT_QuadPFJet105_88_76_15_PFBTagDeepCSV_1p3_VBF2_;
    bool HLT_QuadPFJet111_90_80_15_;
    TBranch *b_HLT_QuadPFJet111_90_80_15_;
    bool loaded_HLT_QuadPFJet111_90_80_15_;
    unsigned int counter_cached_HLT_QuadPFJet111_90_80_15_;
    unsigned int counter_uncached_HLT_QuadPFJet111_90_80_15_;
    ...
    unsigned int counter_cached_HLT_QuadPFJet111_90_80_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1_;
    unsigned int counter_uncached_HLT_QuadPFJet111_90_80_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1_;
    ...
    unsigned int counter_cached_HLT_QuadPFJet111_90_80_15_PFBTagDeepCSV_1p3_VBF2_;
    unsigned int counter_uncached_HLT_QuadPFJet111_90_80_15_PFBTagDeepCSV_1p3_VBF2_;
    bool HLT_QuadPFJet98_83_71_15_;
    TBranch *b_HLT_QuadPFJet98_83_71_15_;
    bool loaded_HLT_QuadPFJet98_83_71_15_;
    unsigned int counter_cached_HLT_QuadPFJet98_83_71_15_;
    unsigned int counter_uncached_HLT_QuadPFJet98_83_71_15_;
    ...
    unsigned int counter_cached_HLT_QuadPFJet98_83_71_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1_;
    unsigned int counter_uncached_HLT_QuadPFJet98_83_71_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1_;
    ...
    unsigned int counter_cached_HLT_QuadPFJet98_83_71_15_PFBTagDeepCSV_1p3_VBF2_;
    unsigned int counter_uncached_HLT_QuadPFJet98_83_71_15_PFBTagDeepCSV_1p3_VBF2_;
    bool HLT_Random_;
    TBranch *b_HLT_Random_;
    bool loaded_HLT_Random_;
    unsigned int counter_cached_HLT_Random_;
    unsigned int counter_uncached_HLT_Random_;
    bool HLT_Rsq0p35_;
    TBranch *b_HLT_Rsq0p35_;
    bool loaded_HLT_Rsq0p35_;
    unsigned int counter_cached_HLT_Rsq0p35_;
    unsigned int counter_uncached_HLT_Rsq0p35_;
    bool HLT_Rsq0p40_;
    TBranch *b_HLT_Rsq0p40_;
    bool loaded_HLT_Rsq0p40_;
    unsigned int counter_cached_HLT_Rsq0p40_;
    unsigned int counter_uncached_HLT_Rsq0p40_;
    bool HLT_RsqMR300_Rsq0p09_MR200_;
    TBranch *b_HLT_RsqMR300_Rsq0p09_MR200_;
    bool loaded_HLT_RsqMR300_Rsq0p09_MR200_;
    unsigned int counter_cached_HLT_RsqMR300_Rsq0p09_MR200_;
    unsigned int counter_uncached_HLT_RsqMR300_Rsq0p09_MR200_;
    ...
    unsigned int counter_cached_HLT_RsqMR300_Rsq0p09_MR200_4jet_;
    unsigned int counter_uncached_HLT_RsqMR300_Rsq0p09_MR200_4jet_;
    bool HLT_RsqMR320_Rsq0p09_MR200_;
    TBranch *b_HLT_RsqMR320_Rsq0p09_MR200_;
    bool loaded_HLT_RsqMR320_Rsq0p09_MR200_;
    unsigned int counter_cached_HLT_RsqMR320_Rsq0p09_MR200_;
    unsigned int counter_uncached_HLT_RsqMR320_Rsq0p09_MR200_;
    ...
    unsigned int counter_cached_HLT_RsqMR320_Rsq0p09_MR200_4jet_;
    unsigned int counter_uncached_HLT_RsqMR320_Rsq0p09_MR200_4jet_;
    ...
    unsigned int counter_cached_HLT_SingleJet30_Mu12_SinglePFJet40_;
    unsigned int counter_uncached_HLT_SingleJet30_Mu12_SinglePFJet40_;
    ...
    unsigned int counter_cached_HLT_SinglePhoton10_Eta3p1ForPPRef_;
    unsigned int counter_uncached_HLT_SinglePhoton10_Eta3p1ForPPRef_;
    ...
    unsigned int counter_cached_HLT_SinglePhoton20_Eta3p1ForPPRef_;
    unsigned int counter_uncached_HLT_SinglePhoton20_Eta3p1ForPPRef_;
    ...
    unsigned int counter_cached_HLT_SinglePhoton30_Eta3p1ForPPRef_;
    unsigned int counter_uncached_HLT_SinglePhoton30_Eta3p1ForPPRef_;
    ...
    unsigned int counter_cached_HLT_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15_;
    unsigned int counter_uncached_HLT_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15_;
    ...
    unsigned int counter_cached_HLT_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15_Charge1_;
    unsigned int counter_uncached_HLT_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15_Charge1_;
    bool HLT_Tau3Mu_Mu7_Mu1_TkMu1_Tau15_;
    TBranch *b_HLT_Tau3Mu_Mu7_Mu1_TkMu1_Tau15_;
    bool loaded_HLT_Tau3Mu_Mu7_Mu1_TkMu1_Tau15_;
    unsigned int counter_cached_HLT_Tau3Mu_Mu7_Mu1_TkMu1_Tau15_;
    unsigned int counter_uncached_HLT_Tau3Mu_Mu7_Mu1_TkMu1_Tau15_;
    ...
    unsigned int counter_cached_HLT_Tau3Mu_Mu7_Mu1_TkMu1_Tau15_Charge1_;
    unsigned int counter_uncached_HLT_Tau3Mu_Mu7_Mu1_TkMu1_Tau15_Charge1_;
    bool HLT_TkMu100_;
    TBranch *b_HLT_TkMu100_;
    bool loaded_HLT_TkMu100_;
    unsigned int counter_cached_HLT_TkMu100_;
    unsigned int counter_uncached_HLT_TkMu100_;
    ...
    unsigned int counter_cached_HLT_Trimuon5_3p5_2_Upsilon_Muon_;
    unsigned int counter_uncached_HLT_Trimuon5_3p5_2_Upsilon_Muon_;
    ...
    unsigned int counter_cached_HLT_TrimuonOpen_5_3p5_2_Upsilon_Muon_;
    unsigned int counter_uncached_HLT_TrimuonOpen_5_3p5_2_Upsilon_Muon_;
    ...
    unsigned int counter_cached_HLT_TripleJet110_35_35_Mjj650_PFMET110_;
    unsigned int counter_uncached_HLT_TripleJet110_35_35_Mjj650_PFMET110_;
    ...
    unsigned int counter_cached_HLT_TripleJet110_35_35_Mjj650_PFMET120_;
    unsigned int counter_uncached_HLT_TripleJet110_35_35_Mjj650_PFMET120_;
    ...
    unsigned int counter_cached_HLT_TripleJet110_35_35_Mjj650_PFMET130_;
    unsigned int counter_uncached_HLT_TripleJet110_35_35_Mjj650_PFMET130_;
    bool HLT_TripleMu_10_5_5_DZ_;
    TBranch *b_HLT_TripleMu_10_5_5_DZ_;
    bool loaded_HLT_TripleMu_10_5_5_DZ_;
    unsigned int counter_cached_HLT_TripleMu_10_5_5_DZ_;
    unsigned int counter_uncached_HLT_TripleMu_10_5_5_DZ_;
    bool HLT_TripleMu_12_10_5_;
    TBranch *b_HLT_TripleMu_12_10_5_;
    bool loaded_HLT_TripleMu_12_10_5_;
    unsigned int counter_cached_HLT_TripleMu_12_10_5_;
    unsigned int counter_uncached_HLT_TripleMu_12_10_5_;
    bool HLT_TripleMu_5_3_3_Mass3p8_DCA_;
    TBranch *b_HLT_TripleMu_5_3_3_Mass3p8_DCA_;
    bool loaded_HLT_TripleMu_5_3_3_Mass3p8_DCA_;
    unsigned int counter_cached_HLT_TripleMu_5_3_3_Mass3p8_DCA_;
    unsigned int counter_uncached_HLT_TripleMu_5_3_3_Mass3p8_DCA_;
    bool HLT_TripleMu_5_3_3_Mass3p8_DZ_;
    TBranch *b_HLT_TripleMu_5_3_3_Mass3p8_DZ_;
    bool loaded_HLT_TripleMu_5_3_3_Mass3p8_DZ_;
    unsigned int counter_cached_HLT_TripleMu_5_3_3_Mass3p8_DZ_;
    unsigned int counter_uncached_HLT_TripleMu_5_3_3_Mass3p8_DZ_;
    ...
    unsigned int counter_cached_HLT_TriplePhoton_20_20_20_CaloIdLV2_;
    unsigned int counter_uncached_HLT_TriplePhoton_20_20_20_CaloIdLV2_;
    ...
    unsigned int counter_cached_HLT_TriplePhoton_20_20_20_CaloIdLV2_R9IdVL_;
    unsigned int counter_uncached_HLT_TriplePhoton_20_20_20_CaloIdLV2_R9IdVL_;
    ...
    unsigned int counter_cached_HLT_TriplePhoton_30_30_10_CaloIdLV2_;
    unsigned int counter_uncached_HLT_TriplePhoton_30_30_10_CaloIdLV2_;
    ...
    unsigned int counter_cached_HLT_TriplePhoton_30_30_10_CaloIdLV2_R9IdVL_;
    unsigned int counter_uncached_HLT_TriplePhoton_30_30_10_CaloIdLV2_R9IdVL_;
    ...
    unsigned int counter_cached_HLT_TriplePhoton_35_35_5_CaloIdLV2_R9IdVL_;
    unsigned int counter_uncached_HLT_TriplePhoton_35_35_5_CaloIdLV2_R9IdVL_;
    ...
    unsigned int counter_cached_HLT_TrkMu12_DoubleTrkMu5NoFiltersNoVtx_;
    unsigned int counter_uncached_HLT_TrkMu12_DoubleTrkMu5NoFiltersNoVtx_;
    bool HLT_TrkMu16NoFiltersNoVtx_;
    TBranch *b_HLT_TrkMu16NoFiltersNoVtx_;
    bool loaded_HLT_TrkMu16NoFiltersNoVtx_;
    unsigned int counter_cached_HLT_TrkMu16NoFiltersNoVtx_;
    unsigned int counter_uncached_HLT_TrkMu16NoFiltersNoVtx_;
    ...
    unsigned int counter_cached_HLT_TrkMu16_DoubleTrkMu6NoFiltersNoVtx_;
    unsigned int counter_uncached_HLT_TrkMu16_DoubleTrkMu6NoFiltersNoVtx_;
    ...
    unsigned int counter_cached_HLT_TrkMu17_DoubleTrkMu8NoFiltersNoVtx_;
    unsigned int counter_uncached_HLT_TrkMu17_DoubleTrkMu8NoFiltersNoVtx_;
    bool HLT_TrkMu6NoFiltersNoVtx_;
    TBranch *b_HLT_TrkMu6NoFiltersNoVtx_;
    bool loaded_HLT_TrkMu6NoFiltersNoVtx_;
    unsigned int counter_cached_HLT_TrkMu6NoFiltersNoVtx_;
    unsigned int counter_uncached_HLT_TrkMu6NoFiltersNoVtx_;
    bool HLT_UncorrectedJetE30_NoBPTX_;
    TBranch *b_HLT_UncorrectedJetE30_NoBPTX_;
    bool loaded_HLT_UncorrectedJetE30_NoBPTX_;
    unsigned int counter_cached_HLT_UncorrectedJetE30_NoBPTX_;
    unsigned int counter_uncached_HLT_UncorrectedJetE30_NoBPTX_;
    ...
    unsigned int counter_cached_HLT_UncorrectedJetE30_NoBPTX3BX_;
    unsigned int counter_uncached_HLT_UncorrectedJetE30_NoBPTX3BX_;
    ...
    unsigned int counter_cached_HLT_UncorrectedJetE60_NoBPTX3BX_;
    unsigned int counter_uncached_HLT_UncorrectedJetE60_NoBPTX3BX_;
    ...
    unsigned int counter_cached_HLT_UncorrectedJetE70_NoBPTX3BX_;
    unsigned int counter_uncached_HLT_UncorrectedJetE70_NoBPTX3BX_;
    ...
    unsigned int counter_cached_HLT_VBF_DoubleLooseChargedIsoPFTauHPS20_Trk1_eta2p1_;
    unsigned int counter_uncached_HLT_VBF_DoubleLooseChargedIsoPFTauHPS20_Trk1_eta2p1_;
    ...
    unsigned int counter_cached_HLT_VBF_DoubleMediumChargedIsoPFTauHPS20_Trk1_eta2p1_;
    unsigned int counter_uncached_HLT_VBF_DoubleMediumChargedIsoPFTauHPS20_Trk1_eta2p1_;
    ...
    unsigned int counter_cached_HLT_VBF_DoubleTightChargedIsoPFTauHPS20_Trk1_eta2p1_;
    unsigned int counter_uncached_HLT_VBF_DoubleTightChargedIsoPFTauHPS20_Trk1_eta2p1_;
    bool HLT_ZeroBias_;
    TBranch *b_HLT_ZeroBias_;
    bool loaded_HLT_ZeroBias_;
    unsigned int counter_cached_HLT_ZeroBias_;
    unsigned int counter_uncached_HLT_ZeroBias_;
    bool HLT_ZeroBias_Alignment_;
    TBranch *b_HLT_ZeroBias_Alignment_;
    bool loaded_HLT_ZeroBias_Alignment_;
    unsigned int counter_cached_HLT_ZeroBias_Alignment_;
    unsigned int counter_uncached_HLT_ZeroBias_Alignment_;
    bool HLT_ZeroBias_Beamspot_;
    TBranch *b_HLT_ZeroBias_Beamspot_;
    bool loaded_HLT_ZeroBias_Beamspot_;
    unsigned int counter_cached_HLT_ZeroBias_Beamspot_;
    unsigned int counter_uncached_HLT_ZeroBias_Beamspot_;
    bool HLT_ZeroBias_FirstBXAfterTrain_;
    TBranch *b_HLT_ZeroBias_FirstBXAfterTrain_;
    bool loaded_HLT_ZeroBias_FirstBXAfterTrain_;
    unsigned int counter_cached_HLT_ZeroBias_FirstBXAfterTrain_;
    unsigned int counter_uncached_HLT_ZeroBias_FirstBXAfterTrain_;
    ...
    unsigned int counter_cached_HLT_ZeroBias_FirstCollisionAfterAbortGap_;
    unsigned int counter_uncached_HLT_ZeroBias_FirstCollisionAfterAbortGap_;
    ...
    unsigned int counter_cached_HLT_ZeroBias_FirstCollisionInTrain_;
    unsigned int counter_uncached_HLT_ZeroBias_FirstCollisionInTrain_;
    bool HLT_ZeroBias_IsolatedBunches_;
    TBranch *b_HLT_ZeroBias_IsolatedBunches_;
    bool loaded_HLT_ZeroBias_IsolatedBunches_;
    unsigned int counter_cached_HLT_ZeroBias_IsolatedBunches_;
    unsigned int counter_uncached_HLT_ZeroBias_IsolatedBunches_;
    ...
    unsigned int counter_cached_HLT_ZeroBias_LastCollisionInTrain_;
    unsigned int counter_uncached_HLT_ZeroBias_LastCollisionInTrain_;
    bool HLT_ZeroBias_part0_;
    TBranch *b_HLT_ZeroBias_part0_;
    bool loaded_HLT_ZeroBias_part0_;
    unsigned int counter_cached_HLT_ZeroBias_part0_;
    unsigned int counter_uncached_HLT_ZeroBias_part0_;
    bool HLT_ZeroBias_part1_;
    TBranch *b_HLT_ZeroBias_part1_;
    bool loaded_HLT_ZeroBias_part1_;
    unsigned int counter_cached_HLT_ZeroBias_part1_;
    unsigned int counter_uncached_HLT_ZeroBias_part1_;
    bool HLT_ZeroBias_part2_;
    TBranch *b_HLT_ZeroBias_part2_;
    bool loaded_HLT_ZeroBias_part2_;
    unsigned int counter_cached_HLT_ZeroBias_part2_;
    unsigned int counter_uncached_HLT_ZeroBias_part2_;
    bool HLT_ZeroBias_part3_;
    TBranch *b_HLT_ZeroBias_part3_;
    bool loaded_HLT_ZeroBias_part3_;
    unsigned int counter_cached_HLT_ZeroBias_part3_;
    unsigned int counter_uncached_HLT_ZeroBias_part3_;
    bool HLT_ZeroBias_part4_;
    TBranch *b_HLT_ZeroBias_part4_;
    bool loaded_HLT_ZeroBias_part4_;
    unsigned int counter_cached_HLT_ZeroBias_part4_;
    unsigned int counter_uncached_HLT_ZeroBias_part4_;
    bool HLT_ZeroBias_part5_;
    TBranch *b_HLT_ZeroBias_part5_;
    bool loaded_HLT_ZeroBias_part5_;
    unsigned int counter_cached_HLT_ZeroBias_part5_;
    unsigned int counter_uncached_HLT_ZeroBias_part5_;
    bool HLT_ZeroBias_part6_;
    TBranch *b_HLT_ZeroBias_part6_;
    bool loaded_HLT_ZeroBias_part6_;
    unsigned int counter_cached_HLT_ZeroBias_part6_;
    unsigned int counter_uncached_HLT_ZeroBias_part6_;
    bool HLT_ZeroBias_part7_;
    TBranch *b_HLT_ZeroBias_part7_;
    bool loaded_HLT_ZeroBias_part7_;
    unsigned int counter_cached_HLT_ZeroBias_part7_;
    unsigned int counter_uncached_HLT_ZeroBias_part7_;
    bool HLTriggerFinalPath_;
    TBranch *b_HLTriggerFinalPath_;
    bool loaded_HLTriggerFinalPath_;
    unsigned int counter_cached_HLTriggerFinalPath_;
    unsigned int counter_uncached_HLTriggerFinalPath_;
    bool HLTriggerFirstPath_;
    TBranch *b_HLTriggerFirstPath_;
    bool loaded_HLTriggerFirstPath_;
    unsigned int counter_cached_HLTriggerFirstPath_;
    unsigned int counter_uncached_HLTriggerFirstPath_;
    float HTXS_Higgs_pt_;
    TBranch *b_HTXS_Higgs_pt_;
    bool loaded_HTXS_Higgs_pt_;
    unsigned int counter_cached_HTXS_Higgs_pt_;
    unsigned int counter_uncached_HTXS_Higgs_pt_;
    float HTXS_Higgs_y_;
    TBranch *b_HTXS_Higgs_y_;
    bool loaded_HTXS_Higgs_y_;
    unsigned int counter_cached_HTXS_Higgs_y_;
    unsigned int counter_uncached_HTXS_Higgs_y_;
    UChar_t HTXS_njets25_;
    TBranch *b_HTXS_njets25_;
    bool loaded_HTXS_njets25_;
    unsigned int counter_cached_HTXS_njets25_;
    unsigned int counter_uncached_HTXS_njets25_;
    UChar_t HTXS_njets30_;
    TBranch *b_HTXS_njets30_;
    bool loaded_HTXS_njets30_;
    unsigned int counter_cached_HTXS_njets30_;
    unsigned int counter_uncached_HTXS_njets30_;
    int HTXS_stage1_1_cat_pTjet25GeV_;
    TBranch *b_HTXS_stage1_1_cat_pTjet25GeV_;
    bool loaded_HTXS_stage1_1_cat_pTjet25GeV_;
    unsigned int counter_cached_HTXS_stage1_1_cat_pTjet25GeV_;
    unsigned int counter_uncached_HTXS_stage1_1_cat_pTjet25GeV_;
    int HTXS_stage1_1_cat_pTjet30GeV_;
    TBranch *b_HTXS_stage1_1_cat_pTjet30GeV_;
    bool loaded_HTXS_stage1_1_cat_pTjet30GeV_;
    unsigned int counter_cached_HTXS_stage1_1_cat_pTjet30GeV_;
    unsigned int counter_uncached_HTXS_stage1_1_cat_pTjet30GeV_;
    ...
    unsigned int counter_cached_HTXS_stage1_1_fine_cat_pTjet25GeV_;
    unsigned int counter_uncached_HTXS_stage1_1_fine_cat_pTjet25GeV_;
    ...
    unsigned int counter_cached_HTXS_stage1_1_fine_cat_pTjet30GeV_;
    unsigned int counter_uncached_HTXS_stage1_1_fine_cat_pTjet30GeV_;
    int HTXS_stage1_2_cat_pTjet25GeV_;
    TBranch *b_HTXS_stage1_2_cat_pTjet25GeV_;
    bool loaded_HTXS_stage1_2_cat_pTjet25GeV_;
    unsigned int counter_cached_HTXS_stage1_2_cat_pTjet25GeV_;
    unsigned int counter_uncached_HTXS_stage1_2_cat_pTjet25GeV_;
    int HTXS_stage1_2_cat_pTjet30GeV_;
    TBranch *b_HTXS_stage1_2_cat_pTjet30GeV_;
    bool loaded_HTXS_stage1_2_cat_pTjet30GeV_;
    unsigned int counter_cached_HTXS_stage1_2_cat_pTjet30GeV_;
    unsigned int counter_uncached_HTXS_stage1_2_cat_pTjet30GeV_;
    ...
    unsigned int counter_cached_HTXS_stage1_2_fine_cat_pTjet25GeV_;
    unsigned int counter_uncached_HTXS_stage1_2_fine_cat_pTjet25GeV_;
    ...
    unsigned int counter_cached_HTXS_stage1_2_fine_cat_pTjet30GeV_;
    unsigned int counter_uncached_HTXS_stage1_2_fine_cat_pTjet30GeV_;
    int HTXS_stage_0_;
    TBranch *b_HTXS_stage_0_;
    bool loaded_HTXS_stage_0_;
    unsigned int counter_cached_HTXS_stage_0_;
    unsigned int counter_uncached_HTXS_stage_0_;
    int HTXS_stage_1_pTjet25_;
    TBranch *b_HTXS_stage_1_pTjet25_;
    bool loaded_HTXS_stage_1_pTjet25_;
    unsigned int counter_cached_HTXS_stage_1_pTjet25_;
    unsigned int counter_uncached_HTXS_stage_1_pTjet25_;
    ...
    unsigned int counter_cached_IsoTrack_dxy_;
    unsigned int counter_uncached_IsoTrack_dxy_;
    float IsoTrack_dz_[NISOTRACK_MAX];
    vector<float> v_IsoTrack_dz_;
    TBranch *b_IsoTrack_dz_;
    bool loaded_IsoTrack_dz_;
    unsigned int counter_cached_IsoTrack_dz_;
    unsigned int counter_uncached_IsoTrack_dz_;
    float IsoTrack_eta_[NISOTRACK_MAX];
    vector<float> v_IsoTrack_eta_;
    TBranch *b_IsoTrack_eta_;
    bool loaded_IsoTrack_eta_;
    unsigned int counter_cached_IsoTrack_eta_;
    unsigned int counter_uncached_IsoTrack_eta_;
    int IsoTrack_fromPV_[NISOTRACK_MAX];
    vector<int> v_IsoTrack_fromPV_;
    TBranch *b_IsoTrack_fromPV_;
    bool loaded_IsoTrack_fromPV_;
    unsigned int counter_cached_IsoTrack_fromPV_;
    unsigned int counter_uncached_IsoTrack_fromPV_;
    ...
    unsigned int counter_cached_IsoTrack_isFromLostTrack_;
    unsigned int counter_uncached_IsoTrack_isFromLostTrack_;
    ...
    unsigned int counter_cached_IsoTrack_isHighPurityTrack_;
    unsigned int counter_uncached_IsoTrack_isHighPurityTrack_;
    ...
    unsigned int counter_cached_IsoTrack_isPFcand_;
    unsigned int counter_uncached_IsoTrack_isPFcand_;
    ...
    unsigned int counter_cached_IsoTrack_miniPFRelIso_all_;
    unsigned int counter_uncached_IsoTrack_miniPFRelIso_all_;
    ...
    unsigned int counter_cached_IsoTrack_miniPFRelIso_chg_;
    unsigned int counter_uncached_IsoTrack_miniPFRelIso_chg_;
    int IsoTrack_pdgId_[NISOTRACK_MAX];
    vector<int> v_IsoTrack_pdgId_;
    TBranch *b_IsoTrack_pdgId_;
    bool loaded_IsoTrack_pdgId_;
    unsigned int counter_cached_IsoTrack_pdgId_;
    unsigned int counter_uncached_IsoTrack_pdgId_;
    ...
    unsigned int counter_cached_IsoTrack_pfRelIso03_all_;
    unsigned int counter_uncached_IsoTrack_pfRelIso03_all_;
    ...
    unsigned int counter_cached_Jet_btagDeepFlavB_;
    unsigned int counter_uncached_Jet_btagDeepFlavB_;
    ...
    unsigned int counter_cached_Jet_mass_;
    unsigned int counter_uncached_Jet_mass_;
    float Jet_muEF_[NJET_MAX];
    vector<float> v_Jet_muEF_;
    TBranch *b_Jet_muEF_;
    bool loaded_Jet_muEF_;
    unsigned int counter_cached_Jet_muEF_;
    unsigned int counter_uncached_Jet_muEF_;
    int Jet_muonIdx1_[NJET_MAX];
    vector<int> v_Jet_muonIdx1_;
    TBranch *b_Jet_muonIdx1_;
    bool loaded_Jet_muonIdx1_;
    unsigned int counter_cached_Jet_muonIdx1_;
    unsigned int counter_uncached_Jet_muonIdx1_;
    int Jet_muonIdx2_[NJET_MAX];
    vector<int> v_Jet_muonIdx2_;
    TBranch *b_Jet_muonIdx2_;
    bool loaded_Jet_muonIdx2_;
    unsigned int counter_cached_Jet_muonIdx2_;
    unsigned int counter_uncached_Jet_muonIdx2_;
    ...
    unsigned int counter_cached_Jet_muonSubtrFactor_;
    unsigned int counter_uncached_Jet_muonSubtrFactor_;
    int Jet_nConstituents_[NJET_MAX];
    vector<int> v_Jet_nConstituents_;
    TBranch *b_Jet_nConstituents_;
    bool loaded_Jet_nConstituents_;
    unsigned int counter_cached_Jet_nConstituents_;
    unsigned int counter_uncached_Jet_nConstituents_;
    int Jet_nElectrons_[NJET_MAX];
    vector<int> v_Jet_nElectrons_;
    TBranch *b_Jet_nElectrons_;
    bool loaded_Jet_nElectrons_;
    unsigned int counter_cached_Jet_nElectrons_;
    unsigned int counter_uncached_Jet_nElectrons_;
    int Jet_nMuons_[NJET_MAX];
    vector<int> v_Jet_nMuons_;
    TBranch *b_Jet_nMuons_;
    bool loaded_Jet_nMuons_;
    unsigned int counter_cached_Jet_nMuons_;
    unsigned int counter_uncached_Jet_nMuons_;
    float Jet_neEmEF_[NJET_MAX];
    vector<float> v_Jet_neEmEF_;
    TBranch *b_Jet_neEmEF_;
    bool loaded_Jet_neEmEF_;
    unsigned int counter_cached_Jet_neEmEF_;
    unsigned int counter_uncached_Jet_neEmEF_;
    float Jet_neHEF_[NJET_MAX];
    vector<float> v_Jet_neHEF_;
    TBranch *b_Jet_neHEF_;
    bool loaded_Jet_neHEF_;
    unsigned int counter_cached_Jet_neHEF_;
    unsigned int counter_uncached_Jet_neHEF_;
    vector<LorentzVector> v_Jet_p4_;
    TBranch *b_Jet_p4_;
    bool loaded_Jet_p4_;
    unsigned int counter_cached_Jet_p4_;
    unsigned int counter_uncached_Jet_p4_;
    int Jet_partonFlavour_[NJET_MAX];
    vector<int> v_Jet_partonFlavour_;
    TBranch *b_Jet_partonFlavour_;
    bool loaded_Jet_partonFlavour_;
    unsigned int counter_cached_Jet_partonFlavour_;
    unsigned int counter_uncached_Jet_partonFlavour_;
    float Jet_phi_[NJET_MAX];
    vector<float> v_Jet_phi_;
    TBranch *b_Jet_phi_;
    bool loaded_Jet_phi_;
    unsigned int counter_cached_Jet_phi_;
    unsigned int counter_uncached_Jet_phi_;
    float Jet_pt_[NJET_MAX];
    vector<float> v_Jet_pt_;
    TBranch *b_Jet_pt_;
    bool loaded_Jet_pt_;
    unsigned int counter_cached_Jet_pt_;
    unsigned int counter_uncached_Jet_pt_;
    int Jet_puId_[NJET_MAX];
    vector<int> v_Jet_puId_;
    TBranch *b_Jet_puId_;
    bool loaded_Jet_puId_;
    unsigned int counter_cached_Jet_puId_;
    unsigned int counter_uncached_Jet_puId_;
    float Jet_puIdDisc_[NJET_MAX];
    vector<float> v_Jet_puIdDisc_;
    TBranch *b_Jet_puIdDisc_;
    bool loaded_Jet_puIdDisc_;
    unsigned int counter_cached_Jet_puIdDisc_;
    unsigned int counter_uncached_Jet_puIdDisc_;
    float Jet_qgl_[NJET_MAX];
    vector<float> v_Jet_qgl_;
    TBranch *b_Jet_qgl_;
    bool loaded_Jet_qgl_;
    unsigned int counter_cached_Jet_qgl_;
    unsigned int counter_uncached_Jet_qgl_;
    float Jet_rawFactor_[NJET_MAX];
    vector<float> v_Jet_rawFactor_;
    TBranch *b_Jet_rawFactor_;
    bool loaded_Jet_rawFactor_;
    unsigned int counter_cached_Jet_rawFactor_;
    unsigned int counter_uncached_Jet_rawFactor_;
    bool L1Reco_step_;
    TBranch *b_L1Reco_step_;
    bool loaded_L1Reco_step_;
    unsigned int counter_cached_L1Reco_step_;
    unsigned int counter_uncached_L1Reco_step_;
    bool L1_AlwaysTrue_;
    TBranch *b_L1_AlwaysTrue_;
    bool loaded_L1_AlwaysTrue_;
    unsigned int counter_cached_L1_AlwaysTrue_;
    unsigned int counter_uncached_L1_AlwaysTrue_;
    bool L1_BPTX_AND_Ref1_VME_;
    TBranch *b_L1_BPTX_AND_Ref1_VME_;
    bool loaded_L1_BPTX_AND_Ref1_VME_;
    unsigned int counter_cached_L1_BPTX_AND_Ref1_VME_;
    unsigned int counter_uncached_L1_BPTX_AND_Ref1_VME_;
    bool L1_BPTX_AND_Ref3_VME_;
    TBranch *b_L1_BPTX_AND_Ref3_VME_;
    bool loaded_L1_BPTX_AND_Ref3_VME_;
    unsigned int counter_cached_L1_BPTX_AND_Ref3_VME_;
    unsigned int counter_uncached_L1_BPTX_AND_Ref3_VME_;
    bool L1_BPTX_AND_Ref4_VME_;
    TBranch *b_L1_BPTX_AND_Ref4_VME_;
    bool loaded_L1_BPTX_AND_Ref4_VME_;
    unsigned int counter_cached_L1_BPTX_AND_Ref4_VME_;
    unsigned int counter_uncached_L1_BPTX_AND_Ref4_VME_;
    bool L1_BPTX_BeamGas_B1_VME_;
    TBranch *b_L1_BPTX_BeamGas_B1_VME_;
    bool loaded_L1_BPTX_BeamGas_B1_VME_;
    unsigned int counter_cached_L1_BPTX_BeamGas_B1_VME_;
    unsigned int counter_uncached_L1_BPTX_BeamGas_B1_VME_;
    bool L1_BPTX_BeamGas_B2_VME_;
    TBranch *b_L1_BPTX_BeamGas_B2_VME_;
    bool loaded_L1_BPTX_BeamGas_B2_VME_;
    unsigned int counter_cached_L1_BPTX_BeamGas_B2_VME_;
    unsigned int counter_uncached_L1_BPTX_BeamGas_B2_VME_;
    bool L1_BPTX_BeamGas_Ref1_VME_;
    TBranch *b_L1_BPTX_BeamGas_Ref1_VME_;
    bool loaded_L1_BPTX_BeamGas_Ref1_VME_;
    unsigned int counter_cached_L1_BPTX_BeamGas_Ref1_VME_;
    unsigned int counter_uncached_L1_BPTX_BeamGas_Ref1_VME_;
    bool L1_BPTX_BeamGas_Ref2_VME_;
    TBranch *b_L1_BPTX_BeamGas_Ref2_VME_;
    bool loaded_L1_BPTX_BeamGas_Ref2_VME_;
    unsigned int counter_cached_L1_BPTX_BeamGas_Ref2_VME_;
    unsigned int counter_uncached_L1_BPTX_BeamGas_Ref2_VME_;
    bool L1_BPTX_NotOR_VME_;
    TBranch *b_L1_BPTX_NotOR_VME_;
    bool loaded_L1_BPTX_NotOR_VME_;
    unsigned int counter_cached_L1_BPTX_NotOR_VME_;
    unsigned int counter_uncached_L1_BPTX_NotOR_VME_;
    bool L1_BPTX_OR_Ref3_VME_;
    TBranch *b_L1_BPTX_OR_Ref3_VME_;
    bool loaded_L1_BPTX_OR_Ref3_VME_;
    unsigned int counter_cached_L1_BPTX_OR_Ref3_VME_;
    unsigned int counter_uncached_L1_BPTX_OR_Ref3_VME_;
    bool L1_BPTX_OR_Ref4_VME_;
    TBranch *b_L1_BPTX_OR_Ref4_VME_;
    bool loaded_L1_BPTX_OR_Ref4_VME_;
    unsigned int counter_cached_L1_BPTX_OR_Ref4_VME_;
    unsigned int counter_uncached_L1_BPTX_OR_Ref4_VME_;
    bool L1_BPTX_RefAND_VME_;
    TBranch *b_L1_BPTX_RefAND_VME_;
    bool loaded_L1_BPTX_RefAND_VME_;
    unsigned int counter_cached_L1_BPTX_RefAND_VME_;
    unsigned int counter_uncached_L1_BPTX_RefAND_VME_;
    bool L1_BptxMinus_;
    TBranch *b_L1_BptxMinus_;
    bool loaded_L1_BptxMinus_;
    unsigned int counter_cached_L1_BptxMinus_;
    unsigned int counter_uncached_L1_BptxMinus_;
    bool L1_BptxOR_;
    TBranch *b_L1_BptxOR_;
    bool loaded_L1_BptxOR_;
    unsigned int counter_cached_L1_BptxOR_;
    unsigned int counter_uncached_L1_BptxOR_;
    bool L1_BptxPlus_;
    TBranch *b_L1_BptxPlus_;
    bool loaded_L1_BptxPlus_;
    unsigned int counter_cached_L1_BptxPlus_;
    unsigned int counter_uncached_L1_BptxPlus_;
    bool L1_BptxXOR_;
    TBranch *b_L1_BptxXOR_;
    bool loaded_L1_BptxXOR_;
    unsigned int counter_cached_L1_BptxXOR_;
    unsigned int counter_uncached_L1_BptxXOR_;
    ...
    unsigned int counter_cached_L1_CDC_SingleMu_3_er1p2_TOP120_DPHI2p618_3p142_;
    unsigned int counter_uncached_L1_CDC_SingleMu_3_er1p2_TOP120_DPHI2p618_3p142_;
    bool L1_DoubleEG8er2p5_HTT260er_;
    TBranch *b_L1_DoubleEG8er2p5_HTT260er_;
    bool loaded_L1_DoubleEG8er2p5_HTT260er_;
    unsigned int counter_cached_L1_DoubleEG8er2p5_HTT260er_;
    unsigned int counter_uncached_L1_DoubleEG8er2p5_HTT260er_;
    bool L1_DoubleEG8er2p5_HTT280er_;
    TBranch *b_L1_DoubleEG8er2p5_HTT280er_;
    bool loaded_L1_DoubleEG8er2p5_HTT280er_;
    unsigned int counter_cached_L1_DoubleEG8er2p5_HTT280er_;
    unsigned int counter_uncached_L1_DoubleEG8er2p5_HTT280er_;
    bool L1_DoubleEG8er2p5_HTT300er_;
    TBranch *b_L1_DoubleEG8er2p5_HTT300er_;
    bool loaded_L1_DoubleEG8er2p5_HTT300er_;
    unsigned int counter_cached_L1_DoubleEG8er2p5_HTT300er_;
    unsigned int counter_uncached_L1_DoubleEG8er2p5_HTT300er_;
    bool L1_DoubleEG8er2p5_HTT320er_;
    TBranch *b_L1_DoubleEG8er2p5_HTT320er_;
    bool loaded_L1_DoubleEG8er2p5_HTT320er_;
    unsigned int counter_cached_L1_DoubleEG8er2p5_HTT320er_;
    unsigned int counter_uncached_L1_DoubleEG8er2p5_HTT320er_;
    bool L1_DoubleEG8er2p5_HTT340er_;
    TBranch *b_L1_DoubleEG8er2p5_HTT340er_;
    bool loaded_L1_DoubleEG8er2p5_HTT340er_;
    unsigned int counter_cached_L1_DoubleEG8er2p5_HTT340er_;
    unsigned int counter_uncached_L1_DoubleEG8er2p5_HTT340er_;
    bool L1_DoubleEG_15_10_er2p5_;
    TBranch *b_L1_DoubleEG_15_10_er2p5_;
    bool loaded_L1_DoubleEG_15_10_er2p5_;
    unsigned int counter_cached_L1_DoubleEG_15_10_er2p5_;
    unsigned int counter_uncached_L1_DoubleEG_15_10_er2p5_;
    bool L1_DoubleEG_20_10_er2p5_;
    TBranch *b_L1_DoubleEG_20_10_er2p5_;
    bool loaded_L1_DoubleEG_20_10_er2p5_;
    unsigned int counter_cached_L1_DoubleEG_20_10_er2p5_;
    unsigned int counter_uncached_L1_DoubleEG_20_10_er2p5_;
    bool L1_DoubleEG_22_10_er2p5_;
    TBranch *b_L1_DoubleEG_22_10_er2p5_;
    bool loaded_L1_DoubleEG_22_10_er2p5_;
    unsigned int counter_cached_L1_DoubleEG_22_10_er2p5_;
    unsigned int counter_uncached_L1_DoubleEG_22_10_er2p5_;
    bool L1_DoubleEG_25_12_er2p5_;
    TBranch *b_L1_DoubleEG_25_12_er2p5_;
    bool loaded_L1_DoubleEG_25_12_er2p5_;
    unsigned int counter_cached_L1_DoubleEG_25_12_er2p5_;
    unsigned int counter_uncached_L1_DoubleEG_25_12_er2p5_;
    bool L1_DoubleEG_25_14_er2p5_;
    TBranch *b_L1_DoubleEG_25_14_er2p5_;
    bool loaded_L1_DoubleEG_25_14_er2p5_;
    unsigned int counter_cached_L1_DoubleEG_25_14_er2p5_;
    unsigned int counter_uncached_L1_DoubleEG_25_14_er2p5_;
    bool L1_DoubleEG_27_14_er2p5_;
    TBranch *b_L1_DoubleEG_27_14_er2p5_;
    bool loaded_L1_DoubleEG_27_14_er2p5_;
    unsigned int counter_cached_L1_DoubleEG_27_14_er2p5_;
    unsigned int counter_uncached_L1_DoubleEG_27_14_er2p5_;
    ...
    unsigned int counter_cached_L1_DoubleEG_LooseIso20_10_er2p5_;
    unsigned int counter_uncached_L1_DoubleEG_LooseIso20_10_er2p5_;
    ...
    unsigned int counter_cached_L1_DoubleEG_LooseIso22_10_er2p5_;
    unsigned int counter_uncached_L1_DoubleEG_LooseIso22_10_er2p5_;
    ...
    unsigned int counter_cached_L1_DoubleEG_LooseIso22_12_er2p5_;
    unsigned int counter_uncached_L1_DoubleEG_LooseIso22_12_er2p5_;
    ...
    unsigned int counter_cached_L1_DoubleEG_LooseIso25_12_er2p5_;
    unsigned int counter_uncached_L1_DoubleEG_LooseIso25_12_er2p5_;
    bool L1_DoubleIsoTau32er2p1_;
    TBranch *b_L1_DoubleIsoTau32er2p1_;
    bool loaded_L1_DoubleIsoTau32er2p1_;
    unsigned int counter_cached_L1_DoubleIsoTau32er2p1_;
    unsigned int counter_uncached_L1_DoubleIsoTau32er2p1_;
    bool L1_DoubleIsoTau34er2p1_;
    TBranch *b_L1_DoubleIsoTau34er2p1_;
    bool loaded_L1_DoubleIsoTau34er2p1_;
    unsigned int counter_cached_L1_DoubleIsoTau34er2p1_;
    unsigned int counter_uncached_L1_DoubleIsoTau34er2p1_;
    bool L1_DoubleIsoTau36er2p1_;
    TBranch *b_L1_DoubleIsoTau36er2p1_;
    bool loaded_L1_DoubleIsoTau36er2p1_;
    unsigned int counter_cached_L1_DoubleIsoTau36er2p1_;
    unsigned int counter_uncached_L1_DoubleIsoTau36er2p1_;
    ...
    unsigned int counter_cached_L1_DoubleJet100er2p3_dEta_Max1p6_;
    unsigned int counter_uncached_L1_DoubleJet100er2p3_dEta_Max1p6_;
    bool L1_DoubleJet100er2p5_;
    TBranch *b_L1_DoubleJet100er2p5_;
    bool loaded_L1_DoubleJet100er2p5_;
    unsigned int counter_cached_L1_DoubleJet100er2p5_;
    unsigned int counter_uncached_L1_DoubleJet100er2p5_;
    ...
    unsigned int counter_cached_L1_DoubleJet112er2p3_dEta_Max1p6_;
    unsigned int counter_uncached_L1_DoubleJet112er2p3_dEta_Max1p6_;
    bool L1_DoubleJet120er2p5_;
    TBranch *b_L1_DoubleJet120er2p5_;
    bool loaded_L1_DoubleJet120er2p5_;
    unsigned int counter_cached_L1_DoubleJet120er2p5_;
    unsigned int counter_uncached_L1_DoubleJet120er2p5_;
    bool L1_DoubleJet150er2p5_;
    TBranch *b_L1_DoubleJet150er2p5_;
    bool loaded_L1_DoubleJet150er2p5_;
    unsigned int counter_cached_L1_DoubleJet150er2p5_;
    unsigned int counter_uncached_L1_DoubleJet150er2p5_;
    ...
    unsigned int counter_cached_L1_DoubleJet30er2p5_Mass_Min150_dEta_Max1p5_;
    unsigned int counter_uncached_L1_DoubleJet30er2p5_Mass_Min150_dEta_Max1p5_;
    ...
    unsigned int counter_cached_L1_DoubleJet30er2p5_Mass_Min200_dEta_Max1p5_;
    unsigned int counter_uncached_L1_DoubleJet30er2p5_Mass_Min200_dEta_Max1p5_;
    ...
    unsigned int counter_cached_L1_DoubleJet30er2p5_Mass_Min250_dEta_Max1p5_;
    unsigned int counter_uncached_L1_DoubleJet30er2p5_Mass_Min250_dEta_Max1p5_;
    ...
    unsigned int counter_cached_L1_DoubleJet30er2p5_Mass_Min300_dEta_Max1p5_;
    unsigned int counter_uncached_L1_DoubleJet30er2p5_Mass_Min300_dEta_Max1p5_;
    ...
    unsigned int counter_cached_L1_DoubleJet30er2p5_Mass_Min330_dEta_Max1p5_;
    unsigned int counter_uncached_L1_DoubleJet30er2p5_Mass_Min330_dEta_Max1p5_;
    ...
    unsigned int counter_cached_L1_DoubleJet30er2p5_Mass_Min360_dEta_Max1p5_;
    unsigned int counter_uncached_L1_DoubleJet30er2p5_Mass_Min360_dEta_Max1p5_;
    ...
    unsigned int counter_cached_L1_DoubleJet35_Mass_Min450_IsoTau45_RmOvlp_;
    unsigned int counter_uncached_L1_DoubleJet35_Mass_Min450_IsoTau45_RmOvlp_;
    bool L1_DoubleJet40er2p5_;
    TBranch *b_L1_DoubleJet40er2p5_;
    bool loaded_L1_DoubleJet40er2p5_;
    unsigned int counter_cached_L1_DoubleJet40er2p5_;
    unsigned int counter_uncached_L1_DoubleJet40er2p5_;
    ...
    unsigned int counter_cached_L1_DoubleJet_100_30_DoubleJet30_Mass_Min620_;
    unsigned int counter_uncached_L1_DoubleJet_100_30_DoubleJet30_Mass_Min620_;
    ...
    unsigned int counter_cached_L1_DoubleJet_110_35_DoubleJet35_Mass_Min620_;
    unsigned int counter_uncached_L1_DoubleJet_110_35_DoubleJet35_Mass_Min620_;
    ...
    unsigned int counter_cached_L1_DoubleJet_115_40_DoubleJet40_Mass_Min620_;
    unsigned int counter_uncached_L1_DoubleJet_115_40_DoubleJet40_Mass_Min620_;
    ...
    unsigned int counter_cached_L1_DoubleJet_115_40_DoubleJet40_Mass_Min620_Jet60TT28_;
    unsigned int counter_uncached_L1_DoubleJet_115_40_DoubleJet40_Mass_Min620_Jet60TT28_;
    ...
    unsigned int counter_cached_L1_DoubleJet_120_45_DoubleJet45_Mass_Min620_;
    unsigned int counter_uncached_L1_DoubleJet_120_45_DoubleJet45_Mass_Min620_;
    ...
    unsigned int counter_cached_L1_DoubleJet_120_45_DoubleJet45_Mass_Min620_Jet60TT28_;
    unsigned int counter_uncached_L1_DoubleJet_120_45_DoubleJet45_Mass_Min620_Jet60TT28_;
    ...
    unsigned int counter_cached_L1_DoubleJet_80_30_Mass_Min420_DoubleMu0_SQ_;
    unsigned int counter_uncached_L1_DoubleJet_80_30_Mass_Min420_DoubleMu0_SQ_;
    ...
    unsigned int counter_cached_L1_DoubleJet_80_30_Mass_Min420_IsoTau40_RmOvlp_;
    unsigned int counter_uncached_L1_DoubleJet_80_30_Mass_Min420_IsoTau40_RmOvlp_;
    ...
    unsigned int counter_cached_L1_DoubleJet_80_30_Mass_Min420_Mu8_;
    unsigned int counter_uncached_L1_DoubleJet_80_30_Mass_Min420_Mu8_;
    ...
    unsigned int counter_cached_L1_DoubleJet_90_30_DoubleJet30_Mass_Min620_;
    unsigned int counter_uncached_L1_DoubleJet_90_30_DoubleJet30_Mass_Min620_;
    bool L1_DoubleLooseIsoEG22er2p1_;
    TBranch *b_L1_DoubleLooseIsoEG22er2p1_;
    bool loaded_L1_DoubleLooseIsoEG22er2p1_;
    unsigned int counter_cached_L1_DoubleLooseIsoEG22er2p1_;
    unsigned int counter_uncached_L1_DoubleLooseIsoEG22er2p1_;
    bool L1_DoubleLooseIsoEG24er2p1_;
    TBranch *b_L1_DoubleLooseIsoEG24er2p1_;
    bool loaded_L1_DoubleLooseIsoEG24er2p1_;
    unsigned int counter_cached_L1_DoubleLooseIsoEG24er2p1_;
    unsigned int counter_uncached_L1_DoubleLooseIsoEG24er2p1_;
    bool L1_DoubleMu0_;
    TBranch *b_L1_DoubleMu0_;
    bool loaded_L1_DoubleMu0_;
    unsigned int counter_cached_L1_DoubleMu0_;
    unsigned int counter_uncached_L1_DoubleMu0_;
    bool L1_DoubleMu0_Mass_Min1_;
    TBranch *b_L1_DoubleMu0_Mass_Min1_;
    bool loaded_L1_DoubleMu0_Mass_Min1_;
    unsigned int counter_cached_L1_DoubleMu0_Mass_Min1_;
    unsigned int counter_uncached_L1_DoubleMu0_Mass_Min1_;
    bool L1_DoubleMu0_OQ_;
    TBranch *b_L1_DoubleMu0_OQ_;
    bool loaded_L1_DoubleMu0_OQ_;
    unsigned int counter_cached_L1_DoubleMu0_OQ_;
    unsigned int counter_uncached_L1_DoubleMu0_OQ_;
    bool L1_DoubleMu0_SQ_;
    TBranch *b_L1_DoubleMu0_SQ_;
    bool loaded_L1_DoubleMu0_SQ_;
    unsigned int counter_cached_L1_DoubleMu0_SQ_;
    unsigned int counter_uncached_L1_DoubleMu0_SQ_;
    bool L1_DoubleMu0_SQ_OS_;
    TBranch *b_L1_DoubleMu0_SQ_OS_;
    bool loaded_L1_DoubleMu0_SQ_OS_;
    unsigned int counter_cached_L1_DoubleMu0_SQ_OS_;
    unsigned int counter_uncached_L1_DoubleMu0_SQ_OS_;
    ...
    unsigned int counter_cached_L1_DoubleMu0_dR_Max1p6_Jet90er2p5_dR_Max0p8_;
    unsigned int counter_uncached_L1_DoubleMu0_dR_Max1p6_Jet90er2p5_dR_Max0p8_;
    ...
    unsigned int counter_cached_L1_DoubleMu0er1p4_SQ_OS_dR_Max1p4_;
    unsigned int counter_uncached_L1_DoubleMu0er1p4_SQ_OS_dR_Max1p4_;
    bool L1_DoubleMu0er1p5_SQ_;
    TBranch *b_L1_DoubleMu0er1p5_SQ_;
    bool loaded_L1_DoubleMu0er1p5_SQ_;
    unsigned int counter_cached_L1_DoubleMu0er1p5_SQ_;
    unsigned int counter_uncached_L1_DoubleMu0er1p5_SQ_;
    bool L1_DoubleMu0er1p5_SQ_OS_;
    TBranch *b_L1_DoubleMu0er1p5_SQ_OS_;
    bool loaded_L1_DoubleMu0er1p5_SQ_OS_;
    unsigned int counter_cached_L1_DoubleMu0er1p5_SQ_OS_;
    unsigned int counter_uncached_L1_DoubleMu0er1p5_SQ_OS_;
    ...
    unsigned int counter_cached_L1_DoubleMu0er1p5_SQ_OS_dR_Max1p4_;
    unsigned int counter_uncached_L1_DoubleMu0er1p5_SQ_OS_dR_Max1p4_;
    bool L1_DoubleMu0er1p5_SQ_dR_Max1p4_;
    TBranch *b_L1_DoubleMu0er1p5_SQ_dR_Max1p4_;
    bool loaded_L1_DoubleMu0er1p5_SQ_dR_Max1p4_;
    unsigned int counter_cached_L1_DoubleMu0er1p5_SQ_dR_Max1p4_;
    unsigned int counter_uncached_L1_DoubleMu0er1p5_SQ_dR_Max1p4_;
    ...
    unsigned int counter_cached_L1_DoubleMu0er2p0_SQ_OS_dR_Max1p4_;
    unsigned int counter_uncached_L1_DoubleMu0er2p0_SQ_OS_dR_Max1p4_;
    bool L1_DoubleMu0er2p0_SQ_dR_Max1p4_;
    TBranch *b_L1_DoubleMu0er2p0_SQ_dR_Max1p4_;
    bool loaded_L1_DoubleMu0er2p0_SQ_dR_Max1p4_;
    unsigned int counter_cached_L1_DoubleMu0er2p0_SQ_dR_Max1p4_;
    unsigned int counter_uncached_L1_DoubleMu0er2p0_SQ_dR_Max1p4_;
    bool L1_DoubleMu10_SQ_;
    TBranch *b_L1_DoubleMu10_SQ_;
    bool loaded_L1_DoubleMu10_SQ_;
    unsigned int counter_cached_L1_DoubleMu10_SQ_;
    unsigned int counter_uncached_L1_DoubleMu10_SQ_;
    bool L1_DoubleMu18er2p1_;
    TBranch *b_L1_DoubleMu18er2p1_;
    bool loaded_L1_DoubleMu18er2p1_;
    unsigned int counter_cached_L1_DoubleMu18er2p1_;
    unsigned int counter_uncached_L1_DoubleMu18er2p1_;
    ...
    unsigned int counter_cached_L1_DoubleMu3_OS_DoubleEG7p5Upsilon_;
    unsigned int counter_uncached_L1_DoubleMu3_OS_DoubleEG7p5Upsilon_;
    ...
    unsigned int counter_cached_L1_DoubleMu3_SQ_ETMHF50_HTT60er_;
    unsigned int counter_uncached_L1_DoubleMu3_SQ_ETMHF50_HTT60er_;
    ...
    unsigned int counter_cached_L1_DoubleMu3_SQ_ETMHF50_Jet60er2p5_;
    unsigned int counter_uncached_L1_DoubleMu3_SQ_ETMHF50_Jet60er2p5_;
    ...
    unsigned int counter_cached_L1_DoubleMu3_SQ_ETMHF50_Jet60er2p5_OR_DoubleJet40er2p5_;
    unsigned int counter_uncached_L1_DoubleMu3_SQ_ETMHF50_Jet60er2p5_OR_DoubleJet40er2p5_;
    ...
    unsigned int counter_cached_L1_DoubleMu3_SQ_ETMHF60_Jet60er2p5_;
    unsigned int counter_uncached_L1_DoubleMu3_SQ_ETMHF60_Jet60er2p5_;
    bool L1_DoubleMu3_SQ_HTT220er_;
    TBranch *b_L1_DoubleMu3_SQ_HTT220er_;
    bool loaded_L1_DoubleMu3_SQ_HTT220er_;
    unsigned int counter_cached_L1_DoubleMu3_SQ_HTT220er_;
    unsigned int counter_uncached_L1_DoubleMu3_SQ_HTT220er_;
    bool L1_DoubleMu3_SQ_HTT240er_;
    TBranch *b_L1_DoubleMu3_SQ_HTT240er_;
    bool loaded_L1_DoubleMu3_SQ_HTT240er_;
    unsigned int counter_cached_L1_DoubleMu3_SQ_HTT240er_;
    unsigned int counter_uncached_L1_DoubleMu3_SQ_HTT240er_;
    bool L1_DoubleMu3_SQ_HTT260er_;
    TBranch *b_L1_DoubleMu3_SQ_HTT260er_;
    bool loaded_L1_DoubleMu3_SQ_HTT260er_;
    unsigned int counter_cached_L1_DoubleMu3_SQ_HTT260er_;
    unsigned int counter_uncached_L1_DoubleMu3_SQ_HTT260er_;
    ...
    unsigned int counter_cached_L1_DoubleMu3_dR_Max1p6_Jet90er2p5_dR_Max0p8_;
    unsigned int counter_uncached_L1_DoubleMu3_dR_Max1p6_Jet90er2p5_dR_Max0p8_;
    bool L1_DoubleMu4_SQ_EG9er2p5_;
    TBranch *b_L1_DoubleMu4_SQ_EG9er2p5_;
    bool loaded_L1_DoubleMu4_SQ_EG9er2p5_;
    unsigned int counter_cached_L1_DoubleMu4_SQ_EG9er2p5_;
    unsigned int counter_uncached_L1_DoubleMu4_SQ_EG9er2p5_;
    bool L1_DoubleMu4_SQ_OS_;
    TBranch *b_L1_DoubleMu4_SQ_OS_;
    bool loaded_L1_DoubleMu4_SQ_OS_;
    unsigned int counter_cached_L1_DoubleMu4_SQ_OS_;
    unsigned int counter_uncached_L1_DoubleMu4_SQ_OS_;
    bool L1_DoubleMu4_SQ_OS_dR_Max1p2_;
    TBranch *b_L1_DoubleMu4_SQ_OS_dR_Max1p2_;
    bool loaded_L1_DoubleMu4_SQ_OS_dR_Max1p2_;
    unsigned int counter_cached_L1_DoubleMu4_SQ_OS_dR_Max1p2_;
    unsigned int counter_uncached_L1_DoubleMu4_SQ_OS_dR_Max1p2_;
    bool L1_DoubleMu4p5_SQ_OS_;
    TBranch *b_L1_DoubleMu4p5_SQ_OS_;
    bool loaded_L1_DoubleMu4p5_SQ_OS_;
    unsigned int counter_cached_L1_DoubleMu4p5_SQ_OS_;
    unsigned int counter_uncached_L1_DoubleMu4p5_SQ_OS_;
    bool L1_DoubleMu4p5_SQ_OS_dR_Max1p2_;
    TBranch *b_L1_DoubleMu4p5_SQ_OS_dR_Max1p2_;
    bool loaded_L1_DoubleMu4p5_SQ_OS_dR_Max1p2_;
    unsigned int counter_cached_L1_DoubleMu4p5_SQ_OS_dR_Max1p2_;
    unsigned int counter_uncached_L1_DoubleMu4p5_SQ_OS_dR_Max1p2_;
    bool L1_DoubleMu4p5er2p0_SQ_OS_;
    TBranch *b_L1_DoubleMu4p5er2p0_SQ_OS_;
    bool loaded_L1_DoubleMu4p5er2p0_SQ_OS_;
    unsigned int counter_cached_L1_DoubleMu4p5er2p0_SQ_OS_;
    unsigned int counter_uncached_L1_DoubleMu4p5er2p0_SQ_OS_;
    ...
    unsigned int counter_cached_L1_DoubleMu4p5er2p0_SQ_OS_Mass7to18_;
    unsigned int counter_uncached_L1_DoubleMu4p5er2p0_SQ_OS_Mass7to18_;
    ...
    unsigned int counter_cached_L1_DoubleMu5Upsilon_OS_DoubleEG3_;
    unsigned int counter_uncached_L1_DoubleMu5Upsilon_OS_DoubleEG3_;
    bool L1_DoubleMu5_SQ_EG9er2p5_;
    TBranch *b_L1_DoubleMu5_SQ_EG9er2p5_;
    bool loaded_L1_DoubleMu5_SQ_EG9er2p5_;
    unsigned int counter_cached_L1_DoubleMu5_SQ_EG9er2p5_;
    unsigned int counter_uncached_L1_DoubleMu5_SQ_EG9er2p5_;
    bool L1_DoubleMu9_SQ_;
    TBranch *b_L1_DoubleMu9_SQ_;
    bool loaded_L1_DoubleMu9_SQ_;
    unsigned int counter_cached_L1_DoubleMu9_SQ_;
    unsigned int counter_uncached_L1_DoubleMu9_SQ_;
    bool L1_DoubleMu_12_5_;
    TBranch *b_L1_DoubleMu_12_5_;
    bool loaded_L1_DoubleMu_12_5_;
    unsigned int counter_cached_L1_DoubleMu_12_5_;
    unsigned int counter_uncached_L1_DoubleMu_12_5_;
    bool L1_DoubleMu_15_5_SQ_;
    TBranch *b_L1_DoubleMu_15_5_SQ_;
    bool loaded_L1_DoubleMu_15_5_SQ_;
    unsigned int counter_cached_L1_DoubleMu_15_5_SQ_;
    unsigned int counter_uncached_L1_DoubleMu_15_5_SQ_;
    bool L1_DoubleMu_15_7_;
    TBranch *b_L1_DoubleMu_15_7_;
    bool loaded_L1_DoubleMu_15_7_;
    unsigned int counter_cached_L1_DoubleMu_15_7_;
    unsigned int counter_uncached_L1_DoubleMu_15_7_;
    bool L1_DoubleMu_15_7_Mass_Min1_;
    TBranch *b_L1_DoubleMu_15_7_Mass_Min1_;
    bool loaded_L1_DoubleMu_15_7_Mass_Min1_;
    unsigned int counter_cached_L1_DoubleMu_15_7_Mass_Min1_;
    unsigned int counter_uncached_L1_DoubleMu_15_7_Mass_Min1_;
    bool L1_DoubleMu_15_7_SQ_;
    TBranch *b_L1_DoubleMu_15_7_SQ_;
    bool loaded_L1_DoubleMu_15_7_SQ_;
    unsigned int counter_cached_L1_DoubleMu_15_7_SQ_;
    unsigned int counter_uncached_L1_DoubleMu_15_7_SQ_;
    bool L1_DoubleTau70er2p1_;
    TBranch *b_L1_DoubleTau70er2p1_;
    bool loaded_L1_DoubleTau70er2p1_;
    unsigned int counter_cached_L1_DoubleTau70er2p1_;
    unsigned int counter_uncached_L1_DoubleTau70er2p1_;
    bool L1_ETM120_;
    TBranch *b_L1_ETM120_;
    bool loaded_L1_ETM120_;
    unsigned int counter_cached_L1_ETM120_;
    unsigned int counter_uncached_L1_ETM120_;
    bool L1_ETM150_;
    TBranch *b_L1_ETM150_;
    bool loaded_L1_ETM150_;
    unsigned int counter_cached_L1_ETM150_;
    unsigned int counter_uncached_L1_ETM150_;
    bool L1_ETMHF100_;
    TBranch *b_L1_ETMHF100_;
    bool loaded_L1_ETMHF100_;
    unsigned int counter_cached_L1_ETMHF100_;
    unsigned int counter_uncached_L1_ETMHF100_;
    bool L1_ETMHF100_HTT60er_;
    TBranch *b_L1_ETMHF100_HTT60er_;
    bool loaded_L1_ETMHF100_HTT60er_;
    unsigned int counter_cached_L1_ETMHF100_HTT60er_;
    unsigned int counter_uncached_L1_ETMHF100_HTT60er_;
    bool L1_ETMHF110_;
    TBranch *b_L1_ETMHF110_;
    bool loaded_L1_ETMHF110_;
    unsigned int counter_cached_L1_ETMHF110_;
    unsigned int counter_uncached_L1_ETMHF110_;
    bool L1_ETMHF110_HTT60er_;
    TBranch *b_L1_ETMHF110_HTT60er_;
    bool loaded_L1_ETMHF110_HTT60er_;
    unsigned int counter_cached_L1_ETMHF110_HTT60er_;
    unsigned int counter_uncached_L1_ETMHF110_HTT60er_;
    ...
    unsigned int counter_cached_L1_ETMHF110_HTT60er_NotSecondBunchInTrain_;
    unsigned int counter_uncached_L1_ETMHF110_HTT60er_NotSecondBunchInTrain_;
    bool L1_ETMHF120_;
    TBranch *b_L1_ETMHF120_;
    bool loaded_L1_ETMHF120_;
    unsigned int counter_cached_L1_ETMHF120_;
    unsigned int counter_uncached_L1_ETMHF120_;
    bool L1_ETMHF120_HTT60er_;
    TBranch *b_L1_ETMHF120_HTT60er_;
    bool loaded_L1_ETMHF120_HTT60er_;
    unsigned int counter_cached_L1_ETMHF120_HTT60er_;
    unsigned int counter_uncached_L1_ETMHF120_HTT60er_;
    ...
    unsigned int counter_cached_L1_ETMHF120_NotSecondBunchInTrain_;
    unsigned int counter_uncached_L1_ETMHF120_NotSecondBunchInTrain_;
    bool L1_ETMHF130_;
    TBranch *b_L1_ETMHF130_;
    bool loaded_L1_ETMHF130_;
    unsigned int counter_cached_L1_ETMHF130_;
    unsigned int counter_uncached_L1_ETMHF130_;
    bool L1_ETMHF130_HTT60er_;
    TBranch *b_L1_ETMHF130_HTT60er_;
    bool loaded_L1_ETMHF130_HTT60er_;
    unsigned int counter_cached_L1_ETMHF130_HTT60er_;
    unsigned int counter_uncached_L1_ETMHF130_HTT60er_;
    bool L1_ETMHF140_;
    TBranch *b_L1_ETMHF140_;
    bool loaded_L1_ETMHF140_;
    unsigned int counter_cached_L1_ETMHF140_;
    unsigned int counter_uncached_L1_ETMHF140_;
    bool L1_ETMHF150_;
    TBranch *b_L1_ETMHF150_;
    bool loaded_L1_ETMHF150_;
    unsigned int counter_cached_L1_ETMHF150_;
    unsigned int counter_uncached_L1_ETMHF150_;
    bool L1_ETMHF90_HTT60er_;
    TBranch *b_L1_ETMHF90_HTT60er_;
    bool loaded_L1_ETMHF90_HTT60er_;
    unsigned int counter_cached_L1_ETMHF90_HTT60er_;
    unsigned int counter_uncached_L1_ETMHF90_HTT60er_;
    bool L1_ETT1200_;
    TBranch *b_L1_ETT1200_;
    bool loaded_L1_ETT1200_;
    unsigned int counter_cached_L1_ETT1200_;
    unsigned int counter_uncached_L1_ETT1200_;
    bool L1_ETT1600_;
    TBranch *b_L1_ETT1600_;
    bool loaded_L1_ETT1600_;
    unsigned int counter_cached_L1_ETT1600_;
    unsigned int counter_uncached_L1_ETT1600_;
    bool L1_ETT2000_;
    TBranch *b_L1_ETT2000_;
    bool loaded_L1_ETT2000_;
    unsigned int counter_cached_L1_ETT2000_;
    unsigned int counter_uncached_L1_ETT2000_;
    bool L1_FirstBunchAfterTrain_;
    TBranch *b_L1_FirstBunchAfterTrain_;
    bool loaded_L1_FirstBunchAfterTrain_;
    unsigned int counter_cached_L1_FirstBunchAfterTrain_;
    unsigned int counter_uncached_L1_FirstBunchAfterTrain_;
    bool L1_FirstBunchBeforeTrain_;
    TBranch *b_L1_FirstBunchBeforeTrain_;
    bool loaded_L1_FirstBunchBeforeTrain_;
    unsigned int counter_cached_L1_FirstBunchBeforeTrain_;
    unsigned int counter_uncached_L1_FirstBunchBeforeTrain_;
    bool L1_FirstBunchInTrain_;
    TBranch *b_L1_FirstBunchInTrain_;
    bool loaded_L1_FirstBunchInTrain_;
    unsigned int counter_cached_L1_FirstBunchInTrain_;
    unsigned int counter_uncached_L1_FirstBunchInTrain_;
    bool L1_FirstCollisionInOrbit_;
    TBranch *b_L1_FirstCollisionInOrbit_;
    bool loaded_L1_FirstCollisionInOrbit_;
    unsigned int counter_cached_L1_FirstCollisionInOrbit_;
    unsigned int counter_uncached_L1_FirstCollisionInOrbit_;
    bool L1_FirstCollisionInTrain_;
    TBranch *b_L1_FirstCollisionInTrain_;
    bool loaded_L1_FirstCollisionInTrain_;
    unsigned int counter_cached_L1_FirstCollisionInTrain_;
    unsigned int counter_uncached_L1_FirstCollisionInTrain_;
    bool L1_HCAL_LaserMon_Trig_;
    TBranch *b_L1_HCAL_LaserMon_Trig_;
    bool loaded_L1_HCAL_LaserMon_Trig_;
    unsigned int counter_cached_L1_HCAL_LaserMon_Trig_;
    unsigned int counter_uncached_L1_HCAL_LaserMon_Trig_;
    bool L1_HCAL_LaserMon_Veto_;
    TBranch *b_L1_HCAL_LaserMon_Veto_;
    bool loaded_L1_HCAL_LaserMon_Veto_;
    unsigned int counter_cached_L1_HCAL_LaserMon_Veto_;
    unsigned int counter_uncached_L1_HCAL_LaserMon_Veto_;
    bool L1_HTT120er_;
    TBranch *b_L1_HTT120er_;
    bool loaded_L1_HTT120er_;
    unsigned int counter_cached_L1_HTT120er_;
    unsigned int counter_uncached_L1_HTT120er_;
    bool L1_HTT160er_;
    TBranch *b_L1_HTT160er_;
    bool loaded_L1_HTT160er_;
    unsigned int counter_cached_L1_HTT160er_;
    unsigned int counter_uncached_L1_HTT160er_;
    bool L1_HTT200er_;
    TBranch *b_L1_HTT200er_;
    bool loaded_L1_HTT200er_;
    unsigned int counter_cached_L1_HTT200er_;
    unsigned int counter_uncached_L1_HTT200er_;
    bool L1_HTT255er_;
    TBranch *b_L1_HTT255er_;
    bool loaded_L1_HTT255er_;
    unsigned int counter_cached_L1_HTT255er_;
    unsigned int counter_uncached_L1_HTT255er_;
    bool L1_HTT280er_;
    TBranch *b_L1_HTT280er_;
    bool loaded_L1_HTT280er_;
    unsigned int counter_cached_L1_HTT280er_;
    unsigned int counter_uncached_L1_HTT280er_;
    ...
    unsigned int counter_cached_L1_HTT280er_QuadJet_70_55_40_35_er2p4_;
    unsigned int counter_uncached_L1_HTT280er_QuadJet_70_55_40_35_er2p4_;
    bool L1_HTT320er_;
    TBranch *b_L1_HTT320er_;
    bool loaded_L1_HTT320er_;
    unsigned int counter_cached_L1_HTT320er_;
    unsigned int counter_uncached_L1_HTT320er_;
    ...
    unsigned int counter_cached_L1_HTT320er_QuadJet_70_55_40_40_er2p4_;
    unsigned int counter_uncached_L1_HTT320er_QuadJet_70_55_40_40_er2p4_;
    ...
    unsigned int counter_cached_L1_HTT320er_QuadJet_80_60_er2p1_45_40_er2p3_;
    unsigned int counter_uncached_L1_HTT320er_QuadJet_80_60_er2p1_45_40_er2p3_;
    ...
    unsigned int counter_cached_L1_HTT320er_QuadJet_80_60_er2p1_50_45_er2p3_;
    unsigned int counter_uncached_L1_HTT320er_QuadJet_80_60_er2p1_50_45_er2p3_;
    bool L1_HTT360er_;
    TBranch *b_L1_HTT360er_;
    bool loaded_L1_HTT360er_;
    unsigned int counter_cached_L1_HTT360er_;
    unsigned int counter_uncached_L1_HTT360er_;
    bool L1_HTT400er_;
    TBranch *b_L1_HTT400er_;
    bool loaded_L1_HTT400er_;
    unsigned int counter_cached_L1_HTT400er_;
    unsigned int counter_uncached_L1_HTT400er_;
    bool L1_HTT450er_;
    TBranch *b_L1_HTT450er_;
    bool loaded_L1_HTT450er_;
    unsigned int counter_cached_L1_HTT450er_;
    unsigned int counter_uncached_L1_HTT450er_;
    bool L1_IsoEG32er2p5_Mt40_;
    TBranch *b_L1_IsoEG32er2p5_Mt40_;
    bool loaded_L1_IsoEG32er2p5_Mt40_;
    unsigned int counter_cached_L1_IsoEG32er2p5_Mt40_;
    unsigned int counter_uncached_L1_IsoEG32er2p5_Mt40_;
    bool L1_IsoEG32er2p5_Mt44_;
    TBranch *b_L1_IsoEG32er2p5_Mt44_;
    bool loaded_L1_IsoEG32er2p5_Mt44_;
    unsigned int counter_cached_L1_IsoEG32er2p5_Mt44_;
    unsigned int counter_uncached_L1_IsoEG32er2p5_Mt44_;
    bool L1_IsoEG32er2p5_Mt48_;
    TBranch *b_L1_IsoEG32er2p5_Mt48_;
    bool loaded_L1_IsoEG32er2p5_Mt48_;
    unsigned int counter_cached_L1_IsoEG32er2p5_Mt48_;
    unsigned int counter_uncached_L1_IsoEG32er2p5_Mt48_;
    bool L1_IsoTau40er2p1_ETMHF100_;
    TBranch *b_L1_IsoTau40er2p1_ETMHF100_;
    bool loaded_L1_IsoTau40er2p1_ETMHF100_;
    unsigned int counter_cached_L1_IsoTau40er2p1_ETMHF100_;
    unsigned int counter_uncached_L1_IsoTau40er2p1_ETMHF100_;
    bool L1_IsoTau40er2p1_ETMHF110_;
    TBranch *b_L1_IsoTau40er2p1_ETMHF110_;
    bool loaded_L1_IsoTau40er2p1_ETMHF110_;
    unsigned int counter_cached_L1_IsoTau40er2p1_ETMHF110_;
    unsigned int counter_uncached_L1_IsoTau40er2p1_ETMHF110_;
    bool L1_IsoTau40er2p1_ETMHF120_;
    TBranch *b_L1_IsoTau40er2p1_ETMHF120_;
    bool loaded_L1_IsoTau40er2p1_ETMHF120_;
    unsigned int counter_cached_L1_IsoTau40er2p1_ETMHF120_;
    unsigned int counter_uncached_L1_IsoTau40er2p1_ETMHF120_;
    bool L1_IsoTau40er2p1_ETMHF90_;
    TBranch *b_L1_IsoTau40er2p1_ETMHF90_;
    bool loaded_L1_IsoTau40er2p1_ETMHF90_;
    unsigned int counter_cached_L1_IsoTau40er2p1_ETMHF90_;
    unsigned int counter_uncached_L1_IsoTau40er2p1_ETMHF90_;
    bool L1_IsolatedBunch_;
    TBranch *b_L1_IsolatedBunch_;
    bool loaded_L1_IsolatedBunch_;
    unsigned int counter_cached_L1_IsolatedBunch_;
    unsigned int counter_uncached_L1_IsolatedBunch_;
    bool L1_LastBunchInTrain_;
    TBranch *b_L1_LastBunchInTrain_;
    bool loaded_L1_LastBunchInTrain_;
    unsigned int counter_cached_L1_LastBunchInTrain_;
    unsigned int counter_uncached_L1_LastBunchInTrain_;
    bool L1_LastCollisionInTrain_;
    TBranch *b_L1_LastCollisionInTrain_;
    bool loaded_L1_LastCollisionInTrain_;
    unsigned int counter_cached_L1_LastCollisionInTrain_;
    unsigned int counter_uncached_L1_LastCollisionInTrain_;
    ...
    unsigned int counter_cached_L1_LooseIsoEG22er2p1_IsoTau26er2p1_dR_Min0p3_;
    unsigned int counter_uncached_L1_LooseIsoEG22er2p1_IsoTau26er2p1_dR_Min0p3_;
    ...
    unsigned int counter_cached_L1_LooseIsoEG22er2p1_Tau70er2p1_dR_Min0p3_;
    unsigned int counter_uncached_L1_LooseIsoEG22er2p1_Tau70er2p1_dR_Min0p3_;
    bool L1_LooseIsoEG24er2p1_HTT100er_;
    TBranch *b_L1_LooseIsoEG24er2p1_HTT100er_;
    bool loaded_L1_LooseIsoEG24er2p1_HTT100er_;
    unsigned int counter_cached_L1_LooseIsoEG24er2p1_HTT100er_;
    unsigned int counter_uncached_L1_LooseIsoEG24er2p1_HTT100er_;
    ...
    unsigned int counter_cached_L1_LooseIsoEG24er2p1_IsoTau27er2p1_dR_Min0p3_;
    unsigned int counter_uncached_L1_LooseIsoEG24er2p1_IsoTau27er2p1_dR_Min0p3_;
    bool L1_LooseIsoEG26er2p1_HTT100er_;
    TBranch *b_L1_LooseIsoEG26er2p1_HTT100er_;
    bool loaded_L1_LooseIsoEG26er2p1_HTT100er_;
    unsigned int counter_cached_L1_LooseIsoEG26er2p1_HTT100er_;
    unsigned int counter_uncached_L1_LooseIsoEG26er2p1_HTT100er_;
    ...
    unsigned int counter_cached_L1_LooseIsoEG26er2p1_Jet34er2p5_dR_Min0p3_;
    unsigned int counter_uncached_L1_LooseIsoEG26er2p1_Jet34er2p5_dR_Min0p3_;
    bool L1_LooseIsoEG28er2p1_HTT100er_;
    TBranch *b_L1_LooseIsoEG28er2p1_HTT100er_;
    bool loaded_L1_LooseIsoEG28er2p1_HTT100er_;
    unsigned int counter_cached_L1_LooseIsoEG28er2p1_HTT100er_;
    unsigned int counter_uncached_L1_LooseIsoEG28er2p1_HTT100er_;
    ...
    unsigned int counter_cached_L1_LooseIsoEG28er2p1_Jet34er2p5_dR_Min0p3_;
    unsigned int counter_uncached_L1_LooseIsoEG28er2p1_Jet34er2p5_dR_Min0p3_;
    bool L1_LooseIsoEG30er2p1_HTT100er_;
    TBranch *b_L1_LooseIsoEG30er2p1_HTT100er_;
    bool loaded_L1_LooseIsoEG30er2p1_HTT100er_;
    unsigned int counter_cached_L1_LooseIsoEG30er2p1_HTT100er_;
    unsigned int counter_uncached_L1_LooseIsoEG30er2p1_HTT100er_;
    ...
    unsigned int counter_cached_L1_LooseIsoEG30er2p1_Jet34er2p5_dR_Min0p3_;
    unsigned int counter_uncached_L1_LooseIsoEG30er2p1_Jet34er2p5_dR_Min0p3_;
    bool L1_MinimumBiasHF0_AND_BptxAND_;
    TBranch *b_L1_MinimumBiasHF0_AND_BptxAND_;
    bool loaded_L1_MinimumBiasHF0_AND_BptxAND_;
    unsigned int counter_cached_L1_MinimumBiasHF0_AND_BptxAND_;
    unsigned int counter_uncached_L1_MinimumBiasHF0_AND_BptxAND_;
    ...
    unsigned int counter_cached_L1_Mu10er2p3_Jet32er2p3_dR_Max0p4_DoubleJet32er2p3_dEta_Max1p6_;
    unsigned int counter_uncached_L1_Mu10er2p3_Jet32er2p3_dR_Max0p4_DoubleJet32er2p3_dEta_Max1p6_;
    ...
    unsigned int counter_cached_L1_Mu12er2p3_Jet40er2p1_dR_Max0p4_DoubleJet40er2p1_dEta_Max1p6_;
    unsigned int counter_uncached_L1_Mu12er2p3_Jet40er2p1_dR_Max0p4_DoubleJet40er2p1_dEta_Max1p6_;
    ...
    unsigned int counter_cached_L1_Mu12er2p3_Jet40er2p3_dR_Max0p4_DoubleJet40er2p3_dEta_Max1p6_;
    unsigned int counter_uncached_L1_Mu12er2p3_Jet40er2p3_dR_Max0p4_DoubleJet40er2p3_dEta_Max1p6_;
    bool L1_Mu18er2p1_Tau24er2p1_;
    TBranch *b_L1_Mu18er2p1_Tau24er2p1_;
    bool loaded_L1_Mu18er2p1_Tau24er2p1_;
    unsigned int counter_cached_L1_Mu18er2p1_Tau24er2p1_;
    unsigned int counter_uncached_L1_Mu18er2p1_Tau24er2p1_;
    bool L1_Mu18er2p1_Tau26er2p1_;
    TBranch *b_L1_Mu18er2p1_Tau26er2p1_;
    bool loaded_L1_Mu18er2p1_Tau26er2p1_;
    unsigned int counter_cached_L1_Mu18er2p1_Tau26er2p1_;
    unsigned int counter_uncached_L1_Mu18er2p1_Tau26er2p1_;
    bool L1_Mu20_EG10er2p5_;
    TBranch *b_L1_Mu20_EG10er2p5_;
    bool loaded_L1_Mu20_EG10er2p5_;
    unsigned int counter_cached_L1_Mu20_EG10er2p5_;
    unsigned int counter_uncached_L1_Mu20_EG10er2p5_;
    bool L1_Mu22er2p1_IsoTau32er2p1_;
    TBranch *b_L1_Mu22er2p1_IsoTau32er2p1_;
    bool loaded_L1_Mu22er2p1_IsoTau32er2p1_;
    unsigned int counter_cached_L1_Mu22er2p1_IsoTau32er2p1_;
    unsigned int counter_uncached_L1_Mu22er2p1_IsoTau32er2p1_;
    bool L1_Mu22er2p1_IsoTau34er2p1_;
    TBranch *b_L1_Mu22er2p1_IsoTau34er2p1_;
    bool loaded_L1_Mu22er2p1_IsoTau34er2p1_;
    unsigned int counter_cached_L1_Mu22er2p1_IsoTau34er2p1_;
    unsigned int counter_uncached_L1_Mu22er2p1_IsoTau34er2p1_;
    bool L1_Mu22er2p1_IsoTau36er2p1_;
    TBranch *b_L1_Mu22er2p1_IsoTau36er2p1_;
    bool loaded_L1_Mu22er2p1_IsoTau36er2p1_;
    unsigned int counter_cached_L1_Mu22er2p1_IsoTau36er2p1_;
    unsigned int counter_uncached_L1_Mu22er2p1_IsoTau36er2p1_;
    bool L1_Mu22er2p1_IsoTau40er2p1_;
    TBranch *b_L1_Mu22er2p1_IsoTau40er2p1_;
    bool loaded_L1_Mu22er2p1_IsoTau40er2p1_;
    unsigned int counter_cached_L1_Mu22er2p1_IsoTau40er2p1_;
    unsigned int counter_uncached_L1_Mu22er2p1_IsoTau40er2p1_;
    bool L1_Mu22er2p1_Tau70er2p1_;
    TBranch *b_L1_Mu22er2p1_Tau70er2p1_;
    bool loaded_L1_Mu22er2p1_Tau70er2p1_;
    unsigned int counter_cached_L1_Mu22er2p1_Tau70er2p1_;
    unsigned int counter_uncached_L1_Mu22er2p1_Tau70er2p1_;
    bool L1_Mu3_Jet120er2p5_dR_Max0p4_;
    TBranch *b_L1_Mu3_Jet120er2p5_dR_Max0p4_;
    bool loaded_L1_Mu3_Jet120er2p5_dR_Max0p4_;
    unsigned int counter_cached_L1_Mu3_Jet120er2p5_dR_Max0p4_;
    unsigned int counter_uncached_L1_Mu3_Jet120er2p5_dR_Max0p4_;
    bool L1_Mu3_Jet120er2p5_dR_Max0p8_;
    TBranch *b_L1_Mu3_Jet120er2p5_dR_Max0p8_;
    bool loaded_L1_Mu3_Jet120er2p5_dR_Max0p8_;
    unsigned int counter_cached_L1_Mu3_Jet120er2p5_dR_Max0p8_;
    unsigned int counter_uncached_L1_Mu3_Jet120er2p5_dR_Max0p8_;
    bool L1_Mu3_Jet16er2p5_dR_Max0p4_;
    TBranch *b_L1_Mu3_Jet16er2p5_dR_Max0p4_;
    bool loaded_L1_Mu3_Jet16er2p5_dR_Max0p4_;
    unsigned int counter_cached_L1_Mu3_Jet16er2p5_dR_Max0p4_;
    unsigned int counter_uncached_L1_Mu3_Jet16er2p5_dR_Max0p4_;
    bool L1_Mu3_Jet30er2p5_;
    TBranch *b_L1_Mu3_Jet30er2p5_;
    bool loaded_L1_Mu3_Jet30er2p5_;
    unsigned int counter_cached_L1_Mu3_Jet30er2p5_;
    unsigned int counter_uncached_L1_Mu3_Jet30er2p5_;
    bool L1_Mu3_Jet35er2p5_dR_Max0p4_;
    TBranch *b_L1_Mu3_Jet35er2p5_dR_Max0p4_;
    bool loaded_L1_Mu3_Jet35er2p5_dR_Max0p4_;
    unsigned int counter_cached_L1_Mu3_Jet35er2p5_dR_Max0p4_;
    unsigned int counter_uncached_L1_Mu3_Jet35er2p5_dR_Max0p4_;
    bool L1_Mu3_Jet60er2p5_dR_Max0p4_;
    TBranch *b_L1_Mu3_Jet60er2p5_dR_Max0p4_;
    bool loaded_L1_Mu3_Jet60er2p5_dR_Max0p4_;
    unsigned int counter_cached_L1_Mu3_Jet60er2p5_dR_Max0p4_;
    unsigned int counter_uncached_L1_Mu3_Jet60er2p5_dR_Max0p4_;
    bool L1_Mu3_Jet80er2p5_dR_Max0p4_;
    TBranch *b_L1_Mu3_Jet80er2p5_dR_Max0p4_;
    bool loaded_L1_Mu3_Jet80er2p5_dR_Max0p4_;
    unsigned int counter_cached_L1_Mu3_Jet80er2p5_dR_Max0p4_;
    unsigned int counter_uncached_L1_Mu3_Jet80er2p5_dR_Max0p4_;
    ...
    unsigned int counter_cached_L1_Mu3er1p5_Jet100er2p5_ETMHF40_;
    unsigned int counter_uncached_L1_Mu3er1p5_Jet100er2p5_ETMHF40_;
    ...
    unsigned int counter_cached_L1_Mu3er1p5_Jet100er2p5_ETMHF50_;
    unsigned int counter_uncached_L1_Mu3er1p5_Jet100er2p5_ETMHF50_;
    bool L1_Mu5_EG23er2p5_;
    TBranch *b_L1_Mu5_EG23er2p5_;
    bool loaded_L1_Mu5_EG23er2p5_;
    unsigned int counter_cached_L1_Mu5_EG23er2p5_;
    unsigned int counter_uncached_L1_Mu5_EG23er2p5_;
    bool L1_Mu5_LooseIsoEG20er2p5_;
    TBranch *b_L1_Mu5_LooseIsoEG20er2p5_;
    bool loaded_L1_Mu5_LooseIsoEG20er2p5_;
    unsigned int counter_cached_L1_Mu5_LooseIsoEG20er2p5_;
    unsigned int counter_uncached_L1_Mu5_LooseIsoEG20er2p5_;
    bool L1_Mu6_DoubleEG10er2p5_;
    TBranch *b_L1_Mu6_DoubleEG10er2p5_;
    bool loaded_L1_Mu6_DoubleEG10er2p5_;
    unsigned int counter_cached_L1_Mu6_DoubleEG10er2p5_;
    unsigned int counter_uncached_L1_Mu6_DoubleEG10er2p5_;
    bool L1_Mu6_DoubleEG12er2p5_;
    TBranch *b_L1_Mu6_DoubleEG12er2p5_;
    bool loaded_L1_Mu6_DoubleEG12er2p5_;
    unsigned int counter_cached_L1_Mu6_DoubleEG12er2p5_;
    unsigned int counter_uncached_L1_Mu6_DoubleEG12er2p5_;
    bool L1_Mu6_DoubleEG15er2p5_;
    TBranch *b_L1_Mu6_DoubleEG15er2p5_;
    bool loaded_L1_Mu6_DoubleEG15er2p5_;
    unsigned int counter_cached_L1_Mu6_DoubleEG15er2p5_;
    unsigned int counter_uncached_L1_Mu6_DoubleEG15er2p5_;
    bool L1_Mu6_DoubleEG17er2p5_;
    TBranch *b_L1_Mu6_DoubleEG17er2p5_;
    bool loaded_L1_Mu6_DoubleEG17er2p5_;
    unsigned int counter_cached_L1_Mu6_DoubleEG17er2p5_;
    unsigned int counter_uncached_L1_Mu6_DoubleEG17er2p5_;
    bool L1_Mu6_HTT240er_;
    TBranch *b_L1_Mu6_HTT240er_;
    bool loaded_L1_Mu6_HTT240er_;
    unsigned int counter_cached_L1_Mu6_HTT240er_;
    unsigned int counter_uncached_L1_Mu6_HTT240er_;
    bool L1_Mu6_HTT250er_;
    TBranch *b_L1_Mu6_HTT250er_;
    bool loaded_L1_Mu6_HTT250er_;
    unsigned int counter_cached_L1_Mu6_HTT250er_;
    unsigned int counter_uncached_L1_Mu6_HTT250er_;
    bool L1_Mu7_EG23er2p5_;
    TBranch *b_L1_Mu7_EG23er2p5_;
    bool loaded_L1_Mu7_EG23er2p5_;
    unsigned int counter_cached_L1_Mu7_EG23er2p5_;
    unsigned int counter_uncached_L1_Mu7_EG23er2p5_;
    bool L1_Mu7_LooseIsoEG20er2p5_;
    TBranch *b_L1_Mu7_LooseIsoEG20er2p5_;
    bool loaded_L1_Mu7_LooseIsoEG20er2p5_;
    unsigned int counter_cached_L1_Mu7_LooseIsoEG20er2p5_;
    unsigned int counter_uncached_L1_Mu7_LooseIsoEG20er2p5_;
    bool L1_Mu7_LooseIsoEG23er2p5_;
    TBranch *b_L1_Mu7_LooseIsoEG23er2p5_;
    bool loaded_L1_Mu7_LooseIsoEG23er2p5_;
    unsigned int counter_cached_L1_Mu7_LooseIsoEG23er2p5_;
    unsigned int counter_uncached_L1_Mu7_LooseIsoEG23er2p5_;
    bool L1_NotBptxOR_;
    TBranch *b_L1_NotBptxOR_;
    bool loaded_L1_NotBptxOR_;
    unsigned int counter_cached_L1_NotBptxOR_;
    unsigned int counter_uncached_L1_NotBptxOR_;
    ...
    unsigned int counter_cached_L1_QuadJet36er2p5_IsoTau52er2p1_;
    unsigned int counter_uncached_L1_QuadJet36er2p5_IsoTau52er2p1_;
    bool L1_QuadJet60er2p5_;
    TBranch *b_L1_QuadJet60er2p5_;
    bool loaded_L1_QuadJet60er2p5_;
    unsigned int counter_cached_L1_QuadJet60er2p5_;
    unsigned int counter_uncached_L1_QuadJet60er2p5_;
    ...
    unsigned int counter_cached_L1_QuadJet_95_75_65_20_DoubleJet_75_65_er2p5_Jet20_FWD3p0_;
    unsigned int counter_uncached_L1_QuadJet_95_75_65_20_DoubleJet_75_65_er2p5_Jet20_FWD3p0_;
    bool L1_QuadMu0_;
    TBranch *b_L1_QuadMu0_;
    bool loaded_L1_QuadMu0_;
    unsigned int counter_cached_L1_QuadMu0_;
    unsigned int counter_uncached_L1_QuadMu0_;
    bool L1_QuadMu0_OQ_;
    TBranch *b_L1_QuadMu0_OQ_;
    bool loaded_L1_QuadMu0_OQ_;
    unsigned int counter_cached_L1_QuadMu0_OQ_;
    unsigned int counter_uncached_L1_QuadMu0_OQ_;
    bool L1_QuadMu0_SQ_;
    TBranch *b_L1_QuadMu0_SQ_;
    bool loaded_L1_QuadMu0_SQ_;
    unsigned int counter_cached_L1_QuadMu0_SQ_;
    unsigned int counter_uncached_L1_QuadMu0_SQ_;
    bool L1_SecondBunchInTrain_;
    TBranch *b_L1_SecondBunchInTrain_;
    bool loaded_L1_SecondBunchInTrain_;
    unsigned int counter_cached_L1_SecondBunchInTrain_;
    unsigned int counter_uncached_L1_SecondBunchInTrain_;
    bool L1_SecondLastBunchInTrain_;
    TBranch *b_L1_SecondLastBunchInTrain_;
    bool loaded_L1_SecondLastBunchInTrain_;
    unsigned int counter_cached_L1_SecondLastBunchInTrain_;
    unsigned int counter_uncached_L1_SecondLastBunchInTrain_;
    bool L1_SingleEG10er2p5_;
    TBranch *b_L1_SingleEG10er2p5_;
    bool loaded_L1_SingleEG10er2p5_;
    unsigned int counter_cached_L1_SingleEG10er2p5_;
    unsigned int counter_uncached_L1_SingleEG10er2p5_;
    bool L1_SingleEG15er2p5_;
    TBranch *b_L1_SingleEG15er2p5_;
    bool loaded_L1_SingleEG15er2p5_;
    unsigned int counter_cached_L1_SingleEG15er2p5_;
    unsigned int counter_uncached_L1_SingleEG15er2p5_;
    bool L1_SingleEG26er2p5_;
    TBranch *b_L1_SingleEG26er2p5_;
    bool loaded_L1_SingleEG26er2p5_;
    unsigned int counter_cached_L1_SingleEG26er2p5_;
    unsigned int counter_uncached_L1_SingleEG26er2p5_;
    bool L1_SingleEG34er2p5_;
    TBranch *b_L1_SingleEG34er2p5_;
    bool loaded_L1_SingleEG34er2p5_;
    unsigned int counter_cached_L1_SingleEG34er2p5_;
    unsigned int counter_uncached_L1_SingleEG34er2p5_;
    bool L1_SingleEG36er2p5_;
    TBranch *b_L1_SingleEG36er2p5_;
    bool loaded_L1_SingleEG36er2p5_;
    unsigned int counter_cached_L1_SingleEG36er2p5_;
    unsigned int counter_uncached_L1_SingleEG36er2p5_;
    bool L1_SingleEG38er2p5_;
    TBranch *b_L1_SingleEG38er2p5_;
    bool loaded_L1_SingleEG38er2p5_;
    unsigned int counter_cached_L1_SingleEG38er2p5_;
    unsigned int counter_uncached_L1_SingleEG38er2p5_;
    bool L1_SingleEG40er2p5_;
    TBranch *b_L1_SingleEG40er2p5_;
    bool loaded_L1_SingleEG40er2p5_;
    unsigned int counter_cached_L1_SingleEG40er2p5_;
    unsigned int counter_uncached_L1_SingleEG40er2p5_;
    bool L1_SingleEG42er2p5_;
    TBranch *b_L1_SingleEG42er2p5_;
    bool loaded_L1_SingleEG42er2p5_;
    unsigned int counter_cached_L1_SingleEG42er2p5_;
    unsigned int counter_uncached_L1_SingleEG42er2p5_;
    bool L1_SingleEG45er2p5_;
    TBranch *b_L1_SingleEG45er2p5_;
    bool loaded_L1_SingleEG45er2p5_;
    unsigned int counter_cached_L1_SingleEG45er2p5_;
    unsigned int counter_uncached_L1_SingleEG45er2p5_;
    bool L1_SingleEG50_;
    TBranch *b_L1_SingleEG50_;
    bool loaded_L1_SingleEG50_;
    unsigned int counter_cached_L1_SingleEG50_;
    unsigned int counter_uncached_L1_SingleEG50_;
    bool L1_SingleEG60_;
    TBranch *b_L1_SingleEG60_;
    bool loaded_L1_SingleEG60_;
    unsigned int counter_cached_L1_SingleEG60_;
    unsigned int counter_uncached_L1_SingleEG60_;
    bool L1_SingleEG8er2p5_;
    TBranch *b_L1_SingleEG8er2p5_;
    bool loaded_L1_SingleEG8er2p5_;
    unsigned int counter_cached_L1_SingleEG8er2p5_;
    unsigned int counter_uncached_L1_SingleEG8er2p5_;
    bool L1_SingleIsoEG24er1p5_;
    TBranch *b_L1_SingleIsoEG24er1p5_;
    bool loaded_L1_SingleIsoEG24er1p5_;
    unsigned int counter_cached_L1_SingleIsoEG24er1p5_;
    unsigned int counter_uncached_L1_SingleIsoEG24er1p5_;
    bool L1_SingleIsoEG24er2p1_;
    TBranch *b_L1_SingleIsoEG24er2p1_;
    bool loaded_L1_SingleIsoEG24er2p1_;
    unsigned int counter_cached_L1_SingleIsoEG24er2p1_;
    unsigned int counter_uncached_L1_SingleIsoEG24er2p1_;
    bool L1_SingleIsoEG26er1p5_;
    TBranch *b_L1_SingleIsoEG26er1p5_;
    bool loaded_L1_SingleIsoEG26er1p5_;
    unsigned int counter_cached_L1_SingleIsoEG26er1p5_;
    unsigned int counter_uncached_L1_SingleIsoEG26er1p5_;
    bool L1_SingleIsoEG26er2p1_;
    TBranch *b_L1_SingleIsoEG26er2p1_;
    bool loaded_L1_SingleIsoEG26er2p1_;
    unsigned int counter_cached_L1_SingleIsoEG26er2p1_;
    unsigned int counter_uncached_L1_SingleIsoEG26er2p1_;
    bool L1_SingleIsoEG26er2p5_;
    TBranch *b_L1_SingleIsoEG26er2p5_;
    bool loaded_L1_SingleIsoEG26er2p5_;
    unsigned int counter_cached_L1_SingleIsoEG26er2p5_;
    unsigned int counter_uncached_L1_SingleIsoEG26er2p5_;
    bool L1_SingleIsoEG28er1p5_;
    TBranch *b_L1_SingleIsoEG28er1p5_;
    bool loaded_L1_SingleIsoEG28er1p5_;
    unsigned int counter_cached_L1_SingleIsoEG28er1p5_;
    unsigned int counter_uncached_L1_SingleIsoEG28er1p5_;
    bool L1_SingleIsoEG28er2p1_;
    TBranch *b_L1_SingleIsoEG28er2p1_;
    bool loaded_L1_SingleIsoEG28er2p1_;
    unsigned int counter_cached_L1_SingleIsoEG28er2p1_;
    unsigned int counter_uncached_L1_SingleIsoEG28er2p1_;
    bool L1_SingleIsoEG28er2p5_;
    TBranch *b_L1_SingleIsoEG28er2p5_;
    bool loaded_L1_SingleIsoEG28er2p5_;
    unsigned int counter_cached_L1_SingleIsoEG28er2p5_;
    unsigned int counter_uncached_L1_SingleIsoEG28er2p5_;
    bool L1_SingleIsoEG30er2p1_;
    TBranch *b_L1_SingleIsoEG30er2p1_;
    bool loaded_L1_SingleIsoEG30er2p1_;
    unsigned int counter_cached_L1_SingleIsoEG30er2p1_;
    unsigned int counter_uncached_L1_SingleIsoEG30er2p1_;
    bool L1_SingleIsoEG30er2p5_;
    TBranch *b_L1_SingleIsoEG30er2p5_;
    bool loaded_L1_SingleIsoEG30er2p5_;
    unsigned int counter_cached_L1_SingleIsoEG30er2p5_;
    unsigned int counter_uncached_L1_SingleIsoEG30er2p5_;
    bool L1_SingleIsoEG32er2p1_;
    TBranch *b_L1_SingleIsoEG32er2p1_;
    bool loaded_L1_SingleIsoEG32er2p1_;
    unsigned int counter_cached_L1_SingleIsoEG32er2p1_;
    unsigned int counter_uncached_L1_SingleIsoEG32er2p1_;
    bool L1_SingleIsoEG32er2p5_;
    TBranch *b_L1_SingleIsoEG32er2p5_;
    bool loaded_L1_SingleIsoEG32er2p5_;
    unsigned int counter_cached_L1_SingleIsoEG32er2p5_;
    unsigned int counter_uncached_L1_SingleIsoEG32er2p5_;
    bool L1_SingleIsoEG34er2p5_;
    TBranch *b_L1_SingleIsoEG34er2p5_;
    bool loaded_L1_SingleIsoEG34er2p5_;
    unsigned int counter_cached_L1_SingleIsoEG34er2p5_;
    unsigned int counter_uncached_L1_SingleIsoEG34er2p5_;
    bool L1_SingleJet10erHE_;
    TBranch *b_L1_SingleJet10erHE_;
    bool loaded_L1_SingleJet10erHE_;
    unsigned int counter_cached_L1_SingleJet10erHE_;
    unsigned int counter_uncached_L1_SingleJet10erHE_;
    bool L1_SingleJet120_;
    TBranch *b_L1_SingleJet120_;
    bool loaded_L1_SingleJet120_;
    unsigned int counter_cached_L1_SingleJet120_;
    unsigned int counter_uncached_L1_SingleJet120_;
    bool L1_SingleJet120_FWD3p0_;
    TBranch *b_L1_SingleJet120_FWD3p0_;
    bool loaded_L1_SingleJet120_FWD3p0_;
    unsigned int counter_cached_L1_SingleJet120_FWD3p0_;
    unsigned int counter_uncached_L1_SingleJet120_FWD3p0_;
    bool L1_SingleJet120er2p5_;
    TBranch *b_L1_SingleJet120er2p5_;
    bool loaded_L1_SingleJet120er2p5_;
    unsigned int counter_cached_L1_SingleJet120er2p5_;
    unsigned int counter_uncached_L1_SingleJet120er2p5_;
    bool L1_SingleJet12erHE_;
    TBranch *b_L1_SingleJet12erHE_;
    bool loaded_L1_SingleJet12erHE_;
    unsigned int counter_cached_L1_SingleJet12erHE_;
    unsigned int counter_uncached_L1_SingleJet12erHE_;
    bool L1_SingleJet140er2p5_;
    TBranch *b_L1_SingleJet140er2p5_;
    bool loaded_L1_SingleJet140er2p5_;
    unsigned int counter_cached_L1_SingleJet140er2p5_;
    unsigned int counter_uncached_L1_SingleJet140er2p5_;
    bool L1_SingleJet140er2p5_ETMHF80_;
    TBranch *b_L1_SingleJet140er2p5_ETMHF80_;
    bool loaded_L1_SingleJet140er2p5_ETMHF80_;
    unsigned int counter_cached_L1_SingleJet140er2p5_ETMHF80_;
    unsigned int counter_uncached_L1_SingleJet140er2p5_ETMHF80_;
    bool L1_SingleJet140er2p5_ETMHF90_;
    TBranch *b_L1_SingleJet140er2p5_ETMHF90_;
    bool loaded_L1_SingleJet140er2p5_ETMHF90_;
    unsigned int counter_cached_L1_SingleJet140er2p5_ETMHF90_;
    unsigned int counter_uncached_L1_SingleJet140er2p5_ETMHF90_;
    bool L1_SingleJet160er2p5_;
    TBranch *b_L1_SingleJet160er2p5_;
    bool loaded_L1_SingleJet160er2p5_;
    unsigned int counter_cached_L1_SingleJet160er2p5_;
    unsigned int counter_uncached_L1_SingleJet160er2p5_;
    bool L1_SingleJet180_;
    TBranch *b_L1_SingleJet180_;
    bool loaded_L1_SingleJet180_;
    unsigned int counter_cached_L1_SingleJet180_;
    unsigned int counter_uncached_L1_SingleJet180_;
    bool L1_SingleJet180er2p5_;
    TBranch *b_L1_SingleJet180er2p5_;
    bool loaded_L1_SingleJet180er2p5_;
    unsigned int counter_cached_L1_SingleJet180er2p5_;
    unsigned int counter_uncached_L1_SingleJet180er2p5_;
    bool L1_SingleJet200_;
    TBranch *b_L1_SingleJet200_;
    bool loaded_L1_SingleJet200_;
    unsigned int counter_cached_L1_SingleJet200_;
    unsigned int counter_uncached_L1_SingleJet200_;
    bool L1_SingleJet20er2p5_NotBptxOR_;
    TBranch *b_L1_SingleJet20er2p5_NotBptxOR_;
    bool loaded_L1_SingleJet20er2p5_NotBptxOR_;
    unsigned int counter_cached_L1_SingleJet20er2p5_NotBptxOR_;
    unsigned int counter_uncached_L1_SingleJet20er2p5_NotBptxOR_;
    ...
    unsigned int counter_cached_L1_SingleJet20er2p5_NotBptxOR_3BX_;
    unsigned int counter_uncached_L1_SingleJet20er2p5_NotBptxOR_3BX_;
    bool L1_SingleJet35_;
    TBranch *b_L1_SingleJet35_;
    bool loaded_L1_SingleJet35_;
    unsigned int counter_cached_L1_SingleJet35_;
    unsigned int counter_uncached_L1_SingleJet35_;
    bool L1_SingleJet35_FWD3p0_;
    TBranch *b_L1_SingleJet35_FWD3p0_;
    bool loaded_L1_SingleJet35_FWD3p0_;
    unsigned int counter_cached_L1_SingleJet35_FWD3p0_;
    unsigned int counter_uncached_L1_SingleJet35_FWD3p0_;
    bool L1_SingleJet35er2p5_;
    TBranch *b_L1_SingleJet35er2p5_;
    bool loaded_L1_SingleJet35er2p5_;
    unsigned int counter_cached_L1_SingleJet35er2p5_;
    unsigned int counter_uncached_L1_SingleJet35er2p5_;
    ...
    unsigned int counter_cached_L1_SingleJet43er2p5_NotBptxOR_3BX_;
    unsigned int counter_uncached_L1_SingleJet43er2p5_NotBptxOR_3BX_;
    ...
    unsigned int counter_cached_L1_SingleJet46er2p5_NotBptxOR_3BX_;
    unsigned int counter_uncached_L1_SingleJet46er2p5_NotBptxOR_3BX_;
    bool L1_SingleJet60_;
    TBranch *b_L1_SingleJet60_;
    bool loaded_L1_SingleJet60_;
    unsigned int counter_cached_L1_SingleJet60_;
    unsigned int counter_uncached_L1_SingleJet60_;
    bool L1_SingleJet60_FWD3p0_;
    TBranch *b_L1_SingleJet60_FWD3p0_;
    bool loaded_L1_SingleJet60_FWD3p0_;
    unsigned int counter_cached_L1_SingleJet60_FWD3p0_;
    unsigned int counter_uncached_L1_SingleJet60_FWD3p0_;
    bool L1_SingleJet60er2p5_;
    TBranch *b_L1_SingleJet60er2p5_;
    bool loaded_L1_SingleJet60er2p5_;
    unsigned int counter_cached_L1_SingleJet60er2p5_;
    unsigned int counter_uncached_L1_SingleJet60er2p5_;
    bool L1_SingleJet8erHE_;
    TBranch *b_L1_SingleJet8erHE_;
    bool loaded_L1_SingleJet8erHE_;
    unsigned int counter_cached_L1_SingleJet8erHE_;
    unsigned int counter_uncached_L1_SingleJet8erHE_;
    bool L1_SingleJet90_;
    TBranch *b_L1_SingleJet90_;
    bool loaded_L1_SingleJet90_;
    unsigned int counter_cached_L1_SingleJet90_;
    unsigned int counter_uncached_L1_SingleJet90_;
    bool L1_SingleJet90_FWD3p0_;
    TBranch *b_L1_SingleJet90_FWD3p0_;
    bool loaded_L1_SingleJet90_FWD3p0_;
    unsigned int counter_cached_L1_SingleJet90_FWD3p0_;
    unsigned int counter_uncached_L1_SingleJet90_FWD3p0_;
    bool L1_SingleJet90er2p5_;
    TBranch *b_L1_SingleJet90er2p5_;
    bool loaded_L1_SingleJet90er2p5_;
    unsigned int counter_cached_L1_SingleJet90er2p5_;
    unsigned int counter_uncached_L1_SingleJet90er2p5_;
    bool L1_SingleLooseIsoEG28er1p5_;
    TBranch *b_L1_SingleLooseIsoEG28er1p5_;
    bool loaded_L1_SingleLooseIsoEG28er1p5_;
    unsigned int counter_cached_L1_SingleLooseIsoEG28er1p5_;
    unsigned int counter_uncached_L1_SingleLooseIsoEG28er1p5_;
    bool L1_SingleLooseIsoEG30er1p5_;
    TBranch *b_L1_SingleLooseIsoEG30er1p5_;
    bool loaded_L1_SingleLooseIsoEG30er1p5_;
    unsigned int counter_cached_L1_SingleLooseIsoEG30er1p5_;
    unsigned int counter_uncached_L1_SingleLooseIsoEG30er1p5_;
    bool L1_SingleMu0_BMTF_;
    TBranch *b_L1_SingleMu0_BMTF_;
    bool loaded_L1_SingleMu0_BMTF_;
    unsigned int counter_cached_L1_SingleMu0_BMTF_;
    unsigned int counter_uncached_L1_SingleMu0_BMTF_;
    bool L1_SingleMu0_DQ_;
    TBranch *b_L1_SingleMu0_DQ_;
    bool loaded_L1_SingleMu0_DQ_;
    unsigned int counter_cached_L1_SingleMu0_DQ_;
    unsigned int counter_uncached_L1_SingleMu0_DQ_;
    bool L1_SingleMu0_EMTF_;
    TBranch *b_L1_SingleMu0_EMTF_;
    bool loaded_L1_SingleMu0_EMTF_;
    unsigned int counter_cached_L1_SingleMu0_EMTF_;
    unsigned int counter_uncached_L1_SingleMu0_EMTF_;
    bool L1_SingleMu0_OMTF_;
    TBranch *b_L1_SingleMu0_OMTF_;
    bool loaded_L1_SingleMu0_OMTF_;
    unsigned int counter_cached_L1_SingleMu0_OMTF_;
    unsigned int counter_uncached_L1_SingleMu0_OMTF_;
    bool L1_SingleMu10er1p5_;
    TBranch *b_L1_SingleMu10er1p5_;
    bool loaded_L1_SingleMu10er1p5_;
    unsigned int counter_cached_L1_SingleMu10er1p5_;
    unsigned int counter_uncached_L1_SingleMu10er1p5_;
    bool L1_SingleMu12_DQ_BMTF_;
    TBranch *b_L1_SingleMu12_DQ_BMTF_;
    bool loaded_L1_SingleMu12_DQ_BMTF_;
    unsigned int counter_cached_L1_SingleMu12_DQ_BMTF_;
    unsigned int counter_uncached_L1_SingleMu12_DQ_BMTF_;
    bool L1_SingleMu12_DQ_EMTF_;
    TBranch *b_L1_SingleMu12_DQ_EMTF_;
    bool loaded_L1_SingleMu12_DQ_EMTF_;
    unsigned int counter_cached_L1_SingleMu12_DQ_EMTF_;
    unsigned int counter_uncached_L1_SingleMu12_DQ_EMTF_;
    bool L1_SingleMu12_DQ_OMTF_;
    TBranch *b_L1_SingleMu12_DQ_OMTF_;
    bool loaded_L1_SingleMu12_DQ_OMTF_;
    unsigned int counter_cached_L1_SingleMu12_DQ_OMTF_;
    unsigned int counter_uncached_L1_SingleMu12_DQ_OMTF_;
    bool L1_SingleMu12er1p5_;
    TBranch *b_L1_SingleMu12er1p5_;
    bool loaded_L1_SingleMu12er1p5_;
    unsigned int counter_cached_L1_SingleMu12er1p5_;
    unsigned int counter_uncached_L1_SingleMu12er1p5_;
    bool L1_SingleMu14er1p5_;
    TBranch *b_L1_SingleMu14er1p5_;
    bool loaded_L1_SingleMu14er1p5_;
    unsigned int counter_cached_L1_SingleMu14er1p5_;
    unsigned int counter_uncached_L1_SingleMu14er1p5_;
    bool L1_SingleMu15_DQ_;
    TBranch *b_L1_SingleMu15_DQ_;
    bool loaded_L1_SingleMu15_DQ_;
    unsigned int counter_cached_L1_SingleMu15_DQ_;
    unsigned int counter_uncached_L1_SingleMu15_DQ_;
    bool L1_SingleMu16er1p5_;
    TBranch *b_L1_SingleMu16er1p5_;
    bool loaded_L1_SingleMu16er1p5_;
    unsigned int counter_cached_L1_SingleMu16er1p5_;
    unsigned int counter_uncached_L1_SingleMu16er1p5_;
    bool L1_SingleMu18_;
    TBranch *b_L1_SingleMu18_;
    bool loaded_L1_SingleMu18_;
    unsigned int counter_cached_L1_SingleMu18_;
    unsigned int counter_uncached_L1_SingleMu18_;
    bool L1_SingleMu18er1p5_;
    TBranch *b_L1_SingleMu18er1p5_;
    bool loaded_L1_SingleMu18er1p5_;
    unsigned int counter_cached_L1_SingleMu18er1p5_;
    unsigned int counter_uncached_L1_SingleMu18er1p5_;
    bool L1_SingleMu20_;
    TBranch *b_L1_SingleMu20_;
    bool loaded_L1_SingleMu20_;
    unsigned int counter_cached_L1_SingleMu20_;
    unsigned int counter_uncached_L1_SingleMu20_;
    bool L1_SingleMu22_;
    TBranch *b_L1_SingleMu22_;
    bool loaded_L1_SingleMu22_;
    unsigned int counter_cached_L1_SingleMu22_;
    unsigned int counter_uncached_L1_SingleMu22_;
    bool L1_SingleMu22_BMTF_;
    TBranch *b_L1_SingleMu22_BMTF_;
    bool loaded_L1_SingleMu22_BMTF_;
    unsigned int counter_cached_L1_SingleMu22_BMTF_;
    unsigned int counter_uncached_L1_SingleMu22_BMTF_;
    bool L1_SingleMu22_EMTF_;
    TBranch *b_L1_SingleMu22_EMTF_;
    bool loaded_L1_SingleMu22_EMTF_;
    unsigned int counter_cached_L1_SingleMu22_EMTF_;
    unsigned int counter_uncached_L1_SingleMu22_EMTF_;
    bool L1_SingleMu22_OMTF_;
    TBranch *b_L1_SingleMu22_OMTF_;
    bool loaded_L1_SingleMu22_OMTF_;
    unsigned int counter_cached_L1_SingleMu22_OMTF_;
    unsigned int counter_uncached_L1_SingleMu22_OMTF_;
    bool L1_SingleMu25_;
    TBranch *b_L1_SingleMu25_;
    bool loaded_L1_SingleMu25_;
    unsigned int counter_cached_L1_SingleMu25_;
    unsigned int counter_uncached_L1_SingleMu25_;
    bool L1_SingleMu3_;
    TBranch *b_L1_SingleMu3_;
    bool loaded_L1_SingleMu3_;
    unsigned int counter_cached_L1_SingleMu3_;
    unsigned int counter_uncached_L1_SingleMu3_;
    bool L1_SingleMu5_;
    TBranch *b_L1_SingleMu5_;
    bool loaded_L1_SingleMu5_;
    unsigned int counter_cached_L1_SingleMu5_;
    unsigned int counter_uncached_L1_SingleMu5_;
    bool L1_SingleMu6er1p5_;
    TBranch *b_L1_SingleMu6er1p5_;
    bool loaded_L1_SingleMu6er1p5_;
    unsigned int counter_cached_L1_SingleMu6er1p5_;
    unsigned int counter_uncached_L1_SingleMu6er1p5_;
    bool L1_SingleMu7_;
    TBranch *b_L1_SingleMu7_;
    bool loaded_L1_SingleMu7_;
    unsigned int counter_cached_L1_SingleMu7_;
    unsigned int counter_uncached_L1_SingleMu7_;
    bool L1_SingleMu7_DQ_;
    TBranch *b_L1_SingleMu7_DQ_;
    bool loaded_L1_SingleMu7_DQ_;
    unsigned int counter_cached_L1_SingleMu7_DQ_;
    unsigned int counter_uncached_L1_SingleMu7_DQ_;
    bool L1_SingleMu7er1p5_;
    TBranch *b_L1_SingleMu7er1p5_;
    bool loaded_L1_SingleMu7er1p5_;
    unsigned int counter_cached_L1_SingleMu7er1p5_;
    unsigned int counter_uncached_L1_SingleMu7er1p5_;
    bool L1_SingleMu8er1p5_;
    TBranch *b_L1_SingleMu8er1p5_;
    bool loaded_L1_SingleMu8er1p5_;
    unsigned int counter_cached_L1_SingleMu8er1p5_;
    unsigned int counter_uncached_L1_SingleMu8er1p5_;
    bool L1_SingleMu9er1p5_;
    TBranch *b_L1_SingleMu9er1p5_;
    bool loaded_L1_SingleMu9er1p5_;
    unsigned int counter_cached_L1_SingleMu9er1p5_;
    unsigned int counter_uncached_L1_SingleMu9er1p5_;
    bool L1_SingleMuCosmics_;
    TBranch *b_L1_SingleMuCosmics_;
    bool loaded_L1_SingleMuCosmics_;
    unsigned int counter_cached_L1_SingleMuCosmics_;
    unsigned int counter_uncached_L1_SingleMuCosmics_;
    bool L1_SingleMuCosmics_BMTF_;
    TBranch *b_L1_SingleMuCosmics_BMTF_;
    bool loaded_L1_SingleMuCosmics_BMTF_;
    unsigned int counter_cached_L1_SingleMuCosmics_BMTF_;
    unsigned int counter_uncached_L1_SingleMuCosmics_BMTF_;
    bool L1_SingleMuCosmics_EMTF_;
    TBranch *b_L1_SingleMuCosmics_EMTF_;
    bool loaded_L1_SingleMuCosmics_EMTF_;
    unsigned int counter_cached_L1_SingleMuCosmics_EMTF_;
    unsigned int counter_uncached_L1_SingleMuCosmics_EMTF_;
    bool L1_SingleMuCosmics_OMTF_;
    TBranch *b_L1_SingleMuCosmics_OMTF_;
    bool loaded_L1_SingleMuCosmics_OMTF_;
    unsigned int counter_cached_L1_SingleMuCosmics_OMTF_;
    unsigned int counter_uncached_L1_SingleMuCosmics_OMTF_;
    bool L1_SingleMuOpen_;
    TBranch *b_L1_SingleMuOpen_;
    bool loaded_L1_SingleMuOpen_;
    unsigned int counter_cached_L1_SingleMuOpen_;
    unsigned int counter_uncached_L1_SingleMuOpen_;
    bool L1_SingleMuOpen_NotBptxOR_;
    TBranch *b_L1_SingleMuOpen_NotBptxOR_;
    bool loaded_L1_SingleMuOpen_NotBptxOR_;
    unsigned int counter_cached_L1_SingleMuOpen_NotBptxOR_;
    unsigned int counter_uncached_L1_SingleMuOpen_NotBptxOR_;
    ...
    unsigned int counter_cached_L1_SingleMuOpen_er1p1_NotBptxOR_3BX_;
    unsigned int counter_uncached_L1_SingleMuOpen_er1p1_NotBptxOR_3BX_;
    ...
    unsigned int counter_cached_L1_SingleMuOpen_er1p4_NotBptxOR_3BX_;
    unsigned int counter_uncached_L1_SingleMuOpen_er1p4_NotBptxOR_3BX_;
    bool L1_SingleTau120er2p1_;
    TBranch *b_L1_SingleTau120er2p1_;
    bool loaded_L1_SingleTau120er2p1_;
    unsigned int counter_cached_L1_SingleTau120er2p1_;
    unsigned int counter_uncached_L1_SingleTau120er2p1_;
    bool L1_SingleTau130er2p1_;
    TBranch *b_L1_SingleTau130er2p1_;
    bool loaded_L1_SingleTau130er2p1_;
    unsigned int counter_cached_L1_SingleTau130er2p1_;
    unsigned int counter_uncached_L1_SingleTau130er2p1_;
    bool L1_TOTEM_1_;
    TBranch *b_L1_TOTEM_1_;
    bool loaded_L1_TOTEM_1_;
    unsigned int counter_cached_L1_TOTEM_1_;
    unsigned int counter_uncached_L1_TOTEM_1_;
    bool L1_TOTEM_2_;
    TBranch *b_L1_TOTEM_2_;
    bool loaded_L1_TOTEM_2_;
    unsigned int counter_cached_L1_TOTEM_2_;
    unsigned int counter_uncached_L1_TOTEM_2_;
    bool L1_TOTEM_3_;
    TBranch *b_L1_TOTEM_3_;
    bool loaded_L1_TOTEM_3_;
    unsigned int counter_cached_L1_TOTEM_3_;
    unsigned int counter_uncached_L1_TOTEM_3_;
    bool L1_TOTEM_4_;
    TBranch *b_L1_TOTEM_4_;
    bool loaded_L1_TOTEM_4_;
    unsigned int counter_cached_L1_TOTEM_4_;
    unsigned int counter_uncached_L1_TOTEM_4_;
    bool L1_TripleEG16er2p5_;
    TBranch *b_L1_TripleEG16er2p5_;
    bool loaded_L1_TripleEG16er2p5_;
    unsigned int counter_cached_L1_TripleEG16er2p5_;
    unsigned int counter_uncached_L1_TripleEG16er2p5_;
    bool L1_TripleEG_16_12_8_er2p5_;
    TBranch *b_L1_TripleEG_16_12_8_er2p5_;
    bool loaded_L1_TripleEG_16_12_8_er2p5_;
    unsigned int counter_cached_L1_TripleEG_16_12_8_er2p5_;
    unsigned int counter_uncached_L1_TripleEG_16_12_8_er2p5_;
    bool L1_TripleEG_16_15_8_er2p5_;
    TBranch *b_L1_TripleEG_16_15_8_er2p5_;
    bool loaded_L1_TripleEG_16_15_8_er2p5_;
    unsigned int counter_cached_L1_TripleEG_16_15_8_er2p5_;
    unsigned int counter_uncached_L1_TripleEG_16_15_8_er2p5_;
    bool L1_TripleEG_18_17_8_er2p5_;
    TBranch *b_L1_TripleEG_18_17_8_er2p5_;
    bool loaded_L1_TripleEG_18_17_8_er2p5_;
    unsigned int counter_cached_L1_TripleEG_18_17_8_er2p5_;
    unsigned int counter_uncached_L1_TripleEG_18_17_8_er2p5_;
    bool L1_TripleEG_18_18_12_er2p5_;
    TBranch *b_L1_TripleEG_18_18_12_er2p5_;
    bool loaded_L1_TripleEG_18_18_12_er2p5_;
    unsigned int counter_cached_L1_TripleEG_18_18_12_er2p5_;
    unsigned int counter_uncached_L1_TripleEG_18_18_12_er2p5_;
    ...
    unsigned int counter_cached_L1_TripleJet_100_80_70_DoubleJet_80_70_er2p5_;
    unsigned int counter_uncached_L1_TripleJet_100_80_70_DoubleJet_80_70_er2p5_;
    ...
    unsigned int counter_cached_L1_TripleJet_105_85_75_DoubleJet_85_75_er2p5_;
    unsigned int counter_uncached_L1_TripleJet_105_85_75_DoubleJet_85_75_er2p5_;
    ...
    unsigned int counter_cached_L1_TripleJet_95_75_65_DoubleJet_75_65_er2p5_;
    unsigned int counter_uncached_L1_TripleJet_95_75_65_DoubleJet_75_65_er2p5_;
    bool L1_TripleMu0_;
    TBranch *b_L1_TripleMu0_;
    bool loaded_L1_TripleMu0_;
    unsigned int counter_cached_L1_TripleMu0_;
    unsigned int counter_uncached_L1_TripleMu0_;
    bool L1_TripleMu0_OQ_;
    TBranch *b_L1_TripleMu0_OQ_;
    bool loaded_L1_TripleMu0_OQ_;
    unsigned int counter_cached_L1_TripleMu0_OQ_;
    unsigned int counter_uncached_L1_TripleMu0_OQ_;
    bool L1_TripleMu0_SQ_;
    TBranch *b_L1_TripleMu0_SQ_;
    bool loaded_L1_TripleMu0_SQ_;
    unsigned int counter_cached_L1_TripleMu0_SQ_;
    unsigned int counter_uncached_L1_TripleMu0_SQ_;
    bool L1_TripleMu3_;
    TBranch *b_L1_TripleMu3_;
    bool loaded_L1_TripleMu3_;
    unsigned int counter_cached_L1_TripleMu3_;
    unsigned int counter_uncached_L1_TripleMu3_;
    bool L1_TripleMu3_SQ_;
    TBranch *b_L1_TripleMu3_SQ_;
    bool loaded_L1_TripleMu3_SQ_;
    unsigned int counter_cached_L1_TripleMu3_SQ_;
    unsigned int counter_uncached_L1_TripleMu3_SQ_;
    bool L1_TripleMu_5SQ_3SQ_0OQ_;
    TBranch *b_L1_TripleMu_5SQ_3SQ_0OQ_;
    bool loaded_L1_TripleMu_5SQ_3SQ_0OQ_;
    unsigned int counter_cached_L1_TripleMu_5SQ_3SQ_0OQ_;
    unsigned int counter_uncached_L1_TripleMu_5SQ_3SQ_0OQ_;
    ...
    unsigned int counter_cached_L1_TripleMu_5SQ_3SQ_0OQ_DoubleMu_5_3_SQ_OS_Mass_Max9_;
    unsigned int counter_uncached_L1_TripleMu_5SQ_3SQ_0OQ_DoubleMu_5_3_SQ_OS_Mass_Max9_;
    ...
    unsigned int counter_cached_L1_TripleMu_5SQ_3SQ_0_DoubleMu_5_3_SQ_OS_Mass_Max9_;
    unsigned int counter_uncached_L1_TripleMu_5SQ_3SQ_0_DoubleMu_5_3_SQ_OS_Mass_Max9_;
    bool L1_TripleMu_5_3_3_;
    TBranch *b_L1_TripleMu_5_3_3_;
    bool loaded_L1_TripleMu_5_3_3_;
    unsigned int counter_cached_L1_TripleMu_5_3_3_;
    unsigned int counter_uncached_L1_TripleMu_5_3_3_;
    bool L1_TripleMu_5_3_3_SQ_;
    TBranch *b_L1_TripleMu_5_3_3_SQ_;
    bool loaded_L1_TripleMu_5_3_3_SQ_;
    unsigned int counter_cached_L1_TripleMu_5_3_3_SQ_;
    unsigned int counter_uncached_L1_TripleMu_5_3_3_SQ_;
    bool L1_TripleMu_5_3p5_2p5_;
    TBranch *b_L1_TripleMu_5_3p5_2p5_;
    bool loaded_L1_TripleMu_5_3p5_2p5_;
    unsigned int counter_cached_L1_TripleMu_5_3p5_2p5_;
    unsigned int counter_uncached_L1_TripleMu_5_3p5_2p5_;
    ...
    unsigned int counter_cached_L1_TripleMu_5_3p5_2p5_DoubleMu_5_2p5_OS_Mass_5to17_;
    unsigned int counter_uncached_L1_TripleMu_5_3p5_2p5_DoubleMu_5_2p5_OS_Mass_5to17_;
    ...
    unsigned int counter_cached_L1_TripleMu_5_3p5_2p5_OQ_DoubleMu_5_2p5_OQ_OS_Mass_5to17_;
    unsigned int counter_uncached_L1_TripleMu_5_3p5_2p5_OQ_DoubleMu_5_2p5_OQ_OS_Mass_5to17_;
    ...
    unsigned int counter_cached_L1_TripleMu_5_4_2p5_DoubleMu_5_2p5_OS_Mass_5to17_;
    unsigned int counter_uncached_L1_TripleMu_5_4_2p5_DoubleMu_5_2p5_OS_Mass_5to17_;
    bool L1_TripleMu_5_5_3_;
    TBranch *b_L1_TripleMu_5_5_3_;
    bool loaded_L1_TripleMu_5_5_3_;
    unsigned int counter_cached_L1_TripleMu_5_5_3_;
    unsigned int counter_uncached_L1_TripleMu_5_5_3_;
    bool L1_UnpairedBunchBptxMinus_;
    TBranch *b_L1_UnpairedBunchBptxMinus_;
    bool loaded_L1_UnpairedBunchBptxMinus_;
    unsigned int counter_cached_L1_UnpairedBunchBptxMinus_;
    unsigned int counter_uncached_L1_UnpairedBunchBptxMinus_;
    ...
    unsigned int counter_cached_L1_ZeroBias_;
    unsigned int counter_uncached_L1_ZeroBias_;
    bool L1_ZeroBias_copy_;
    TBranch *b_L1_ZeroBias_copy_;
    bool loaded_L1_ZeroBias_copy_;
    unsigned int counter_cached_L1_ZeroBias_copy_;
    unsigned int counter_uncached_L1_ZeroBias_copy_;
    bool L1simulation_step_;
    TBranch *b_L1simulation_step_;
    bool loaded_L1simulation_step_;
    unsigned int counter_cached_L1simulation_step_;
    unsigned int counter_uncached_L1simulation_step_;
    float LHEPart_eta_[NLHEPART_MAX];
    vector<float> v_LHEPart_eta_;
    TBranch *b_LHEPart_eta_;
    bool loaded_LHEPart_eta_;
    unsigned int counter_cached_LHEPart_eta_;
    unsigned int counter_uncached_LHEPart_eta_;
    ...
    unsigned int counter_cached_LHEReweightingWeight_;
    unsigned int counter_uncached_LHEReweightingWeight_;
    ...
    unsigned int counter_cached_LHEWeight_originalXWGTUP_;
    unsigned int counter_uncached_LHEWeight_originalXWGTUP_;
    float LHE_AlphaS_;
    TBranch *b_LHE_AlphaS_;
    bool loaded_LHE_AlphaS_;
    unsigned int counter_cached_LHE_AlphaS_;
    unsigned int counter_uncached_LHE_AlphaS_;
    float LHE_HT_;
    TBranch *b_LHE_HT_;
    bool loaded_LHE_HT_;
    unsigned int counter_cached_LHE_HT_;
    unsigned int counter_uncached_LHE_HT_;
    float LHE_HTIncoming_;
    TBranch *b_LHE_HTIncoming_;
    bool loaded_LHE_HTIncoming_;
    unsigned int counter_cached_LHE_HTIncoming_;
    unsigned int counter_uncached_LHE_HTIncoming_;
    UChar_t LHE_Nb_;
    TBranch *b_LHE_Nb_;
    bool loaded_LHE_Nb_;
    unsigned int counter_cached_LHE_Nb_;
    unsigned int counter_uncached_LHE_Nb_;
    UChar_t LHE_Nc_;
    TBranch *b_LHE_Nc_;
    bool loaded_LHE_Nc_;
    unsigned int counter_cached_LHE_Nc_;
    unsigned int counter_uncached_LHE_Nc_;
    UChar_t LHE_Nglu_;
    TBranch *b_LHE_Nglu_;
    bool loaded_LHE_Nglu_;
    unsigned int counter_cached_LHE_Nglu_;
    unsigned int counter_uncached_LHE_Nglu_;
    UChar_t LHE_Njets_;
    TBranch *b_LHE_Njets_;
    bool loaded_LHE_Njets_;
    unsigned int counter_cached_LHE_Njets_;
    unsigned int counter_uncached_LHE_Njets_;
    UChar_t LHE_NpLO_;
    TBranch *b_LHE_NpLO_;
    bool loaded_LHE_NpLO_;
    unsigned int counter_cached_LHE_NpLO_;
    unsigned int counter_uncached_LHE_NpLO_;
    UChar_t LHE_NpNLO_;
    TBranch *b_LHE_NpNLO_;
    bool loaded_LHE_NpNLO_;
    unsigned int counter_cached_LHE_NpNLO_;
    unsigned int counter_uncached_LHE_NpNLO_;
    UChar_t LHE_Nuds_;
    TBranch *b_LHE_Nuds_;
    bool loaded_LHE_Nuds_;
    unsigned int counter_cached_LHE_Nuds_;
    unsigned int counter_uncached_LHE_Nuds_;
    float LHE_Vpt_;
    TBranch *b_LHE_Vpt_;
    ...
    unsigned int counter_cached_MET_MetUnclustEnUpDeltaX_;
    unsigned int counter_uncached_MET_MetUnclustEnUpDeltaX_;
    float MET_MetUnclustEnUpDeltaY_;
    TBranch *b_MET_MetUnclustEnUpDeltaY_;
    bool loaded_MET_MetUnclustEnUpDeltaY_;
    unsigned int counter_cached_MET_MetUnclustEnUpDeltaY_;
    unsigned int counter_uncached_MET_MetUnclustEnUpDeltaY_;
    float MET_covXX_;
    TBranch *b_MET_covXX_;
    bool loaded_MET_covXX_;
    unsigned int counter_cached_MET_covXX_;
    unsigned int counter_uncached_MET_covXX_;
    float MET_covXY_;
    TBranch *b_MET_covXY_;
    bool loaded_MET_covXY_;
    unsigned int counter_cached_MET_covXY_;
    unsigned int counter_uncached_MET_covXY_;
    float MET_covYY_;
    TBranch *b_MET_covYY_;
    bool loaded_MET_covYY_;
    unsigned int counter_cached_MET_covYY_;
    unsigned int counter_uncached_MET_covYY_;
    float MET_fiducialGenPhi_;
    TBranch *b_MET_fiducialGenPhi_;
    bool loaded_MET_fiducialGenPhi_;
    unsigned int counter_cached_MET_fiducialGenPhi_;
    unsigned int counter_uncached_MET_fiducialGenPhi_;
    float MET_fiducialGenPt_;
    TBranch *b_MET_fiducialGenPt_;
    bool loaded_MET_fiducialGenPt_;
    unsigned int counter_cached_MET_fiducialGenPt_;
    unsigned int counter_uncached_MET_fiducialGenPt_;
    float MET_phi_;
    TBranch *b_MET_phi_;
    bool loaded_MET_phi_;
    unsigned int counter_cached_MET_phi_;
    unsigned int counter_uncached_MET_phi_;
    float MET_pt_;
    TBranch *b_MET_pt_;
    bool loaded_MET_pt_;
    unsigned int counter_cached_MET_pt_;
    unsigned int counter_uncached_MET_pt_;
    float MET_significance_;
    TBranch *b_MET_significance_;
    bool loaded_MET_significance_;
    unsigned int counter_cached_MET_significance_;
    unsigned int counter_uncached_MET_significance_;
    float MET_sumEt_;
    TBranch *b_MET_sumEt_;
    bool loaded_MET_sumEt_;
    unsigned int counter_cached_MET_sumEt_;
    unsigned int counter_uncached_MET_sumEt_;
    ...
    unsigned int counter_cached_Muon_charge_;
    unsigned int counter_uncached_Muon_charge_;
    ...
    unsigned int counter_cached_Muon_dxy_;
    unsigned int counter_uncached_Muon_dxy_;
    float Muon_dxyErr_[NMUON_MAX];
    vector<float> v_Muon_dxyErr_;
    TBranch *b_Muon_dxyErr_;
    bool loaded_Muon_dxyErr_;
    unsigned int counter_cached_Muon_dxyErr_;
    unsigned int counter_uncached_Muon_dxyErr_;
    float Muon_dxybs_[NMUON_MAX];
    vector<float> v_Muon_dxybs_;
    TBranch *b_Muon_dxybs_;
    bool loaded_Muon_dxybs_;
    unsigned int counter_cached_Muon_dxybs_;
    unsigned int counter_uncached_Muon_dxybs_;
    float Muon_dz_[NMUON_MAX];
    vector<float> v_Muon_dz_;
    TBranch *b_Muon_dz_;
    bool loaded_Muon_dz_;
    unsigned int counter_cached_Muon_dz_;
    unsigned int counter_uncached_Muon_dz_;
    float Muon_dzErr_[NMUON_MAX];
    vector<float> v_Muon_dzErr_;
    TBranch *b_Muon_dzErr_;
    bool loaded_Muon_dzErr_;
    unsigned int counter_cached_Muon_dzErr_;
    unsigned int counter_uncached_Muon_dzErr_;
    float Muon_eta_[NMUON_MAX];
    vector<float> v_Muon_eta_;
    TBranch *b_Muon_eta_;
    bool loaded_Muon_eta_;
    unsigned int counter_cached_Muon_eta_;
    unsigned int counter_uncached_Muon_eta_;
    ...
    unsigned int counter_cached_Muon_fsrPhotonIdx_;
    unsigned int counter_uncached_Muon_fsrPhotonIdx_;
    ...
    unsigned int counter_cached_Muon_isTracker_;
    unsigned int counter_uncached_Muon_isTracker_;
    ...
    unsigned int counter_cached_Muon_jetPtRelv2_;
    unsigned int counter_uncached_Muon_jetPtRelv2_;
    float Muon_jetRelIso_[NMUON_MAX];
    vector<float> v_Muon_jetRelIso_;
    TBranch *b_Muon_jetRelIso_;
    bool loaded_Muon_jetRelIso_;
    unsigned int counter_cached_Muon_jetRelIso_;
    unsigned int counter_uncached_Muon_jetRelIso_;
    bool Muon_looseId_[NMUON_MAX];
    vector<bool> v_Muon_looseId_;
    TBranch *b_Muon_looseId_;
    bool loaded_Muon_looseId_;
    unsigned int counter_cached_Muon_looseId_;
    unsigned int counter_uncached_Muon_looseId_;
    float Muon_mass_[NMUON_MAX];
    vector<float> v_Muon_mass_;
    TBranch *b_Muon_mass_;
    bool loaded_Muon_mass_;
    unsigned int counter_cached_Muon_mass_;
    unsigned int counter_uncached_Muon_mass_;
    bool Muon_mediumId_[NMUON_MAX];
    vector<bool> v_Muon_mediumId_;
    TBranch *b_Muon_mediumId_;
    bool loaded_Muon_mediumId_;
    unsigned int counter_cached_Muon_mediumId_;
    unsigned int counter_uncached_Muon_mediumId_;
    ...
    unsigned int counter_cached_Muon_mediumPromptId_;
    unsigned int counter_uncached_Muon_mediumPromptId_;
    UChar_t Muon_miniIsoId_[NMUON_MAX];
    vector<UChar_t> v_Muon_miniIsoId_;
    TBranch *b_Muon_miniIsoId_;
    bool loaded_Muon_miniIsoId_;
    unsigned int counter_cached_Muon_miniIsoId_;
    unsigned int counter_uncached_Muon_miniIsoId_;
    ...
    unsigned int counter_cached_Muon_miniPFRelIso_all_;
    unsigned int counter_uncached_Muon_miniPFRelIso_all_;
    ...
    unsigned int counter_cached_Muon_miniPFRelIso_chg_;
    unsigned int counter_uncached_Muon_miniPFRelIso_chg_;
    ...
    unsigned int counter_cached_Muon_multiIsoId_;
    unsigned int counter_uncached_Muon_multiIsoId_;
    UChar_t Muon_mvaId_[NMUON_MAX];
    vector<UChar_t> v_Muon_mvaId_;
    TBranch *b_Muon_mvaId_;
    bool loaded_Muon_mvaId_;
    unsigned int counter_cached_Muon_mvaId_;
    unsigned int counter_uncached_Muon_mvaId_;
    ...
    unsigned int counter_cached_Muon_nStations_;
    unsigned int counter_uncached_Muon_nStations_;
    ...
    unsigned int counter_cached_Muon_pdgId_;
    unsigned int counter_uncached_Muon_pdgId_;
    UChar_t Muon_pfIsoId_[NMUON_MAX];
    vector<UChar_t> v_Muon_pfIsoId_;
    TBranch *b_Muon_pfIsoId_;
    bool loaded_Muon_pfIsoId_;
    unsigned int counter_cached_Muon_pfIsoId_;
    unsigned int counter_uncached_Muon_pfIsoId_;
    ...
    unsigned int counter_cached_Muon_pfRelIso03_all_;
    unsigned int counter_uncached_Muon_pfRelIso03_all_;
    ...
    unsigned int counter_cached_Muon_pfRelIso03_chg_;
    unsigned int counter_uncached_Muon_pfRelIso03_chg_;
    ...
    unsigned int counter_cached_Muon_pfRelIso04_all_;
    unsigned int counter_uncached_Muon_pfRelIso04_all_;
    float Muon_phi_[NMUON_MAX];
    vector<float> v_Muon_phi_;
    TBranch *b_Muon_phi_;
    bool loaded_Muon_phi_;
    unsigned int counter_cached_Muon_phi_;
    unsigned int counter_uncached_Muon_phi_;
    float Muon_pt_[NMUON_MAX];
    vector<float> v_Muon_pt_;
    TBranch *b_Muon_pt_;
    bool loaded_Muon_pt_;
    unsigned int counter_cached_Muon_pt_;
    unsigned int counter_uncached_Muon_pt_;
    ...
    unsigned int counter_cached_Muon_triggerIdLoose_;
    unsigned int counter_uncached_Muon_triggerIdLoose_;
    float Muon_tunepRelPt_[NMUON_MAX];
    vector<float> v_Muon_tunepRelPt_;
    TBranch *b_Muon_tunepRelPt_;
    bool loaded_Muon_tunepRelPt_;
    unsigned int counter_cached_Muon_tunepRelPt_;
    unsigned int counter_uncached_Muon_tunepRelPt_;
    float OtherPV_z_[NOTHERPV_MAX];
    vector<float> v_OtherPV_z_;
    TBranch *b_OtherPV_z_;
    bool loaded_OtherPV_z_;
    unsigned int counter_cached_OtherPV_z_;
    unsigned int counter_uncached_OtherPV_z_;
    float PSWeight_[NPSWEIGHT_MAX];
    vector<float> v_PSWeight_;
    TBranch *b_PSWeight_;
    bool loaded_PSWeight_;
    unsigned int counter_cached_PSWeight_;
    unsigned int counter_uncached_PSWeight_;
    float PV_chi2_;
    TBranch *b_PV_chi2_;
    bool loaded_PV_chi2_;
    unsigned int counter_cached_PV_chi2_;
    unsigned int counter_uncached_PV_chi2_;
    float PV_ndof_;
    TBranch *b_PV_ndof_;
    bool loaded_PV_ndof_;
    unsigned int counter_cached_PV_ndof_;
    unsigned int counter_uncached_PV_ndof_;
    int PV_npvs_;
    TBranch *b_PV_npvs_;
    bool loaded_PV_npvs_;
    unsigned int counter_cached_PV_npvs_;
    unsigned int counter_uncached_PV_npvs_;
    int PV_npvsGood_;
    TBranch *b_PV_npvsGood_;
    bool loaded_PV_npvsGood_;
    unsigned int counter_cached_PV_npvsGood_;
    unsigned int counter_uncached_PV_npvsGood_;
    float PV_score_;
    TBranch *b_PV_score_;
    bool loaded_PV_score_;
    unsigned int counter_cached_PV_score_;
    unsigned int counter_uncached_PV_score_;
    float PV_x_;
    TBranch *b_PV_x_;
    bool loaded_PV_x_;
    unsigned int counter_cached_PV_x_;
    unsigned int counter_uncached_PV_x_;
    float PV_y_;
    TBranch *b_PV_y_;
    bool loaded_PV_y_;
    unsigned int counter_cached_PV_y_;
    unsigned int counter_uncached_PV_y_;
    float PV_z_;
    TBranch *b_PV_z_;
    bool loaded_PV_z_;
    unsigned int counter_cached_PV_z_;
    unsigned int counter_uncached_PV_z_;
    int Photon_charge_[NPHOTON_MAX];
    vector<int> v_Photon_charge_;
    TBranch *b_Photon_charge_;
    bool loaded_Photon_charge_;
    unsigned int counter_cached_Photon_charge_;
    unsigned int counter_uncached_Photon_charge_;
    ...
    unsigned int counter_cached_Photon_cleanmask_;
    unsigned int counter_uncached_Photon_cleanmask_;
    int Photon_cutBased_[NPHOTON_MAX];
    vector<int> v_Photon_cutBased_;
    TBranch *b_Photon_cutBased_;
    bool loaded_Photon_cutBased_;
    unsigned int counter_cached_Photon_cutBased_;
    unsigned int counter_uncached_Photon_cutBased_;
    ...
    unsigned int counter_cached_Photon_cutBased_Fall17V1Bitmap_;
    unsigned int counter_uncached_Photon_cutBased_Fall17V1Bitmap_;
    float Photon_eCorr_[NPHOTON_MAX];
    vector<float> v_Photon_eCorr_;
    TBranch *b_Photon_eCorr_;
    bool loaded_Photon_eCorr_;
    unsigned int counter_cached_Photon_eCorr_;
    unsigned int counter_uncached_Photon_eCorr_;
    ...
    unsigned int counter_cached_Photon_electronIdx_;
    unsigned int counter_uncached_Photon_electronIdx_;
    ...
    unsigned int counter_cached_Photon_electronVeto_;
    unsigned int counter_uncached_Photon_electronVeto_;
    ...
    unsigned int counter_cached_Photon_energyErr_;
    unsigned int counter_uncached_Photon_energyErr_;
    float Photon_eta_[NPHOTON_MAX];
    vector<float> v_Photon_eta_;
    TBranch *b_Photon_eta_;
    bool loaded_Photon_eta_;
    unsigned int counter_cached_Photon_eta_;
    unsigned int counter_uncached_Photon_eta_;
    ...
    unsigned int counter_cached_Photon_genPartIdx_;
    unsigned int counter_uncached_Photon_genPartIdx_;
    float Photon_hoe_[NPHOTON_MAX];
    vector<float> v_Photon_hoe_;
    TBranch *b_Photon_hoe_;
    bool loaded_Photon_hoe_;
    unsigned int counter_cached_Photon_hoe_;
    unsigned int counter_uncached_Photon_hoe_;
    ...
    unsigned int counter_cached_Photon_isScEtaEB_;
    unsigned int counter_uncached_Photon_isScEtaEB_;
    ...
    unsigned int counter_cached_Photon_isScEtaEE_;
    unsigned int counter_uncached_Photon_isScEtaEE_;
    int Photon_jetIdx_[NPHOTON_MAX];
    vector<int> v_Photon_jetIdx_;
    TBranch *b_Photon_jetIdx_;
    bool loaded_Photon_jetIdx_;
    unsigned int counter_cached_Photon_jetIdx_;
    unsigned int counter_uncached_Photon_jetIdx_;
    float Photon_mass_[NPHOTON_MAX];
    vector<float> v_Photon_mass_;
    TBranch *b_Photon_mass_;
    bool loaded_Photon_mass_;
    unsigned int counter_cached_Photon_mass_;
    unsigned int counter_uncached_Photon_mass_;
    float Photon_mvaID_[NPHOTON_MAX];
    vector<float> v_Photon_mvaID_;
    TBranch *b_Photon_mvaID_;
    bool loaded_Photon_mvaID_;
    unsigned int counter_cached_Photon_mvaID_;
    unsigned int counter_uncached_Photon_mvaID_;
    ...
    unsigned int counter_cached_Photon_mvaID_Fall17V1p1_;
    unsigned int counter_uncached_Photon_mvaID_Fall17V1p1_;
    ...
    unsigned int counter_cached_Photon_mvaID_WP80_;
    unsigned int counter_uncached_Photon_mvaID_WP80_;
    ...
    unsigned int counter_cached_Photon_mvaID_WP90_;
    unsigned int counter_uncached_Photon_mvaID_WP90_;
    vector<LorentzVector> v_Photon_p4_;
    TBranch *b_Photon_p4_;
    bool loaded_Photon_p4_;
    unsigned int counter_cached_Photon_p4_;
    unsigned int counter_uncached_Photon_p4_;
    int Photon_pdgId_[NPHOTON_MAX];
    vector<int> v_Photon_pdgId_;
    TBranch *b_Photon_pdgId_;
    bool loaded_Photon_pdgId_;
    unsigned int counter_cached_Photon_pdgId_;
    unsigned int counter_uncached_Photon_pdgId_;
    ...
    unsigned int counter_cached_Photon_pfRelIso03_all_;
    unsigned int counter_uncached_Photon_pfRelIso03_all_;
    ...
    unsigned int counter_cached_Photon_pfRelIso03_chg_;
    unsigned int counter_uncached_Photon_pfRelIso03_chg_;
    ...
    unsigned int counter_cached_Photon_pixelSeed_;
    unsigned int counter_uncached_Photon_pixelSeed_;
    ...
    unsigned int counter_cached_Photon_r9_;
    unsigned int counter_uncached_Photon_r9_;
    ...
    unsigned int counter_cached_Photon_seedGain_;
    unsigned int counter_uncached_Photon_seedGain_;
    float Photon_sieie_[NPHOTON_MAX];
    vector<float> v_Photon_sieie_;
    TBranch *b_Photon_sieie_;
    bool loaded_Photon_sieie_;
    unsigned int counter_cached_Photon_sieie_;
    unsigned int counter_uncached_Photon_sieie_;
    ...
    unsigned int counter_cached_Photon_trkSumPtHollowConeDR03_;
    unsigned int counter_uncached_Photon_trkSumPtHollowConeDR03_;
    ...
    unsigned int counter_cached_Photon_vidNestedWPBitmap_;
    unsigned int counter_uncached_Photon_vidNestedWPBitmap_;
    float Pileup_gpudensity_;
    TBranch *b_Pileup_gpudensity_;
    bool loaded_Pileup_gpudensity_;
    unsigned int counter_cached_Pileup_gpudensity_;
    unsigned int counter_uncached_Pileup_gpudensity_;
    int Pileup_nPU_;
    TBranch *b_Pileup_nPU_;
    bool loaded_Pileup_nPU_;
    unsigned int counter_cached_Pileup_nPU_;
    unsigned int counter_uncached_Pileup_nPU_;
    float Pileup_nTrueInt_;
    TBranch *b_Pileup_nTrueInt_;
    bool loaded_Pileup_nTrueInt_;
    unsigned int counter_cached_Pileup_nTrueInt_;
    unsigned int counter_uncached_Pileup_nTrueInt_;
    float Pileup_pudensity_;
    TBranch *b_Pileup_pudensity_;
    bool loaded_Pileup_pudensity_;
    unsigned int counter_cached_Pileup_pudensity_;
    unsigned int counter_uncached_Pileup_pudensity_;
    int Pileup_sumEOOT_;
    TBranch *b_Pileup_sumEOOT_;
    bool loaded_Pileup_sumEOOT_;
    unsigned int counter_cached_Pileup_sumEOOT_;
    unsigned int counter_uncached_Pileup_sumEOOT_;
    int Pileup_sumLOOT_;
    ...
    unsigned int counter_cached_PuppiMET_sumEt_;
    unsigned int counter_uncached_PuppiMET_sumEt_;
    float RawMET_phi_;
    TBranch *b_RawMET_phi_;
    bool loaded_RawMET_phi_;
    unsigned int counter_cached_RawMET_phi_;
    unsigned int counter_uncached_RawMET_phi_;
    float RawMET_pt_;
    TBranch *b_RawMET_pt_;
    bool loaded_RawMET_pt_;
    unsigned int counter_cached_RawMET_pt_;
    unsigned int counter_uncached_RawMET_pt_;
    float RawMET_sumEt_;
    TBranch *b_RawMET_sumEt_;
    bool loaded_RawMET_sumEt_;
    unsigned int counter_cached_RawMET_sumEt_;
    unsigned int counter_uncached_RawMET_sumEt_;
    float RawPuppiMET_phi_;
    TBranch *b_RawPuppiMET_phi_;
    bool loaded_RawPuppiMET_phi_;
    unsigned int counter_cached_RawPuppiMET_phi_;
    unsigned int counter_uncached_RawPuppiMET_phi_;
    float RawPuppiMET_pt_;
    TBranch *b_RawPuppiMET_pt_;
    bool loaded_RawPuppiMET_pt_;
    unsigned int counter_cached_RawPuppiMET_pt_;
    unsigned int counter_uncached_RawPuppiMET_pt_;
    ...
    unsigned int counter_cached_SV_chi2_;
    unsigned int counter_uncached_SV_chi2_;
    float SV_dlen_[NSV_MAX];
    vector<float> v_SV_dlen_;
    TBranch *b_SV_dlen_;
    bool loaded_SV_dlen_;
    unsigned int counter_cached_SV_dlen_;
    unsigned int counter_uncached_SV_dlen_;
    float SV_dlenSig_[NSV_MAX];
    vector<float> v_SV_dlenSig_;
    TBranch *b_SV_dlenSig_;
    bool loaded_SV_dlenSig_;
    unsigned int counter_cached_SV_dlenSig_;
    unsigned int counter_uncached_SV_dlenSig_;
    float SV_dxy_[NSV_MAX];
    vector<float> v_SV_dxy_;
    TBranch *b_SV_dxy_;
    bool loaded_SV_dxy_;
    unsigned int counter_cached_SV_dxy_;
    unsigned int counter_uncached_SV_dxy_;
    float SV_dxySig_[NSV_MAX];
    vector<float> v_SV_dxySig_;
    TBranch *b_SV_dxySig_;
    bool loaded_SV_dxySig_;
    unsigned int counter_cached_SV_dxySig_;
    unsigned int counter_uncached_SV_dxySig_;
    float SV_eta_[NSV_MAX];
    vector<float> v_SV_eta_;
    TBranch *b_SV_eta_;
    bool loaded_SV_eta_;
    unsigned int counter_cached_SV_eta_;
    unsigned int counter_uncached_SV_eta_;
    float SV_mass_[NSV_MAX];
    vector<float> v_SV_mass_;
    TBranch *b_SV_mass_;
    bool loaded_SV_mass_;
    unsigned int counter_cached_SV_mass_;
    unsigned int counter_uncached_SV_mass_;
    ...
    TBranch *b_SV_p4_;
    bool loaded_SV_p4_;
    unsigned int counter_cached_SV_p4_;
    unsigned int counter_uncached_SV_p4_;
    float SV_pAngle_[NSV_MAX];
    vector<float> v_SV_pAngle_;
    TBranch *b_SV_pAngle_;
    bool loaded_SV_pAngle_;
    unsigned int counter_cached_SV_pAngle_;
    unsigned int counter_uncached_SV_pAngle_;
    float SV_phi_[NSV_MAX];
    vector<float> v_SV_phi_;
    TBranch *b_SV_phi_;
    bool loaded_SV_phi_;
    unsigned int counter_cached_SV_phi_;
    unsigned int counter_uncached_SV_phi_;
    float SV_pt_[NSV_MAX];
    vector<float> v_SV_pt_;
    TBranch *b_SV_pt_;
    bool loaded_SV_pt_;
    unsigned int counter_cached_SV_pt_;
    unsigned int counter_uncached_SV_pt_;
    float SV_x_[NSV_MAX];
    vector<float> v_SV_x_;
    TBranch *b_SV_x_;
    bool loaded_SV_x_;
    unsigned int counter_cached_SV_x_;
    unsigned int counter_uncached_SV_x_;
    float SV_y_[NSV_MAX];
    vector<float> v_SV_y_;
    TBranch *b_SV_y_;
    bool loaded_SV_y_;
    unsigned int counter_cached_SV_y_;
    unsigned int counter_uncached_SV_y_;
    float SV_z_[NSV_MAX];
    vector<float> v_SV_z_;
    TBranch *b_SV_z_;
    bool loaded_SV_z_;
    unsigned int counter_cached_SV_z_;
    unsigned int counter_uncached_SV_z_;
    float SoftActivityJetHT_;
    TBranch *b_SoftActivityJetHT_;
    bool loaded_SoftActivityJetHT_;
    unsigned int counter_cached_SoftActivityJetHT_;
    unsigned int counter_uncached_SoftActivityJetHT_;
    float SoftActivityJetHT10_;
    TBranch *b_SoftActivityJetHT10_;
    bool loaded_SoftActivityJetHT10_;
    unsigned int counter_cached_SoftActivityJetHT10_;
    unsigned int counter_uncached_SoftActivityJetHT10_;
    float SoftActivityJetHT2_;
    TBranch *b_SoftActivityJetHT2_;
    bool loaded_SoftActivityJetHT2_;
    unsigned int counter_cached_SoftActivityJetHT2_;
    unsigned int counter_uncached_SoftActivityJetHT2_;
    float SoftActivityJetHT5_;
    TBranch *b_SoftActivityJetHT5_;
    bool loaded_SoftActivityJetHT5_;
    unsigned int counter_cached_SoftActivityJetHT5_;
    unsigned int counter_uncached_SoftActivityJetHT5_;
    int SoftActivityJetNjets10_;
    TBranch *b_SoftActivityJetNjets10_;
    bool loaded_SoftActivityJetNjets10_;
    unsigned int counter_cached_SoftActivityJetNjets10_;
    unsigned int counter_uncached_SoftActivityJetNjets10_;
    int SoftActivityJetNjets2_;
    TBranch *b_SoftActivityJetNjets2_;
    bool loaded_SoftActivityJetNjets2_;
    unsigned int counter_cached_SoftActivityJetNjets2_;
    unsigned int counter_uncached_SoftActivityJetNjets2_;
    int SoftActivityJetNjets5_;
    TBranch *b_SoftActivityJetNjets5_;
    bool loaded_SoftActivityJetNjets5_;
    unsigned int counter_cached_SoftActivityJetNjets5_;
    unsigned int counter_uncached_SoftActivityJetNjets5_;
    ...
    unsigned int counter_cached_SoftActivityJet_eta_;
    unsigned int counter_uncached_SoftActivityJet_eta_;
    ...
    unsigned int counter_cached_SoftActivityJet_phi_;
    unsigned int counter_uncached_SoftActivityJet_phi_;
    ...
    unsigned int counter_cached_SoftActivityJet_pt_;
    unsigned int counter_uncached_SoftActivityJet_pt_;
    ...
    unsigned int counter_cached_SubGenJetAK8_eta_;
    unsigned int counter_uncached_SubGenJetAK8_eta_;
    ...
    unsigned int counter_cached_SubGenJetAK8_mass_;
    unsigned int counter_uncached_SubGenJetAK8_mass_;
    vector<LorentzVector> v_SubGenJetAK8_p4_;
    TBranch *b_SubGenJetAK8_p4_;
    bool loaded_SubGenJetAK8_p4_;
    unsigned int counter_cached_SubGenJetAK8_p4_;
    unsigned int counter_uncached_SubGenJetAK8_p4_;
    ...
    unsigned int counter_cached_SubGenJetAK8_phi_;
    unsigned int counter_uncached_SubGenJetAK8_phi_;
    ...
    unsigned int counter_cached_SubGenJetAK8_pt_;
    unsigned int counter_uncached_SubGenJetAK8_pt_;
    float SubJet_btagCMVA_[NSUBJET_MAX];
    vector<float> v_SubJet_btagCMVA_;
    TBranch *b_SubJet_btagCMVA_;
    bool loaded_SubJet_btagCMVA_;
    unsigned int counter_cached_SubJet_btagCMVA_;
    unsigned int counter_uncached_SubJet_btagCMVA_;
    ...
    unsigned int counter_cached_SubJet_btagCSVV2_;
    unsigned int counter_uncached_SubJet_btagCSVV2_;
    ...
    unsigned int counter_cached_SubJet_btagDeepB_;
    unsigned int counter_uncached_SubJet_btagDeepB_;
    ...
    unsigned int counter_cached_SubJet_mass_;
    unsigned int counter_uncached_SubJet_mass_;
    float SubJet_n2b1_[NSUBJET_MAX];
    vector<float> v_SubJet_n2b1_;
    TBranch *b_SubJet_n2b1_;
    bool loaded_SubJet_n2b1_;
    unsigned int counter_cached_SubJet_n2b1_;
    unsigned int counter_uncached_SubJet_n2b1_;
    float SubJet_n3b1_[NSUBJET_MAX];
    vector<float> v_SubJet_n3b1_;
    TBranch *b_SubJet_n3b1_;
    bool loaded_SubJet_n3b1_;
    unsigned int counter_cached_SubJet_n3b1_;
    unsigned int counter_uncached_SubJet_n3b1_;
    ...
    unsigned int counter_cached_SubJet_nBHadrons_;
    unsigned int counter_uncached_SubJet_nBHadrons_;
    ...
    unsigned int counter_cached_SubJet_nCHadrons_;
    unsigned int counter_uncached_SubJet_nCHadrons_;
    vector<LorentzVector> v_SubJet_p4_;
    TBranch *b_SubJet_p4_;
    bool loaded_SubJet_p4_;
    unsigned int counter_cached_SubJet_p4_;
    unsigned int counter_uncached_SubJet_p4_;
    float SubJet_phi_[NSUBJET_MAX];
    vector<float> v_SubJet_phi_;
    TBranch *b_SubJet_phi_;
    bool loaded_SubJet_phi_;
    unsigned int counter_cached_SubJet_phi_;
    unsigned int counter_uncached_SubJet_phi_;
    float SubJet_pt_[NSUBJET_MAX];
    vector<float> v_SubJet_pt_;
    TBranch *b_SubJet_pt_;
    bool loaded_SubJet_pt_;
    unsigned int counter_cached_SubJet_pt_;
    unsigned int counter_uncached_SubJet_pt_;
    ...
    unsigned int counter_cached_Tau_genPartIdx_;
    unsigned int counter_uncached_Tau_genPartIdx_;
    UChar_t Tau_idAntiEle_[NTAU_MAX];
    vector<UChar_t> v_Tau_idAntiEle_;
    TBranch *b_Tau_idAntiEle_;
    bool loaded_Tau_idAntiEle_;
    unsigned int counter_cached_Tau_idAntiEle_;
    unsigned int counter_uncached_Tau_idAntiEle_;
    ...
    unsigned int counter_cached_Tau_idAntiMu_;
    unsigned int counter_uncached_Tau_idAntiMu_;
    bool Tau_idDecayMode_[NTAU_MAX];
    vector<bool> v_Tau_idDecayMode_;
    TBranch *b_Tau_idDecayMode_;
    bool loaded_Tau_idDecayMode_;
    unsigned int counter_cached_Tau_idDecayMode_;
    unsigned int counter_uncached_Tau_idDecayMode_;
    ...
    unsigned int counter_cached_Tau_idDeepTau2017v2p1VSe_;
    unsigned int counter_uncached_Tau_idDeepTau2017v2p1VSe_;
    ...
    unsigned int counter_cached_Tau_idDeepTau2017v2p1VSjet_;
    unsigned int counter_uncached_Tau_idDeepTau2017v2p1VSjet_;
    ...
    unsigned int counter_cached_Tau_idDeepTau2017v2p1VSmu_;
    unsigned int counter_uncached_Tau_idDeepTau2017v2p1VSmu_;
    ...
    unsigned int counter_cached_Tau_idMVAnewDM2017v2_;
    unsigned int counter_uncached_Tau_idMVAnewDM2017v2_;
    UChar_t Tau_idMVAoldDM_[NTAU_MAX];
    vector<UChar_t> v_Tau_idMVAoldDM_;
    TBranch *b_Tau_idMVAoldDM_;
    bool loaded_Tau_idMVAoldDM_;
    unsigned int counter_cached_Tau_idMVAoldDM_;
    unsigned int counter_uncached_Tau_idMVAoldDM_;
    ...
    unsigned int counter_cached_Tau_idMVAoldDM2017v1_;
    unsigned int counter_uncached_Tau_idMVAoldDM2017v1_;
    ...
    unsigned int counter_cached_Tau_idMVAoldDM2017v2_;
    unsigned int counter_uncached_Tau_idMVAoldDM2017v2_;
    ...
    unsigned int counter_cached_Tau_idMVAoldDMdR032017v2_;
    unsigned int counter_uncached_Tau_idMVAoldDMdR032017v2_;
    int Tau_jetIdx_[NTAU_MAX];
    vector<int> v_Tau_jetIdx_;
    TBranch *b_Tau_jetIdx_;
    bool loaded_Tau_jetIdx_;
    unsigned int counter_cached_Tau_jetIdx_;
    unsigned int counter_uncached_Tau_jetIdx_;
    ...
    unsigned int counter_cached_Tau_leadTkDeltaEta_;
    unsigned int counter_uncached_Tau_leadTkDeltaEta_;
    ...
    unsigned int counter_cached_Tau_leadTkDeltaPhi_;
    unsigned int counter_uncached_Tau_leadTkDeltaPhi_;
    ...
    unsigned int counter_cached_Tau_leadTkPtOverTauPt_;
    unsigned int counter_uncached_Tau_leadTkPtOverTauPt_;
    float Tau_mass_[NTAU_MAX];
    vector<float> v_Tau_mass_;
    TBranch *b_Tau_mass_;
    bool loaded_Tau_mass_;
    unsigned int counter_cached_Tau_mass_;
    unsigned int counter_uncached_Tau_mass_;
    float Tau_neutralIso_[NTAU_MAX];
    vector<float> v_Tau_neutralIso_;
    TBranch *b_Tau_neutralIso_;
    bool loaded_Tau_neutralIso_;
    unsigned int counter_cached_Tau_neutralIso_;
    unsigned int counter_uncached_Tau_neutralIso_;
    vector<LorentzVector> v_Tau_p4_;
    TBranch *b_Tau_p4_;
    bool loaded_Tau_p4_;
    unsigned int counter_cached_Tau_p4_;
    unsigned int counter_uncached_Tau_p4_;
    float Tau_phi_[NTAU_MAX];
    vector<float> v_Tau_phi_;
    TBranch *b_Tau_phi_;
    bool loaded_Tau_phi_;
    unsigned int counter_cached_Tau_phi_;
    unsigned int counter_uncached_Tau_phi_;
    ...
    unsigned int counter_cached_Tau_photonsOutsideSignalCone_;
    unsigned int counter_uncached_Tau_photonsOutsideSignalCone_;
    float Tau_pt_[NTAU_MAX];
    vector<float> v_Tau_pt_;
    TBranch *b_Tau_pt_;
    bool loaded_Tau_pt_;
    unsigned int counter_cached_Tau_pt_;
    unsigned int counter_uncached_Tau_pt_;
    float Tau_puCorr_[NTAU_MAX];
    vector<float> v_Tau_puCorr_;
    TBranch *b_Tau_puCorr_;
    bool loaded_Tau_puCorr_;
    unsigned int counter_cached_Tau_puCorr_;
    unsigned int counter_uncached_Tau_puCorr_;
    float Tau_rawAntiEle_[NTAU_MAX];
    vector<float> v_Tau_rawAntiEle_;
    TBranch *b_Tau_rawAntiEle_;
    bool loaded_Tau_rawAntiEle_;
    unsigned int counter_cached_Tau_rawAntiEle_;
    unsigned int counter_uncached_Tau_rawAntiEle_;
    ...
    unsigned int counter_cached_Tau_rawAntiEle2018_;
    unsigned int counter_uncached_Tau_rawAntiEle2018_;
    int Tau_rawAntiEleCat_[NTAU_MAX];
    vector<int> v_Tau_rawAntiEleCat_;
    TBranch *b_Tau_rawAntiEleCat_;
    bool loaded_Tau_rawAntiEleCat_;
    unsigned int counter_cached_Tau_rawAntiEleCat_;
    unsigned int counter_uncached_Tau_rawAntiEleCat_;
    ...
    unsigned int counter_cached_Tau_rawAntiEleCat2018_;
    unsigned int counter_uncached_Tau_rawAntiEleCat2018_;
    ...
    unsigned int counter_cached_Tau_rawDeepTau2017v2p1VSe_;
    unsigned int counter_uncached_Tau_rawDeepTau2017v2p1VSe_;
    ...
    unsigned int counter_cached_Tau_rawDeepTau2017v2p1VSjet_;
    unsigned int counter_uncached_Tau_rawDeepTau2017v2p1VSjet_;
    ...
    unsigned int counter_cached_Tau_rawDeepTau2017v2p1VSmu_;
    unsigned int counter_uncached_Tau_rawDeepTau2017v2p1VSmu_;
    float Tau_rawIso_[NTAU_MAX];
    vector<float> v_Tau_rawIso_;
    TBranch *b_Tau_rawIso_;
    bool loaded_Tau_rawIso_;
    unsigned int counter_cached_Tau_rawIso_;
    unsigned int counter_uncached_Tau_rawIso_;
    float Tau_rawIsodR03_[NTAU_MAX];
    vector<float> v_Tau_rawIsodR03_;
    TBranch *b_Tau_rawIsodR03_;
    bool loaded_Tau_rawIsodR03_;
    unsigned int counter_cached_Tau_rawIsodR03_;
    unsigned int counter_uncached_Tau_rawIsodR03_;
    ...
    unsigned int counter_cached_Tau_rawMVAnewDM2017v2_;
    unsigned int counter_uncached_Tau_rawMVAnewDM2017v2_;
    float Tau_rawMVAoldDM_[NTAU_MAX];
    vector<float> v_Tau_rawMVAoldDM_;
    TBranch *b_Tau_rawMVAoldDM_;
    bool loaded_Tau_rawMVAoldDM_;
    unsigned int counter_cached_Tau_rawMVAoldDM_;
    unsigned int counter_uncached_Tau_rawMVAoldDM_;
    ...
    unsigned int counter_cached_Tau_rawMVAoldDM2017v1_;
    unsigned int counter_uncached_Tau_rawMVAoldDM2017v1_;
    ...
    unsigned int counter_cached_Tau_rawMVAoldDM2017v2_;
    unsigned int counter_uncached_Tau_rawMVAoldDM2017v2_;
    ...
    unsigned int counter_cached_Tau_rawMVAoldDMdR032017v2_;
    unsigned int counter_uncached_Tau_rawMVAoldDMdR032017v2_;
    float TkMET_phi_;
    TBranch *b_TkMET_phi_;
    bool loaded_TkMET_phi_;
    unsigned int counter_cached_TkMET_phi_;
    unsigned int counter_uncached_TkMET_phi_;
    float TkMET_pt_;
    TBranch *b_TkMET_pt_;
    bool loaded_TkMET_pt_;
    unsigned int counter_cached_TkMET_pt_;
    unsigned int counter_uncached_TkMET_pt_;
    float TkMET_sumEt_;
    TBranch *b_TkMET_sumEt_;
    bool loaded_TkMET_sumEt_;
    unsigned int counter_cached_TkMET_sumEt_;
    unsigned int counter_uncached_TkMET_sumEt_;
    float TrigObj_eta_[NTRIGOBJ_MAX];
    vector<float> v_TrigObj_eta_;
    TBranch *b_TrigObj_eta_;
    bool loaded_TrigObj_eta_;
    unsigned int counter_cached_TrigObj_eta_;
    unsigned int counter_uncached_TrigObj_eta_;
    ...
    unsigned int counter_cached_btagWeight_CSVV2_;
    unsigned int counter_uncached_btagWeight_CSVV2_;
    float btagWeight_DeepCSVB_;
    TBranch *b_btagWeight_DeepCSVB_;
    bool loaded_btagWeight_DeepCSVB_;
    unsigned int counter_cached_btagWeight_DeepCSVB_;
    unsigned int counter_uncached_btagWeight_DeepCSVB_;
    ULong64_t event_;
    TBranch *b_event_;
    bool loaded_event_;
    ...
    unsigned int counter_cached_genTtbarId_;
    unsigned int counter_uncached_genTtbarId_;
    float genWeight_;
    TBranch *b_genWeight_;
    bool loaded_genWeight_;
    unsigned int counter_cached_genWeight_;
    unsigned int counter_uncached_genWeight_;
    UInt_t luminosityBlock_;
    TBranch *b_luminosityBlock_;
    bool loaded_luminosityBlock_;
    unsigned int counter_cached_luminosityBlock_;
    unsigned int counter_uncached_luminosityBlock_;
    ...
    unsigned int counter_cached_nElectron_;
    unsigned int counter_uncached_nElectron_;
    UInt_t nFatJet_;
    TBranch *b_nFatJet_;
    bool loaded_nFatJet_;
    unsigned int counter_cached_nFatJet_;
    unsigned int counter_uncached_nFatJet_;
    UInt_t nFsrPhoton_;
    TBranch *b_nFsrPhoton_;
    bool loaded_nFsrPhoton_;
    unsigned int counter_cached_nFsrPhoton_;
    unsigned int counter_uncached_nFsrPhoton_;
    UInt_t nGenDressedLepton_;
    TBranch *b_nGenDressedLepton_;
    bool loaded_nGenDressedLepton_;
    unsigned int counter_cached_nGenDressedLepton_;
    unsigned int counter_uncached_nGenDressedLepton_;
    UInt_t nGenIsolatedPhoton_;
    TBranch *b_nGenIsolatedPhoton_;
    bool loaded_nGenIsolatedPhoton_;
    unsigned int counter_cached_nGenIsolatedPhoton_;
    unsigned int counter_uncached_nGenIsolatedPhoton_;
    UInt_t nGenJet_;
    TBranch *b_nGenJet_;
    bool loaded_nGenJet_;
    unsigned int counter_cached_nGenJet_;
    unsigned int counter_uncached_nGenJet_;
    UInt_t nGenJetAK8_;
    TBranch *b_nGenJetAK8_;
    bool loaded_nGenJetAK8_;
    unsigned int counter_cached_nGenJetAK8_;
    unsigned int counter_uncached_nGenJetAK8_;
    UInt_t nGenPart_;
    TBranch *b_nGenPart_;
    bool loaded_nGenPart_;
    unsigned int counter_cached_nGenPart_;
    unsigned int counter_uncached_nGenPart_;
    UInt_t nGenVisTau_;
    TBranch *b_nGenVisTau_;
    bool loaded_nGenVisTau_;
    unsigned int counter_cached_nGenVisTau_;
    unsigned int counter_uncached_nGenVisTau_;
    UInt_t nIsoTrack_;
    TBranch *b_nIsoTrack_;
    bool loaded_nIsoTrack_;
    unsigned int counter_cached_nIsoTrack_;
    unsigned int counter_uncached_nIsoTrack_;
    UInt_t nJet_;
    TBranch *b_nJet_;
    bool loaded_nJet_;
    unsigned int counter_cached_nJet_;
    unsigned int counter_uncached_nJet_;
    UInt_t nLHEPart_;
    TBranch *b_nLHEPart_;
    bool loaded_nLHEPart_;
    unsigned int counter_cached_nLHEPart_;
    unsigned int counter_uncached_nLHEPart_;
    UInt_t nLHEPdfWeight_;
    TBranch *b_nLHEPdfWeight_;
    bool loaded_nLHEPdfWeight_;
    unsigned int counter_cached_nLHEPdfWeight_;
    unsigned int counter_uncached_nLHEPdfWeight_;
    UInt_t nLHEReweightingWeight_;
    TBranch *b_nLHEReweightingWeight_;
    bool loaded_nLHEReweightingWeight_;
    unsigned int counter_cached_nLHEReweightingWeight_;
    unsigned int counter_uncached_nLHEReweightingWeight_;
    ...
    TBranch *b_nMuon_;
    bool loaded_nMuon_;
    unsigned int counter_cached_nMuon_;
    unsigned int counter_uncached_nMuon_;
    UInt_t nOtherPV_;
    TBranch *b_nOtherPV_;
    bool loaded_nOtherPV_;
    unsigned int counter_cached_nOtherPV_;
    unsigned int counter_uncached_nOtherPV_;
    UInt_t nPSWeight_;
    TBranch *b_nPSWeight_;
    bool loaded_nPSWeight_;
    unsigned int counter_cached_nPSWeight_;
    unsigned int counter_uncached_nPSWeight_;
    UInt_t nPhoton_;
    TBranch *b_nPhoton_;
    bool loaded_nPhoton_;
    unsigned int counter_cached_nPhoton_;
    unsigned int counter_uncached_nPhoton_;
    UInt_t nSV_;
    TBranch *b_nSV_;
    bool loaded_nSV_;
    unsigned int counter_cached_nSV_;
    unsigned int counter_uncached_nSV_;
    UInt_t nSoftActivityJet_;
    TBranch *b_nSoftActivityJet_;
    bool loaded_nSoftActivityJet_;
    unsigned int counter_cached_nSoftActivityJet_;
    unsigned int counter_uncached_nSoftActivityJet_;
    UInt_t nSubGenJetAK8_;
    TBranch *b_nSubGenJetAK8_;
    bool loaded_nSubGenJetAK8_;
    unsigned int counter_cached_nSubGenJetAK8_;
    unsigned int counter_uncached_nSubGenJetAK8_;
    UInt_t nSubJet_;
    TBranch *b_nSubJet_;
    bool loaded_nSubJet_;
    unsigned int counter_cached_nSubJet_;
    unsigned int counter_uncached_nSubJet_;
    UInt_t nTau_;
    TBranch *b_nTau_;
    bool loaded_nTau_;
    unsigned int counter_cached_nTau_;
    unsigned int counter_uncached_nTau_;
    UInt_t nTrigObj_;
    TBranch *b_nTrigObj_;
    ...
    TBranch *b_run_;
    bool loaded_run_;
    unsigned int counter_cached_run_;
    unsigned int counter_uncached_run_;
    Int_t year_;
public:
